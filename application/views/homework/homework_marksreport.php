<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="box removeboxmius">
            ...
            <form  class="assign_teacher_form" action="<?php echo base_url(); ?>homework/homework_marksreport" method="post" enctype="multipart/form-data">
                <div class="box-body">
                    <div class="row">
                        <div class="col-md-12">
...
?>
            ...
            <div class="" id="box_display">
                ...
                <div class="box-header with-border">
                    <h3 class="box-title"><i class="fa fa-users"> </i> <?php echo $this->lang->line('homework_marks_report'); ?></h3>
                </div>
                <div class="box-body table-responsive">
                    <div class="download_label"> <?php echo $this->lang->line('homework_marks_report');?></div>
                    <table class="table table-striped table-bordered table-hover example" cellspacing="0" width="100%" data-export-title="<?php echo $this->lang->line('homework_marks_report');?>">
                        <thead>
                            <tr>
...
if (!empty($resultlist)) {
    ...
    foreach ($resultlist as $key => $homework) {
        ?>
                                    <tr>
                                        <td class="dt-body-left dt-head-left"><?php echo $homework['admission_no'];?></td>
                                        
                                        <td><a href="<?php echo base_url("student/view/".$homework['id']); ?>"> 
                                        <?php echo $this->customlib->getFullName($homework['firstname'], $homework['middlename'],$homework['lastname'], $sch_setting->middlename, $sch_setting->lastname); ?></a></td>

                                        <?php if ($sch_setting->roll_no) { ?>
                                        <td><?php echo $homework['roll_no'];?></td>
                                        <?php } ?>                                        
                                        ...
                                        <td><?php echo date($this->customlib->getSchoolDateFormat(), $this->customlib->dateyyyymmddTodateformat($homework['evaluation_date'])); ?></td>
                                        <td><?php echo $homework['marks'];?></td>
                                        <td><?php echo $homework['marks_obtain'];?></td>
