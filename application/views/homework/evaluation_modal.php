        ...
        <div class="taskside scroll-area">
            ...
            <div class="task-info task-single-inline-wrap ptt10">
                ...
                <?php if (!empty($result["document"])) { ?>
                    ...
                    <a data-toggle="tooltip" title="<?php echo $this->lang->line('download'); ?>" href="<?php echo site_url("homework/download/" . $result["id"]) ?>"><i class="fa fa-download text text-primary"></i></a></label>
                    <?php
                }
