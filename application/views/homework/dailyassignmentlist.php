...
?>
            ...
            <div class="" id="box_display">
                ...
                <div class="box-body table-responsive">                    
                    <table class="table table-striped table-bordered table-hover dailyassignmentlist" data-export-title="<?php echo $this->lang->line('daily_assignment_list')." ".$this->customlib->get_postmessage();?>">
                        <thead>
                            <tr>
           ...
           data: form_data, // serializes the form's elements.
              ...
              success: function(response) { // your success handler
                ...
                if(!response.status){
                   ...
                   initDatatable('dailyassignmentlist','homework/searchdailyassignment',response.params,[],50,
...
<script type="text/javascript">
    $(document).ready(function() {
        displayDataTable('dailyassignmentlist');
    });
</script>