...
?></div>
                    <table class="table table-striped table-bordered table-hover example" cellspacing="0" width="100%" data-export-title="<?php echo $this->lang->line('homework_evaluation_report');?>">
                        <thead>
                            <tr>
