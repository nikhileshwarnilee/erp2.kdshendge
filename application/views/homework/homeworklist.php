...
<script type="text/javascript">
    ...
    function homework_docs(id) {
        ...
        initDatatable('all-list', 'homework/homework_docs/'+id, '', [], 50);      
    }
           ...
           data: form_data, // serializes the form's elements.
              beforeSend: function () {
                ...
                if(!response.status){
                    ...
                    initDatatable('homework-list','homework/dthomeworklist',response.params);
                    initDatatable('homework-list-close','homework/closehomeworklist',response.params);
                }
              },
