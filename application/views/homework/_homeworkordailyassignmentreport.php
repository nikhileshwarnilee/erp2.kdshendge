        ...
        <div class="box box-primary border0 mb0 margesection">
            ...
            <div class="">
                <ul class="reportlists">
                    ...
                    <?php if ($this->rbac->hasPrivilege('homework_marks_report', 'can_view')) { ?>
                        <li class="col-lg-4 col-md-4 col-sm-6 <?php echo set_SubSubmenu('homework/homework_marksreport'); ?>"><a href="<?php echo base_url(); ?>homework/homework_marksreport"><i class="fa fa-file-text-o"></i> <?php echo $this->lang->line('homework_marks_report'); ?></a></li> 
                    <?php } ?>
                </ul>
            </div>
        </div> 
