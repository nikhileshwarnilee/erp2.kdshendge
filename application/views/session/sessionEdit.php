                ...
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        ...
                        <div class="mailbox-messages">
                            ...
                            <table class="table table-striped table-bordered table-hover example"   data-export-title="<?php echo $this->lang->line('session_list'); ?>">
                                <thead>
                                    <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td class="mailbox-date pull-right" hidden>
                                                <?php if ($this->rbac->hasPrivilege('session_setting', 'can_edit')) { ?>
                                                    <a href="<?php echo base_url(); ?>sessions/edit/<?php echo $session['id'] ?>" class="btn btn-primary btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('edit'); ?>">
                                                        <i class="fa fa-pencil"></i>
                                                    </a>
                                                <?php } if ($this->rbac->hasPrivilege('session_setting', 'can_delete')) { ?>
                                                    <a href="<?php echo base_url(); ?>sessions/delete/<?php echo $session['id'] ?>"class="btn btn-primary btn-xs <?php
                                                    if ($session['active'] != 0) {
                                                        echo'disabled';
                                                    }
