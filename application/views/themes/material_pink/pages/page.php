    ...
    if (!empty($page['category_content'])) {
        ...
        foreach ($page['category_content'] as $page_content_key => $page_content_value) {
            ...
            if ($page_content_key == "events") {
                                        ...
                                        <div class="eventcaption">
                                            ...
                                            <div class="event20">
                                                ...
                                                <p><?php  									 
														...
														// if no space found, just use the raw cut
                ...
                foreach ($page['category_content'][$page_content_key] as $key => $value) {
                    ...
                    <div class="latestevent">
                        ...
                        <div class="alert-message alert-message-default">
                            ...
                            <?php if($value['date']){ echo $this->lang->line('date') .': '. date($this->customlib->getSchoolDateFormat(), $this->customlib->dateyyyymmddTodateformat($value['date'])); } ?>
                            <p><?php  									 
                ...
                <div class="row">
                    <?php
                    $category_content  =   $page['category_content'][$page_content_key];
