   ...
   <div class="row justify-content-center align-items-center flex-wrap d-flex">
      <div class="col-md-10">
         ...
         <ul class="reflist"> 
            ...
            <?php if ($this->sch_setting_detail->roll_no) { ?>
...
echo $this->lang->line('fail');
                                    ...
                                    if ($exam_pass_status) {
                                        ...
                                        ?>
                                       <span class='text text-success' style="margin-right: 5px;">
                                       <?php
echo $this->lang->line('pass');
                                        ?>
                                       </span> <?php
                                        ...
                                        ?>
                                       <span class='text text-danger' style="margin-right: 5px;">
                                       <?php
echo $this->lang->line('fail');
                                        ?>
                                       </span>
      ...
      <div class="row">
         <div class="col-md-12">
            <div class="bgtgray">
               ...
               <div class="col-sm-4">
                  <div class="description-block">
                     <h5 class="description-header"> <?php echo $this->lang->line('percentage') ?> :  <span class="description-text">s
                        <?php
                           $exam_percentage = ($exam_get_total * 100) / $exam_grand_total;
                                                   echo number_format($exam_percentage, 2, '.', '');
                                                   ?>
         ...
         <tbody>
            ...
            $exam_get_percentage = 0;    
                            ...
                            $consolidate_exam_result = "fail";
                             ...
                             echo number_format($consolidate_get_percentage_mark['exam_consolidate_marks'], 2, '.', '')." (".$consolidate_get_percentage_mark['exam_weightage']."%)";
