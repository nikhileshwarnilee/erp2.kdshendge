...
?>
    <div class="row justify-content-center align-items-center flex-wrap d-flex pt20">
        ...
        <div class="col-md-6 col-lg-7 col-sm-8 text-lg-right">
            <a href="#checkOnlineAdmissionStatus" class="modalclosebtn modal-close-xs w-full-xs text-center" onclick="openStatusFormmodal();" data-toggle="modal" data-target="#checkOnlineAdmissionStatus"><?php echo $this->lang->line('check_your_form_status') ?></a>  
           <?php if(!empty($online_admission_application_form)){ ?>
           <a href="<?php echo base_url(); ?>welcome/download/<?php echo $sch_setting->id; ?>" class='modalclosebtn modal-close-xs w-full-xs mr-lg-1'><?php echo $this->lang->line('download_application_form'); ?></a>    
            <?php } ?>
