                ...
                <div class="box box-primary" id="tachelist">
                    ...
                    <div class="box-body">
                        ...
                        <div class="table-responsive mailbox-messages overflow-visible-lg">
                            ...
                            <table class="table table-striped table-bordered table-hover example"  data-export-title="<?php echo $this->lang->line('staff_member_list');?>">
                                <thead>
                                    <tr>
                                        <th class="dt-body-left dt-head-left"><?php echo $this->lang->line('member_id'); ?></th>
                                    ...
                                    <?php if (empty($teacherlist)) {
                                        ...
                                        foreach ($teacherlist as $teacher) {
                                            ...
                                            <tr class="<?php echo $clsactive; ?>">
                                                <td class="dt-body-left dt-head-left"><?php echo $member_id; ?></td>
                                                ...
                                                <td class="text text-right">
                                                    ...
                                                    if ($teacher['libarary_member_id'] == 0) {
                                                        ...
                                                        <button  data-stdid="<?php echo $teacher['id'] ?>" class="btn btn-primary btn-xs add-teachers"  data-toggle="tooltip" title="<?php echo $this->lang->line('add'); ?>" >
                                                            <i class="fa fa-plus"></i>
                                                        </button>
                                                        <?php
                                                    } else {
                                                        ?>
                                                        <button type="button" class="btn btn-primary btn-xs surrender-teacher" data-loading-text="<i class='fa fa-spinner fa-spin '></i> <?php echo $this->lang->line('please_wait'); ?>"  data-toggle="tooltip" data-memberid="<?php echo $member_id; ?>" title="<?php echo $this->lang->line('surrender_membership'); ?>"><i class="fa fa-mail-reply"></i></button>
                                                        <?php
                                                    }
                                                    ?>
                                                </td>
