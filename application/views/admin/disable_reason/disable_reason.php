                ...
                <div class="col-md-4">
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title"><i class="fa fa-users"></i> <?php echo $this->lang->line('add_disable_reason'); ?></h3>
                        </div> 
                                    ...
                                    <?php foreach ($results as $value) { ?>
                                        <tr>
                                            ...
                                            <td class="text-right">
                                                ...
                                                <a onclick="return confirm('<?php echo $this->lang->line('delete_confirm'); ?>')" class="btn btn-primary btn-xs" href="<?php echo base_url() ?>admin/disable_reason/delete/<?php echo $value['id'] ?>" data-toggle="tooltip" title="<?php echo $this->lang->line('delete'); ?>"><i class="fa fa-remove"></i></a>
                                                <?php } ?>
                                            </td>
