                    ...
                    <div class="box-body">
                        ...
                        <div class="mailbox-messages">
                            ...
                            <div class="table-responsive overflow-visible">
                                <table class="table table-striped table-bordered table-hover example"  data-export-title="<?php echo $this->lang->line('room_type_list');?>">
                                    <thead>
                                        <tr>
        ...
        ?>
                                                    ...
                                                    <td class="mailbox-date pull-right no-print">
                                                        <?php if ($this->rbac->hasPrivilege('room_type', 'can_edit')) {?>
                                                            <a href="<?php echo base_url(); ?>admin/roomtype/edit/<?php echo $roomtype['id'] ?>" class="btn btn-primary btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('edit'); ?>">
                                                                <i class="fa fa-pencil"></i>
                                                            </a>
                                                        <?php }if ($this->rbac->hasPrivilege('room_type', 'can_delete')) {?>
                                                            <a href="<?php echo base_url(); ?>admin/roomtype/delete/<?php echo $roomtype['id'] ?>"class="btn btn-primary btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('delete'); ?>" onclick="return confirm('<?php echo $this->lang->line('delete_confirm') ?>');">
