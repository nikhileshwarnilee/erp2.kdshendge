  ...
  <div class="row">
   <div class="col-md-12">
    <div class="box box-primary">
     <div class="box-header with-border">
      <h3 class="box-title"><i class="fa fa-search"></i> <?php echo $this->lang->line('select_criteria'); ?></h3>
			...
			<div class="box-tools pull-right">
                <div class="btn-group">
                    <a href="<?php echo site_url('admin/transfercertificate/verify_tc') ?>" style="border-radius:2px 0px 0px 2px" class="btn btn-primary btn-sm btnMDb2"><?php echo $this->lang->line('verify_tc');?></a>
                    ...
                    <ul class="dropdown-menu" role="menu">
						<?php if ($this->rbac->hasPrivilege('prepare_tc', 'can_view')) { ?>
                        <li><a href="<?php echo site_url('admin/transfercertificate/prepare_tc') ?>"><?php echo $this->lang->line('prepare_tc');?></a></li>
						<?php } if ($this->rbac->hasPrivilege('tc_settings', 'can_view')) { ?> 
                        <li><a href="<?php echo site_url('admin/transfercertificate/index') ?>"><?php echo $this->lang->line('tc_settings');?> </a></li>
						<?php } ?>
                    </ul>
                </div>
            </div>
     ...
     <div class="box-body">
      <div class="row">
       <form role="form" action="<?php echo site_url('admin/transfercertificate/download') ?>" method="post" class="">
         ...
         <table class="table table-striped table-bordered table-hover example" cellspacing="0" width="100%" data-export-title="<?php echo $this->lang->line('student_list');?>">
          <thead>
           <tr>
            ...
            <th width="5%"><?php echo $this->lang->line('reissue'); ?></th>
          ...
          <tbody>
           ...
           <tr>
            ...
            <td class="dt-type-numeric"><input type="checkbox" name="is_regenerte_<?php echo $student['student_session_id']; ?>" id="is_regenerte_<?php echo $student['student_session_id']; ?>" value="1" data-toggle="tooltip"  autocomplete="off" ></td>
            <td>
            <button type="button" class="btn btn-primary btn-xs download_pdf" data-student_session_id="<?php echo $student['student_session_id']; ?>" data-action="download" data-toggle="tooltip" data-original-title="<?php echo $this->lang->line('download'); ?>" data-student_id="<?php echo $student['id'] ?>" data-student_name="<?php echo $student_name; ?>" data-admission_no="<?php echo $student['admission_no']; ?>" data-loading-text="<i class='fa fa-circle-o-notch fa-spin'></i>" autocomplete="off"><i class="fa fa-download"></i></button>
            </td>
           </tr>
           <?php
           $count++;
