                                    ...
                                    <div class="panel panel-default">
                                        <div class="panel-heading">
                                            <h4 class="panel-title">
                                                <a class="displayblock" data-toggle="collapse" class="" data-parent="#accordion" href="#collapse<?php echo $custom_field_table_key ?>"><i class="more-less fa fa-plus pt3"></i><?php echo $custom_field_table_value; ?></a>
                                            </h4>
                                        </div>
                ...
                ?>
                                                            <li id="<?php echo $records_fields_value['id']; ?>" class="list-group-item-sort text-left">
                                                                <span class="sort-action">
                                                                    ...
                                                                    <a onclick = "return confirm('<?php echo $this->lang->line('delete_confirm'); ?>')" href="<?php echo site_url('admin/customfield/delete/' . $records_fields_value['id']); ?>" class="btn btn-xs" data-toggle="tooltip" data-original-title="<?php echo $this->lang->line('delete'); ?>" data-id="1" id="deleteItem"  data-toggle="modal" data-target="#confirm-delete"><i class="fa fa-remove"></i></a>
