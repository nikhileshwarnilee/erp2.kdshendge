                ...
                <div class="timeline-item">
                    <span class="time">
                        ...
                        if ($this->rbac->hasPrivilege('follow_up_admission_enquiry', 'can_delete')) {
                            ?>
                            <a class="text-right" data-toggle="tooltip" title="" onclick="delete_next_call(<?php echo $value['id']; ?>,<?php echo $id; ?>,'<?php echo $value['created_by']; ?>')" data-original-title="<?php echo $this->lang->line('delete'); ?>"><i class="fa fa-trash"></i></a>
                        <?php } ?></span>
