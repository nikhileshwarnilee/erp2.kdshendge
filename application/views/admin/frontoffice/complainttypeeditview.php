                ...
                <div class="col-md-4">
                    ...
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title"><?php echo $this->lang->line('edit_complaint_type'); ?></h3>
                        </div><!-- /.box-header -->
                ...
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        ...
                        <div class="mailbox-messages table-responsive overflow-visible">
                            <table class="table table-hover table-striped table-bordered example"  data-export-title="<?php echo $this->lang->line('complain_type_list');?>">
                                <thead>
                                    <tr>                                    
