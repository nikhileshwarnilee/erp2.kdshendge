...
?>
            ...
            <div class="task-info task-single-inline-wrap ptt10">
                <h5><span class="text-dark"><?php echo $this->lang->line('assigned'); ?>:</span> <?php if (!empty($assigned_staff)) {echo $assigned_staff['name'] . ' ' . $assigned_staff['surname'];?> <?php if ($assigned_staff['employee_id'] != '') {echo ' (' . $assigned_staff['employee_id'] . ')';}}?></h5>
            </div>

            <hr class="taskseparator w-100" />
