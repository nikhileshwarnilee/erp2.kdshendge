                ...
                <div class="col-md-4">
                    ...
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title"><?php echo $this->lang->line('edit_postal_dispatch'); ?></h3>
                        </div><!-- /.box-header -->
                ...
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        ...
                        <div class="mailbox-messages table-responsive overflow-visible-lg">
                            <table class="table table-hover table-striped table-bordered example"  data-export-title="<?php echo $this->lang->line('postal_dispatch_list');?>">
                                <thead>
                                    <tr>
                                        ...
                                        foreach ($DispatchList as $key => $value) {                               
                                            ...
                                            <tr>
                                                ...
                                                <td class="mailbox-date pull-right white-space-nowrap">
                                                    ...
                                                    <?php if ($value->image !="") { ?>
                                                        <a href="<?php echo base_url(); ?>admin/dispatch/download/<?php echo $value->id; ?>" class="btn btn-primary btn-xs" data-toggle="tooltip" title="" data-original-title="<?php echo $this->lang->line('download'); ?>">
                                                            <i class="fa fa-download"></i>
                                                        </a>                                                     <?php } ?>
                                                    <?php if ($this->rbac->hasPrivilege('postal_dispatch', 'can_edit')) { ?>
                                                    <a href="<?php echo base_url(); ?>admin/dispatch/editdispatch/<?php echo $value->id; ?>"  class="btn btn-primary btn-xs" data-toggle="tooltip" title="" data-original-title="<?php echo $this->lang->line('edit'); ?>">
                                                    ...
                                                    if ($this->rbac->hasPrivilege('postal_dispatch', 'can_delete')) {
                                                        ?> 
                                                        <a href="<?php echo base_url(); ?>admin/dispatch/delete/<?php echo $value->id; ?>" class="btn btn-primary btn-xs" data-toggle="tooltip" title="" onclick="return confirm('<?php echo $this->lang->line('delete_confirm') ?>');" data-original-title="<?php echo $this->lang->line('delete'); ?>">
