                                        ...
                                        foreach ($DispatchList as $key => $value) {
                                            ...
                                            <tr>
                                                ...
                                                <td class="mailbox-date pull-right white-space-nowrap">
                                                    <a onclick="getRecord('<?php echo $value->id; ?>')" class="btn btn-primary btn-xs" data-target="#receviedetails" data-toggle="modal" data-original-title="<?php echo $this->lang->line('view')?>">
