                ...
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped table-bordered table-hover example" data-export-title="<?php echo $this->lang->line('event_list'); ?>">
                                <thead>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td class="white-space-nowrap">
                                                <a onclick="view_event_data('<?php echo $value['id']; ?>')" class="btn btn-primary btn-xs" data-toggle="tooltip" title="" data-original-title="<?php echo $this->lang->line('view') ?>"><i class="fa fa-reorder"></i></a>

                                                <?php if ($this->rbac->hasPrivilege('events', 'can_edit')) { ?>
                                                    <a class="btn btn-primary btn-xs" onclick="edit('<?php echo $value['id']; ?>')" data-toggle="tooltip" title="" data-original-title="<?php echo $this->lang->line('edit'); ?>"><i class="fa fa-pencil"></i></a>
                                                <?php }
                                                if ($this->rbac->hasPrivilege('events', 'can_delete')) { ?>
                                                    <a onclick="event_delete('<?php echo $value['id']; ?>')" class="btn btn-primary btn-xs" data-toggle="tooltip" title="" data-original-title="<?php echo $this->lang->line('delete') ?>"><i class="fa fa-remove"></i></a>
                                                <?php } ?>
                    ...
                    <div class="row">
                        ...
                        <div id="sessionlist" class="form-group col-xs-12 col-sm-12 col-md-12 col-lg-12 hide">
                            ...
                            <select autofocus="" id="session_id" name="session_id" class="form-control">
                                ...
                                ?>
                                    <option value="<?php echo $sessions['id'] ?>" 
                                    <?php
                                     if (set_value('session_id') == $sessions['id']) {
