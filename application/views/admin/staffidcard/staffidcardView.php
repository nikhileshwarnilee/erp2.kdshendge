        ...
        $this->session->unset_userdata('msg'); ?>
                                ...
                                <div class="form-group switch-inline">
                                    ...
                                    <div class="material-switch switchcheck">
                                        ...
                                        <label for="enable_staff_mother_name" class="label-info-success"></label>
                                    </div>
                                </div>
                                <div class="form-group switch-inline">
                ...
                <div class="box box-primary" id="hroom">
                    ...
                    <div class="box-body">
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped table-bordered table-hover example"  data-export-title="<?php echo $this->lang->line('staff_id_card_list');?>">
                                <thead>
                                    <tr>
