    ...
    ?>
        ...
        ?>
                                        ...
                                        <div class="fadeheight-sms">
                                         <p class=""> <a class="uploadclosebtn" data-toggle="tooltip" data-original-title="<?php echo $this->lang->line('delete_background_image'); ?>"><i class="fa fa-trash-o" onclick="removebackground_image()"></i></a><?php echo $editstaffidcard[0]->background; ?>
                                         </p>
                                        </div>
                                    </div>
                                        <?php }?>
        ...
        ?>
                                        ...
                                        <div class="fadeheight-sms">
                                         <p class=""> <a class="uploadclosebtn" data-toggle="tooltip" data-original-title="<?php echo $this->lang->line('delete_logo_image'); ?>"><i class="fa fa-trash-o" onclick="removelogo_image()"></i></a><?php echo $editstaffidcard[0]->logo; ?>
                                         </p>
                                        </div>
                                    </div>
                                        <?php }?>
        ...
        ?>
                                        ...
                                        <div class="fadeheight-sms">
                                         <p class=""> <a class="uploadclosebtn" data-toggle="tooltip" data-original-title="<?php echo $this->lang->line('delete_sign_image'); ?>"><i class="fa fa-trash-o" onclick="removesign_image()"></i></a><?php echo $editstaffidcard[0]->sign_image; ?>
                                         </p>
                                        </div>
                                    </div>
                                    <?php }?>
                                ...
                                <div class="form-group switch-inline">
                                    ...
                                    <div class="material-switch switchcheck">
                                        ...
                                        <label for="enable_name" class="label-info-success"></label>
                                    </div>
                                </div>
                                <div class="form-group switch-inline">
                                    ...
                                    <div class="material-switch switchcheck">
                                        ...
                                        <label for="enable_staff_id" class="label-info-success"></label>
                                    </div>
                                </div>
                                   <div class="form-group switch-inline">
                                    ...
                                    <div class="material-switch switchcheck">
                                        ...
                                        <label for="enable_designation" class="label-info-success"></label>
                                    </div>
                                </div>
                                <div class="form-group switch-inline">
                                    ...
                                    <div class="material-switch switchcheck">
                                        ...
                                        <label for="enable_department" class="label-info-success"></label>
                                    </div>
                                </div>
                                <div class="form-group switch-inline">
                                    ...
                                    <div class="material-switch switchcheck">
                                        ...
                                        <label for="enable_fathers_name" class="label-info-success"></label>
                                    </div>
                                </div>
                                <div class="form-group switch-inline">
                                    ...
                                    <div class="material-switch switchcheck">
                                        ...
                                        <label for="enable_mother_name" class="label-info-success"></label>
                                    </div>
                                </div>
                                <div class="form-group switch-inline">
                                    ...
                                    <div class="material-switch switchcheck">
                                        ...
                                        <label for="enable_date_of_joining" class="label-info-success"></label>
                                    </div>
                                </div>
                                <div class="form-group switch-inline">
                                    ...
                                    <div class="material-switch switchcheck">
                                        ...
                                        <label for="enable_staff_permanent_address" class="label-info-success"></label>
                                    </div>
                                </div>
                                 <div class="form-group switch-inline">
                                    ...
                                    <div class="material-switch switchcheck">
                                        ...
                                        <label for="enable_staff_phone" class="label-info-success"></label>
                                    </div>
                                </div>
                                <div class="form-group switch-inline">
                                    ...
                                    <div class="material-switch switchcheck">
                                        ...
                                        <label for="enable_staff_dob" class="label-info-success"></label>
                                    </div>
                                </div>
                                    <div class="form-group switch-inline">
                                    ...
                                    <div class="material-switch switchcheck">
                                        ...
                                        <label for="enable_vertical_card" class="label-info-success"></label>
                                    </div>
                                </div>
                                <div class="form-group switch-inline">
                                    ...
                                    <div class="material-switch switchcheck">
                                        ...
                                        <label for="enable_staff_barcode" class="label-info-success"></label>
                                    </div>
                                </div>
                            </div><!-- /.box-body -->
    ...
    $count = 1;
     ...
     <img class="object-fit-cover fit-image-40" src="<?php echo $this->media_storage->getImageURL('uploads/staff_id_card/background/'.$staffidcard_value->background); ?>" width="40">
                                                ...
                                                <td class="mailbox-date pull-right no-print white-space-nowrap">
                                                    <a data-id="<?php echo $staffidcard_value->id ?>" class="btn btn-primary btn-xs view_data"  data-toggle="tooltip" title="<?php echo $this->lang->line('view'); ?>">
                                                        <i class="fa fa-reorder"></i>
                                                    </a>
                                                    <?php
if ($this->rbac->hasPrivilege('staff_id_card', 'can_edit')) {
            ?>
                                                        <a href="<?php echo base_url(); ?>admin/staffidcard/edit/<?php echo $staffidcard_value->id ?>" class="btn btn-primary btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('edit'); ?>">
        ...
        if ($this->rbac->hasPrivilege('staff_id_card', 'can_delete')) {
            ?>
                                                        <a href="<?php echo base_url(); ?>admin/staffidcard/delete/<?php echo $staffidcard_value->id ?>" class="btn btn-primary btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('delete'); ?>" onclick="return confirm('<?php echo $this->lang->line('delete_confirm') ?>');">
