...
<li><a href="#tab_parent" data-toggle="tab"><?php echo $this->lang->line('parent') ?></a></li>
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane active table-responsive" id="tab_students">
                            ...
                            <table class="table table-striped table-bordered table-hover example"  data-export-title="<?php echo $this->lang->line('users'); ?>" cellspacing="0" width="100%">
                                <thead>
                                    <tr>
                                        <th class="dt-body-left dt-head-left dt-type-numeric" ><?php echo $this->lang->line('admission_no'); ?></th>
                                ...
                                <tbody>
                                    ...
                                    if (!empty($studentList)) {
                                        ...
                                        foreach ($studentList as $student) {
                                            ?>
                                            <tr>
                                                <td class="dt-body-left dt-head-left dt-type-numeric" ><?php echo $student['admission_no']; ?></td>
                                                <td>
                                                ...
                                                <td class="relative">
                                                    <div class="float-rtl-right">
                                                        <div class="material-switch pull-right">
                                                            ...
                                                            <label for="student<?php echo $student['user_tbl_id'] ?>" class="label-info-success"></label>
                                                        </div>
                                                    </div>    
                                                </td>
                                            </tr>
                        ...
                        <div class="tab-pane table-responsive" id="tab_parent">
                            ...
                            <table class="table table-striped table-bordered table-hover example" cellspacing="0" width="100%">
                                <thead>
                                    <tr>
                                        <th class="dt-body-left dt-head-left dt-type-numeric" ><?php echo $this->lang->line('guardian_name'); ?></th>
                                ...
                                <tbody>
                                    ...
                                    if (!empty($parentList)) {
                                        ...
                                        foreach ($parentList as $parent) {
                                            ?>
                                            <tr>
                                                <td class="dt-body-left dt-head-left dt-type-numeric" ><?php echo $parent->guardian_name; ?></td>
                                                ...
                                                <td class="relative">
                                                    <div class="float-rtl-right">
                                                        <div class="material-switch pull-right">
                                                            ...
                                                            <label for="parent<?php echo $parent->id ?>" class="label-info-success"></label>
                                                        </div>
                                                    </div>
                        ...
                        <div class="tab-pane table-responsive" id="tab_staff">
                            ...
                            <table class="table table-striped table-bordered table-hover example" cellspacing="0" width="100%">
                                <thead>
                                    <tr>
                                        <th class="dt-body-left dt-head-left dt-type-numeric" ><?php echo $this->lang->line('staff_id'); ?></th>
                                ...
                                <tbody>
                                    ...
                                    if (!empty($staffList)) {
                                        ...
                                        foreach ($staffList as $staff) {
                                            ?>
                                            <tr>
                                                <td class="dt-body-left dt-head-left dt-type-numeric" > <?php echo $staff['employee_id'] ?></td>
                                                ...
                                                <td class="relative">
                                                    <div class="float-rtl-right">
                                                        <div class="material-switch pull-right float-rtl-right">
                                                            ...
                                                            <label for="staff<?php echo $staff['id'] ?>" class="label-info-success"></label>
                                                        </div>
                                                    </div>    
                                                </td>
                                            </tr>
