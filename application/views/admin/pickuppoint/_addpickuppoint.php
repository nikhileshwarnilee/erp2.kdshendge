...
?>
<div id="<?php echo $delete_string;?>" class="pickpoint-row">
          <div class="row"> 
        <div class="col-md-4">
        ...
        <div class="col-md-1 ">
            <div class="form-group text-center">
                <label>&nbsp;</label>
               <div class="pt3" <?php if(empty($result)){ ?> onclick="remove_pickpoint('<?php echo $delete_string;?>')" <?php }else{ ?> onclick="remove_editpickpoint('<?php echo $delete_string;?>')" <?php }?>  class="section_id_error text-danger">&nbsp;<i class="fa fa-remove btn btn-primary"></i></div>               
            </div>
        </div>
     </div>
</div>