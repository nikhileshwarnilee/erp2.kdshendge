                    ...
                    <div class="box-body">
                        ...
                        <div class="mailbox-messages">
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover example" data-export-title="<?php echo $this->lang->line('route_pickup_point');?>">
                                    <thead>
                                        <tr>
            ...
            ?>
                                                    ...
                                                    <td class="dt-body-left dt-head-left">
                                                        <?php if ($this->rbac->hasPrivilege('route_pickup_point', 'can_view')) {?>
                                                             <a onclick="reorder('<?php echo $data["transport_route_id"]; ?>')" class="btn btn-primary btn-xs"  data-toggle="tooltip" title="<?php echo ('Reorder'); ?>">
                                                                <i class="fa fa-reorder"></i>
                                                            </a>

                                                        <?php }if ($this->rbac->hasPrivilege('route_pickup_point', 'can_edit')) {?>
                                                            <a onclick="edit('<?php echo $data["transport_route_id"]; ?>')" class="btn btn-primary btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('edit'); ?>">
                                                                <i class="fa fa-pencil"></i>
                                                            </a>
                                                        <?php }if ($this->rbac->hasPrivilege('route_pickup_point', 'can_delete')) {?>
                                                            <a href="<?php echo base_url(); ?>admin/pickuppoint/delete/<?php echo $data['transport_route_id'] ?>"class="btn btn-primary btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('delete'); ?>" onclick="return confirm('<?php echo $this->lang->line('delete_confirm') ?>');">
...
<script type="text/javascript">
    ...
    let rowCount = $('.pickpoint-row').length; 
    if (rowCount>1) {
