...
echo $this->session->flashdata('msg');
    ...
    ?>
                                            ...
                                            <div class="form-group">
                                                 <div class="material-switch">
                                                    <input id="online_admission" name="online_admission" type="checkbox" data-role="field_" class="enableexam"   value="1" <?php echo set_checkbox('online_admission', '1', (set_value('online_admission', $result->online_admission) == 1) ? true : false); ?>>
                                                      <label for="online_admission" class="label-info-success"></label>
                                                 </div>
                                           </div>
                                        </div>
                                    <div  id="settingclm">
                                           ...
                                           <div class="col-lg-9 col-md-8 col-sm-7">
                                                <div class="form-group">
                                                    <div class="material-switch">
                                                     ...
                                                     <label for="chk_yes" class="label-info-success"></label>
                                                </div>
                                                </div>
                                             </div>
                                        </div>
                                                ...
                                                <div class="col-lg-6 col-md-8 col-sm-7">
                                                    <div class="row">
                                                        <div class="col-md-8 col-xs-10">
                                                            <div class="form-group">
                                                                <input type="file" data-height="38" name="file" class="form-control filestyle">
                                                        ...
                                                        <div class="col-md-1 col-xs-2">
                                                            <div class="form-group">
                                                                ...
                                                                <a href="<?php echo base_url(); ?>admin/onlineadmission/download/<?php echo $sch_setting_detail->id; ?>" data-toggle="tooltip" data-original-title='<?php echo $this->lang->line('download_application_form'); ?>' class='btn btn-primary btn-sm btn-sm-md'><i class="fa fa-download"></i></a>                                                          
                                                                <?php } ?> 
                                                            </div>
                                                        </div>
                                                     </div>
                            ...
                            <div class="row">
                                <div class="col-sm-12 ">
                                    <button type="submit" name="submitbtn" id="submitbtn" value="submitbtn" class="btn btn-primary pull-right"> <?php echo $this->lang->line('save'); ?></button>
                                </div>
                            </div>
                          </form>
                        </div><!-- box body-->
