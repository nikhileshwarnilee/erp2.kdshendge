...
?>
        ...
        <div style="width: 100%; margin: 0 auto; padding: 10px 5px 5px;position: relative;">
...
if ($marksheet->date != "") {
    ?>
                    <tr>
                        <td valign="top" style="font-weight: bold; padding-left: 30px; padding-top: 10px;"><?php echo $this->lang->line('date'); ?> : <?php echo $marksheet->date; ?></td>
                    </tr>
                    <?php
}
?>
