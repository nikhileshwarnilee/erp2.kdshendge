...
if (isset($error_message)) {
    ...
    ?>
        ...
        ?>
                                        <div class="header_image">
                                            <div class="fadeheight-sms">
                                             <p class=""> <a class="uploadclosebtn" title="<?php echo $this->lang->line('delete'); ?>"><i class="fa fa-trash-o" onclick="removeheader_image()"></i></a><?php echo $marksheet->header_image; ?>
                                             </p>
                                            </div>
                                        </div>
                                    <?php }?>
        ...
        ?>
                                        <div class="left_logo">
                                            <div class="fadeheight-sms">
                                             <p class=""> <a class="uploadclosebtn" title="<?php echo $this->lang->line('delete'); ?>"><i class="fa fa-trash-o" onclick="removeleft_logo()"></i></a><?php echo $marksheet->left_logo; ?>
                                             </p>
                                            </div>
                                        </div>
                                    <?php }?>
        ...
        ?>
                                        <div class="right_logo">
                                            <div class="fadeheight-sms">
                                             <p class=""> <a class="uploadclosebtn" title="<?php echo $this->lang->line('delete'); ?>"><i class="fa fa-trash-o" onclick="removeright_logo()"></i></a><?php echo $marksheet->right_logo; ?>
                                             </p>
                                            </div>
                                        </div>
                                    <?php }?>
        ...
        ?>
                                        <div class="left_sign">
                                            <div class="fadeheight-sms">
                                             <p class=""> <a class="uploadclosebtn" title="<?php echo $this->lang->line('delete'); ?>"><i class="fa fa-trash-o" onclick="removeleft_sign()"></i></a><?php echo $marksheet->left_sign; ?>
                                             </p>
                                            </div>
                                        </div>
                                    <?php }?>
        ...
        ?>
                                        <div class="middle_sign">
                                            <div class="fadeheight-sms">
                                             <p class=""> <a class="uploadclosebtn" title="<?php echo $this->lang->line('delete'); ?>"><i class="fa fa-trash-o" onclick="removemiddle_sign()"></i></a><?php echo $marksheet->middle_sign; ?>
                                             </p>
                                            </div>
                                        </div>
                                    <?php }?>
        ...
        ?>
                                        <div class="right_sign">
                                            <div class="fadeheight-sms">
                                             <p class=""> <a class="uploadclosebtn" title="<?php echo $this->lang->line('delete'); ?>"><i class="fa fa-trash-o" onclick="removeright_sign()"></i></a><?php echo $marksheet->right_sign; ?>
                                             </p>
                                            </div>
                                        </div>
                                    <?php }?>
        ...
        ?>
                                        <div class="background_img">
                                            <div class="fadeheight-sms">
                                             <p class=""> <a class="uploadclosebtn" title="<?php echo $this->lang->line('delete'); ?>"><i class="fa fa-trash-o" onclick="removebackground_img()"></i></a><?php echo $marksheet->background_img; ?>
                                             </p>
                                            </div>
                                        </div>
                                    <?php }?>
                                ...
                                <div class="form-group switch-inline">
                                    ...
                                    <div class="material-switch switchcheck">
                                        ...
                                        <label for="is_division" class="label-info-success"></label>
                                    </div>
                                </div>
                                   <div class="form-group switch-inline">
                                    ...
                                    <div class="material-switch switchcheck">
                                        ...
                                        <label for="is_rank" class="label-info-success"></label>
                                    </div>
                                </div>
                                <div class="form-group switch-inline">
                                ...
                                <div class="form-group switch-inline">
                                    ...
                                    <div class="material-switch switchcheck">
                                        ...
                                        <label for="is_teacher_remark" class="label-info-success"></label>
                                    </div>
                                </div>
                            </div><!-- /.box-body -->
                ...
                <div class="box box-primary" id="hroom">
                    ...
                    <div class="box-body">
                        <div class="table-responsive mailbox-messages overflow-visible">
                            ...
                            <table class="table table-striped table-bordered table-hover example" data-export-title="<?php echo $this->lang->line('marksheet_list');?>">
                                <thead>
                                    <tr>
...
if ($this->rbac->hasPrivilege('design_marksheet', 'can_edit')) {
            ?>
                                                        <a href="<?php echo site_url('admin/marksheet/edit/' . $certificate->id); ?>" class="btn btn-primary btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('edit'); ?>">
        ...
        if ($this->rbac->hasPrivilege('design_marksheet', 'can_delete')) {
            ?>
                                                        <a href="<?php echo base_url(); ?>admin/marksheet/delete/<?php echo $certificate->id ?>" class="btn btn-primary btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('delete'); ?>" onclick="return confirm('<?php echo $this->lang->line('delete_confirm') ?>');">
