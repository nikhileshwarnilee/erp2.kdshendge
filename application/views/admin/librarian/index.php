                ...
                <div class="box box-primary" id="tachelist">
                    ...
                    <div class="box-body">
                        ...
                        <div class="table-responsive mailbox-messages">
                            ...
                            <table class="table table-striped table-bordered table-hover example" id="members"  data-export-title="<?php echo $this->lang->line('members');?>">
                                <thead>
                                    <tr>
                                        <th class="dt-body-left dt-head-left"><?php echo $this->lang->line('member_id'); ?></th>
                                        <th class="dt-body-left dt-head-left"><?php echo $this->lang->line('library_card_no'); ?></th>
        ...
        ?>
                                            <tr>
                                                ...
                                                <td class="mailbox-date pull-right">
                                                    <a href="<?php echo base_url(); ?>admin/member/issue/<?php echo $member['lib_member_id'] ?>" class="btn btn-primary btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('issue_return'); ?>">
