...
<script>
    ...
    function add_topic() {
        ...
        var id = makeid(8);
        $('#topic_result').append('<div class="form-group relative" id="' + id + '"><label><?php echo $this->lang->line("topic_name"); ?></label><small class="req"> *</small><input type="text" name="topic[]" class="lessinput" /><span  onclick="remove_topic(' + id + ')" class="section_id_error text-danger cursor-pointer position-absolute top-v-center">&nbsp;<i class="fa fa-remove px-5"></i></span></div>');
...
<script>
    ...
    $(document).ready(function () {
        initDatatable('topic-list','admin/lessonplan/gettopiclist',[],[],50,
        [
            {
