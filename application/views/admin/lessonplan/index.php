    ...
    ?>
                ...
                <div class="box-body" id="transfee">
                    ...
                    <p class="pull-right clearboth">
                        ...
                        <a class="btn btn-default btn-xs displayinline" title="<?php echo $this->lang->line('print'); ?>" id="print" onclick="printDiv()" ><i class="fa fa-print"></i></a> 
                    </p><br clear="all" />
                    <div class="table-responsive">
                        <table class="table table-bordered topictable ptt10 table-switch" id="headerTable">
                            <tr class="hide" id="visible">
                                <td colspan="5" class="text-center"><b><?php echo $this->lang->line('syllabus_status_for') . ": " . $subject_name; ?></b></td>
                            </tr>
                            <tr>
                                <th width="30">#</th>
...
<?php if ($this->rbac->hasPrivilege('manage_syllabus_status', 'can_edit')) {?>
    <div class="material-switch pull-right">
                               ...
                               </div>     <?php echo $this->lang->line('action'); ?>
                                <?php }?>
</div>
                                </div>    
                               </th>
...
<div class="material-switch pull-right">
                    ...
                    ?> />
                                                                <label for="topic<?php echo $topic_value['id'] ?>" class="label-info-success"></label>
                                                            </div>
