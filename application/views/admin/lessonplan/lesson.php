<div class="content-wrapper">
    <section class="content-header">
        <h1>
            <i class="fa fa-mortar-board"></i><small></small>
        </h1>
    </section>
    <!-- Main content -->
...
<script>
    ...
    function add_lesson() {
        var id = makeid(8);
        $('#lesson_result').append('<div class="form-group relative" id="' + id + '"><label><?php echo $this->lang->line("lesson_name"); ?></label><small class="req"> *</small><br><input type="text" name="lessons[]" class="lessinput" /> <span  onclick="remove_lesson(' + id + ')" class="section_id_error text-danger cursor-pointer position-absolute top-v-center">&nbsp;<i class="fa fa-remove px-5"></i></span></div>');
    }
...
<script>
    ...
    $(document).ready(function () {
        initDatatable('topic-list','admin/lessonplan/getlessonlist',[],[],50,
        [
            {
                targets: [-1], // last column
                orderable: false,
                className: 'dt-body-right dt-head-right white-space-nowrap'
            },
            {
