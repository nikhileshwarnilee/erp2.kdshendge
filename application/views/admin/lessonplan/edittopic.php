...
?>
                            ...
                            <?php foreach ($edittopicname as $edittopicname_value) {?>
                                <div class="form-group relative" id="<?php echo $edittopicname_value['id']; ?>"><label><?php echo $this->lang->line("topic_name"); ?></label><small class="req"> *</small><input type="text" class="lessinput" name="topic_<?php echo $edittopicname_value['id']; ?>" value="<?php echo $edittopicname_value['name']; ?>" /><?php if ($this->rbac->hasPrivilege('topic', 'can_delete')) {?><span  onclick="remove_topic('<?php echo $edittopicname_value['id']; ?>')" class="section_id_error text-danger position-absolute top-v-center ">&nbsp;<i class="fa fa-remove px-5"></i></span> <?php }?></div>
                            <?php }?>
...
<script>
    ...
    function add_topic() {
        var id = makeid(8);
        $('#topic_result').append('<div class="form-group relative" id="' + id + '"><label><?php echo $this->lang->line("topic_name"); ?></label><small class="req"> *</small><input type="text" class="lessinput" name="topic[]"   /><span  onclick="remove_topic(' + id + ')" class="section_id_error text-danger position-absolute top-v-center">&nbsp;<i class="fa fa-remove px-5"></i></span></div>');	
...
<script>
    ...
    $(document).ready(function () {
        initDatatable('topic-list','admin/lessonplan/gettopiclist');
    });
} ( jQuery ) )
</script>