                            ...
                            <div class="tab-content">
                                <div class="tab-pane active table-responsive" id="tab_parent">
                                    <div class="download_label"><?php
                                        echo $this->lang->line('payroll_report');//$this->customlib->get_postmessage();
                                    ?></div>
                                    <table class="table table-striped table-bordered table-hover example table-fixed-header"  data-export-title="<?php echo $this->lang->line('payroll_report'); ?>">
                                        <thead class="header">
                                            <tr>
        ...
        foreach ($result as $key => $value) {
            ...
            <?php echo $this->lang->line(strtolower($value['month'])) . " - " . $value['year']; ?>
                                                    ...
                                                    <td>
                                                        ...
                                                        <div class="fee_detail_popover" style="display: none"><p class="text text-info"><?php echo $this->lang->line('mode'); ?>: <?php echo $payment_mode[$value["payment_mode"]] ?></p></div>
