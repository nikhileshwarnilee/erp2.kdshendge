                                            ...
                                            <tr>                                               
                                                ...
                                                <td class="mailbox-date pull-right no-print">
                                                    ...
                                                    if ($this->rbac->hasPrivilege('expense', 'can_edit')) {
                                                        ?>
                                                        <a href="<?php echo base_url(); ?>admin/expensehead/edit/<?php echo $category['id'] ?>" class="btn btn-primary btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('edit'); ?>">
                                                    ...
                                                    if ($this->rbac->hasPrivilege('expense', 'can_delete')) {
                                                        ?>
                                                        <a href="<?php echo base_url(); ?>admin/expensehead/delete/<?php echo $category['id'] ?>"class="btn btn-primary btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('delete'); ?>" onclick="return confirm('<?php echo $this->lang->line('delete_confirm') ?>');">
