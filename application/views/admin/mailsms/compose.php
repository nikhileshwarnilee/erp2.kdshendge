    ...
    $(document).on('click', '.add-btn', function () {
        ...
        if (record_id != "" && category_selected != "") {
            ...
            if (chkexists) {
                ...
                $(".send_list").append('<li class="list-group-item" id="' + category_selected + '-' + record_id + '"><i class="fa fa-user"></i> ' + value + ' ('+ category_selected_lang +') <i class="fa fa-trash pull-right text-danger"  data-toggle="tooltip" data-original-title="<?php echo $this->lang->line('delete') ?>"  onclick="delete_record(' + "'" + category_selected + '-' + record_id + "'" + ')"></i></li>');
            } else {
