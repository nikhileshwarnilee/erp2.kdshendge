							...
							<div class="row">
								<div class="col-md-12">
									<div class="form-group">
										<a class="btn btn-primary btn-sm pull-right checkbox-toggle delete_email_sms_log" ><?php echo $this->lang->line('delete_email_sms_log'); ?>  </a>
									</div>	
								</div>	
							</div>
						
                            <table class="table table-striped table-bordered table-hover example" data-export-title="<?php echo $this->lang->line('email_sms_log'); ?>">
                                <thead>
                                    <tr>
...
if ($message['is_class']) {
	...
	<td>
												<a href="<?php echo base_url(); ?>admin/mailsms/edit_schedule/<?php echo $message['id']; ?>/send_now" class="btn btn-primary btn-xs" data-toggle="modal" data-original-title="<?php echo $this->lang->line('view_edit'); ?>"><i class="fa fa-reorder"></i></a>
											</td>											
                                        </tr>
                                        <?php
}
...
<script>
	$(function () {
		$('.delete_email_sms_log').on('click', function () {			
			if (confirm("<?php echo $this->lang->line('confirm_delete') ?>")) {				
				$.ajax({
					url: '<?php echo base_url(); ?>admin/mailsms/delete_email_sms_log/',
