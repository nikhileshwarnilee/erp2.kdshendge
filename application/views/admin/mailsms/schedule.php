                ...
                <div class="box box-primary" >
                    ...
                    <div class="box-body">
                        <div class="table-responsive mailbox-messages">
                            ...
                            <table class="table table-striped table-bordered table-hover example" data-export-title="<?php echo $this->lang->line('schedule_email_sms_log');?>">
                                <thead>
                                    <tr>
    ...
    ?>
                                            ...
                                            <td class="mailbox-name">
                                                <?php if ($this->rbac->hasPrivilege('schedule_email_sms_log', 'can_edit')) {?>
                                                                                              ...
                                                                                              <a href="<?php echo base_url(); ?>admin/mailsms/edit_schedule/<?php echo $message['id']; ?>/schedule" class="btn btn-primary btn-xs" data-toggle="modal" data-original-title="<?php echo $this->lang->line('view_edit'); ?>"><i class="fa fa-reorder"></i></a>

                                                <?php }if ($this->rbac->hasPrivilege('schedule_email_sms_log', 'can_delete')) {?>

                                                <a href="#" class="btn btn-primary btn-xs delete_schedule" data-id="<?php echo $message['id']; ?>" data-toggle="modal" data-original-title="<?php echo $this->lang->line('delete'); ?>"><i class="fa fa-trash"></i></a>
                                                <?php }?>
                                            </td>
                                        </tr>
                                        <?php
