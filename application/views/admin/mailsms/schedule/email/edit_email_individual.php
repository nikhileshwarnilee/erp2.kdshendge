...
$(document).ready(function(){
    ...
    if (record_id !== "" && category_selected !== "" && typeof  obj.user_name !== "undefined") {       
        ...
        if (chkexists) {
            ...
            $(".send_list").append('<li style="height:auto" class="list-group-item" id="' + category_selected + '-' + record_id + '"><i class="fa fa-user"></i> ' + obj.user_name + ' ('+ category_selected +') <i class="fa fa-trash pull-right text-danger"  data-toggle="tooltip" data-original-title="<?php echo $this->lang->line('delete') ?>"  onclick="delete_record(' + "'" + category_selected + '-' + record_id + "'" + ')" title="<?php echo $this->lang->line('delete'); ?>"></i></li>');
                ...
                success: function (data) {
                    if (data.length > 0) {
                        setTimeout(function () {
                            ...
                            $("#search-query").css("background", "transparent");
                        }
                        , 1000);
                    } else {
                        $("#suggesstion-box").hide();
    ...
    $(document).on('click', '.add-btn', function () {
        ...
        if (record_id != "" && category_selected != "") {
            ...
            if (chkexists) {
                ...
                $("#search-query").attr('value', "").val("");
                $("#search-query").attr('data-record', "");
                $(".send_list").append('<li class="list-group-item" id="' + category_selected + '-' + record_id + '"><i class="fa fa-user"></i> ' + value + ' ('+ category_selected +') <i class="fa fa-trash pull-right text-danger" data-toggle="tooltip" data-original-title="<?php echo $this->lang->line('delete') ?>" onclick="delete_record(' + "'" + category_selected + '-' + record_id + "'" + ')"></i></li>');
