...
<div class="content-wrapper">
    <section class="content-header">
        <h1><i class="fa fa-bullhorn"></i> <?php //echo $this->lang->line('communicate'); 
                                            ?></h1>
    </section>
                                                    ...
                                                    <div class="col-md-6 col-lg-8">
                                                        ...
                                                        <ul class="list-group listcheckbox hide" id="send_to">
                                                            <li class="checkbox"><a href="#" class="small"><label>
                                                                        <input class="reset_checkbox" type="checkbox" name="send_to[]" <?php if (in_array('student', ($send_to_user)) && $send_to != null) {
                                                                                                                                            echo "checked";
                                                                                                                                        } ?> value="student" /><?php echo $this->lang->line('students'); ?></label></a></li>
                                                            <?php if ($sch_setting->guardian_name) { ?>
                                                                <li class="checkbox"><a href="#" class="small"><label>
                                                                            <input class="reset_checkbox" type="checkbox" name="send_to[]" <?php if (in_array('parent', ($send_to_user)) && $send_to != null) {
                                                                                                                                                echo "checked";
                                                                                                                                            } ?> value="parent" /><?php echo $this->lang->line('guardians'); ?></label></a></li>
                                                            <?php } ?>
                                                        </ul>
                                                    </div>
    ...
    function class_preview() {
        ...
        for (i = 0; i < quantos; i++) {
            ...
            $.ajax({
                ...
                type: 'post',
                data: {
                    img_name: event.target.files[i]['name'],
                    dir_path: urls,
                    file_type: event.target.files[i]['type'],
                    delete_id: i
                },
                dataType: 'json',
                success: function(response) {
