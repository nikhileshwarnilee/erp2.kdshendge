...
$(document).ready(function(){
    ...
    if (record_id != ""  && obj.user_name != '') {
        ...
        if (chkexists) {
            ...
            $(".send_list").append('<li class="list-group-item" id="' + category_selected + '-' + record_id + '"><i class="fa fa-user"></i> ' + obj.user_name + ' (' +category_selected.charAt(0).toUpperCase() + category_selected.slice(1) + ') <i class="fa fa-trash pull-right text-danger" onclick="delete_record(' + "'" + category_selected + '-' + record_id + "'" + ')" title="<?php echo $this->lang->line('delete'); ?>"></i></li>');
        } else {
