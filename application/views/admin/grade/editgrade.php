                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th>
                                            <table width="100%">
                                                <tr>
                                                    <th width="22%" class="pr15"><?php echo $this->lang->line('grade_name'); ?></th>
                                                    <th width="22%" class="pr15"><?php echo $this->lang->line('percent_from_upto'); ?></th>
                                                    <th width="22%" class="pr15"><?php echo $this->lang->line('grade_point'); ?></th>
                                                    <th width="22%" class="pr15"><?php echo $this->lang->line('description'); ?></th>
                                                    <th class="text-right white-space-nowrap"><?php echo $this->lang->line('action'); ?></th>
                                                </tr>
                                            </table>
                                        </th>
                                    </tr>
...
if (!empty($grade['exam_grade_values'])) {
            foreach ($grade['exam_grade_values'] as $grade_key => $grade_value) {
                ?>
                                                                <tr>
                                                                    <td width="22%" class="pr15"><?php echo $grade_value->name ?></td>
                                                                    <td width="22%" class="pr15"><?php echo $grade_value->mark_upto . " " . $this->lang->line('to') . " " . $grade_value->mark_from; ?> </td>
                                                                    <td width="22%" class="pr15"><?php echo $grade_value->point ?> </td>
                                                                    <td width="22%" class="pr15"><?php echo $grade_value->description ?> </td>
...
if ($this->rbac->hasPrivilege('marks_grade', 'can_edit')) {
                    ?>                                                    
                                                                            <a href="<?php echo base_url(); ?>admin/grade/edit/<?php echo $grade_value->id; ?>" class="btn btn-primary btn-xs" data-toggle="tooltip" title="<?php echo $this->lang->line('edit'); ?>">
                ...
                if ($this->rbac->hasPrivilege('marks_grade', 'can_delete')) {
                    ?>
                                                                            <a href="<?php echo base_url(); ?>admin/grade/delete/<?php echo $grade_value->id; ?>"class="btn btn-primary btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('delete'); ?>" onclick="return confirm('<?php echo $this->lang->line('delete_confirm') ?>');">
