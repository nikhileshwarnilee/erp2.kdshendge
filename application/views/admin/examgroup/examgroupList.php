                ...
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        ...
                        <div class="mailbox-messages table-responsive">
                            ...
                            <table class="table table-hover table-striped table-bordered example"   data-export-title="<?php echo $this->lang->line('exam_group_list');?>">
                                <thead>
                                    <tr>
                                        ...
                                        ?>
                                            <tr>
                                                <td>
                                                  ...
                                                  <span data-toggle="popover" class="detail_popover"><?php echo $examgroup->name; ?></span>
                                                ...
                                                <td class="white-space-nowrap">
                                                    <?php if ($this->rbac->hasPrivilege('exam', 'can_view')) { ?>
                                                        <a href="<?php echo base_url(); ?>admin/examgroup/addexam/<?php echo $examgroup->id ?>"
                                                            class="btn btn-primary btn-xs" data-toggle="tooltip" title="<?php echo $this->lang->line('add_exam'); ?>">
                                                    ...
                                                    ?>
                                                        <a href="<?php echo site_url('admin/examgroup/edit/' . $examgroup->id); ?>" class="btn btn-primary btn-xs" data-toggle="tooltip" title="<?php echo $this->lang->line('edit'); ?>">
                                                    ...
                                                    ?>
                                                        <a href="<?php echo site_url('admin/examgroup/delete/' . $examgroup->id); ?>" class="btn btn-primary btn-xs" data-toggle="tooltip" title="<?php echo $this->lang->line('delete'); ?>" onclick="return confirm('<?php echo $this->lang->line('delete_confirm') ?>');">
