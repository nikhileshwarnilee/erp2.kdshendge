...
<form method="POST" action="<?php echo site_url('admin/examgroup/ajaxConnectForm'); ?>" id="connectExamForm">
	...
	<div class="modal-footer">
        <button type="submit" class="btn btn-primary" id="load" name="reset" data-loading-text="<i class='fa fa-spinner fa-spin '></i> <?php echo $this->lang->line('saving'); ?>"><?php echo $this->lang->line('reset_link_exam'); ?></button> &nbsp;
