                                        ...
                                        foreach ($exam_subjects as $exam_subject_key => $exam_subject_value) {
                                            ...
                                            <tr>
                                                ...
                                                <td class="col-sm-1 text-right">  
                                                    ...
                                                    <button type="button" class="btn btn-primary btn-xs" data-toggle="modal" data-target="#subjectModal" data-subject_name="<?php echo $exam_subject_value->subject_name; ?>" data-subject_id="<?php echo $exam_subject_value->id; ?>" data-teachersubject_id="<?php echo $exam_subject_value->subject_id; ?>" ><i class="fa fa-newspaper-o" aria-hidden="true"></i></button></span>
                                                </td>
                                            </tr>
                                            <?php
                                        }
