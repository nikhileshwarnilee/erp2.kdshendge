                ...
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        <div class="mailbox-messages table-responsive">
                            ...
                            <table class="table table-hover table-striped table-bordered example"  data-export-title="<?php echo $this->lang->line('item_stock_list');?>">
                                <thead>
                                    <tr>
...
if ($items['description'] == "") {
        ...
        ?>
            ...
            ?>
                                                        <a href="<?php echo base_url(); ?>admin/itemstock/download/<?php echo $items['id'] ?>" class="btn btn-primary btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('download'); ?>">
                                                            <i class="fa fa-download"></i>
                                                        </a>
                                                    <?php }
        ?>

                                                    <a href="<?php echo base_url(); ?>admin/itemstock/edit/<?php echo $items['id'] ?>" class="btn btn-primary btn-xs"  data-toggle="tooltip" data-record-id="<?php echo $items['quantity']; ?>" title="<?php echo $this->lang->line('edit'); ?>">
                                                        <i class="fa fa-pencil"></i>
                                                    </a>

                                                    <a href="<?php echo base_url(); ?>admin/itemstock/delete/<?php echo $items['id'] ?>" class="btn btn-primary btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('delete'); ?>" onclick="return confirm('<?php echo $this->lang->line('delete_confirm') ?>');">
