                ...
                <div class="box box-info"><div class="box-header ptbnull">
                    ...
                    <div class="box-body table-responsive">
                        <div > <div class="download_label"><?php echo $this->lang->line('vehicle_list'); ?></div>
                            <table class="table table-hover table-striped table-bordered example"  data-export-title="<?php echo $this->lang->line('vehicle_list');?>"> 
                                <thead>
                                    <tr>
                                    ...
                                    foreach ($listVehicle as $key => $data) { ?>
                                        <tr>
                                                ...
                                                <td class="mailbox-date pull-right no-print white-space-nowrap">
                                                        ...
                                                        <a class="btn btn-primary btn-xs vehicledetails" data-id="<?php echo $data['id'] ?>"  data-toggle="tooltip" title="<?php echo $this->lang->line('view'); ?>"><i class="fa fa-reorder"></i>
                                                        </a>
                                                        
                                                    <?php if ($this->rbac->hasPrivilege('vehicle', 'can_edit')) { ?>
                                                        <a class="btn btn-primary btn-xs editvehicle" data-id="<?php echo $data['id'] ?>"  data-toggle="tooltip" title="<?php echo $this->lang->line('edit'); ?>"><i class="fa fa-pencil"></i>
                                                        </a>
                                                    <?php }if ($this->rbac->hasPrivilege('vehicle', 'can_delete')) { ?>
                                                        <a href="<?php echo base_url(); ?>admin/vehicle/delete/<?php echo $data['id'] ?>"class="btn btn-primary btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('delete'); ?>" onclick="return confirm('<?php echo $this->lang->line('delete_confirm') ?>');"><i class="fa fa-remove"></i>
                                                        </a>
                                                    <?php } ?>
                                                </td>
                                        </tr>
