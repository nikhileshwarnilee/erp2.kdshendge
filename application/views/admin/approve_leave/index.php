            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="box-body table-responsive overflow-visible-lg">
                        ...
                        <div >
                            <table class="table table-hover table-striped table-bordered example"  data-export-title="<?php echo $this->lang->line('approve_leave_list');?>">
                                <thead>
                                    <tr>
                                    ...
                                    foreach ($results as $value) {
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-right white-space-nowrap">
                                                ...
                                                if ($value['docs'] != '') {
                                                    ?>
                                                    <a href="<?php echo base_url(); ?>admin/approve_leave/download/<?php echo $value['id'] ?>" class="btn btn-primary btn-xs" data-toggle="tooltip" title="" data-original-title="<?php echo $this->lang->line('download'); ?>">
                                                ...
                                                <a onclick="get('<?php echo $value['id']; ?>', '<?php echo $value['class_id']; ?>', '<?php echo $value['section_id']; ?>', '<?php echo $value['status']; ?>')" class="btn btn-primary btn-xs" data-toggle="tooltip" data-original-title="<?php echo $this->lang->line('edit') ?>"><i class="fa fa-pencil"></i> </a>
                                                
                                                <?php } if ($this->rbac->hasPrivilege('approve_leave', 'can_delete')) { ?>
                                                
                                                <a onclick="delete_leave('<?php echo $value['id']; ?>', '<?php echo $value['class_id']; ?>', '<?php echo $value['section_id']; ?>');"  data-toggle="tooltip" data-original-title="<?php echo $this->lang->line('delete') ?>" class="btn btn-primary btn-xs"><i class="fa fa-trash" ></i> </a>
