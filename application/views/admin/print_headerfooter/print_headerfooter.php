            ...
            <div class="col-md-12">
                <div class="nav-tabs-custom box box-primary theme-shadow">
                    <ul class="nav nav-tabs pull-right flex-sm-wrap d-xs-flex">
                        ...
                        <li><a href="#tab_6" data-toggle="tab"><?php echo $this->lang->line('email'); ?></a></li>
...
if ($this->session->flashdata('msg') != '') {
    ...
    $this->session->unset_userdata('msg'); ?>
                        ...
                        <div class="tab-pane" id="tab_6">
                            <form role="form" id="form6" enctype="multipart/form-data" action="<?php echo site_url('admin/print_headerfooter/edit') ?>" class="" method="post">
                                <div class="row">
                                    <div class="col-md-12"> 
                                        <div class="form-group">
                                            <label><?php echo $this->lang->line('header_image') . " (2230px X 300px)"; ?><small class="req"> *</small></label>
                                            <input id="email_documents" data-default-file="<?php echo $this->customlib->getBaseUrl() ?>./uploads/print_headerfooter/email/<?php echo $result[5]['header_image'] ?>" placeholder="" type="file" class="filestyle form-control" data-height="180"  name="header_image">
                                            <input  placeholder="" type="hidden" class="form-control" value="email" name="type">
                                            <span class="text-danger"><?php echo form_error('header_image'); ?></span>
                                        </div>
                                        <div class="form-group"><label><?php echo $this->lang->line('footer_content'); ?></label>
                                            <textarea id="email_textarea" name="email_message" class="form-control" style="height: 250px">
                                                <?php echo set_value('email_message', $result[5]['footer_content']); ?>
                                            </textarea>
                                            <span class="text-danger"><?php echo form_error('email_message'); ?></span>
                                        </div>
                                    </div>
                                    <div class="col-lg-12">
                                        <div class="pull-right">
                                            <button type="submit" id="submitbtn6" class="btn btn-primary " data-loading-text="<i class='fa fa-spinner fa-spin '></i> <?php echo $this->lang->line('save'); ?>"><?php echo $this->lang->line('save'); ?></button>
                                        </div>
                                    </div>
                                </div>
                            </form>
