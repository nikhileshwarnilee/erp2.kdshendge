                ...
                <div class="box box-primary">
                    <div class="box-header ptbnull">
                        ...
                        <div class="box-tools pull-right">
                            <button type="button" class="btn btn-primary" autocomplete="off" data-toggle="modal"
                                data-target="#addModal"><i class="fa fa-cloud-upload"></i>
                                ...
                                <form method="POST" action="#" id="searchform">
                                    <div class="input-group input-group-sm">
                                        <input type="text" name="table_search"
                                            class="form-control pull-right post_search_text"
                                            placeholder="<?php echo $this->lang->line('search'); ?>">
                                        <div class="input-group-btn">
                                            <button type="submit" class="btn btn-primary  post_search_submit"><i
                                ...
                                <div class="pull-right">
                                    <div class="btn-group">
                                        <button class="btn btn-primary btn-sm"
                                            title="<?php echo $this->lang->line('list_view'); ?>" id="list">
                                            <span class="fa fa-1-2x fa-th-list"></span>
                                        </button>
                                        <button class="btn btn-primary btn-sm"
                                            title="<?php echo $this->lang->line('card_view'); ?>" id="grid">
                                                ...
                                                <table class="table no-border">
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="total_size">
                                                                <?php echo format_file_size($count->file_size); ?></td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                            </div>
                                            <div class="sidebar-form-content displaynone">
                                                <div class="btn-group">
                                                    <button type="button" data-toggle="tooltip"
                                                        data-original-title="<?php echo $this->lang->line('share'); ?>"
                                                        class="btn btn-sm btn-primary " id="share_files"><i
                                                            class="fa fa-share-alt"></i></button>
                                                    <button type="button" data-toggle="tooltip"
                                                        data-original-title="<?php echo $this->lang->line('generate_url'); ?>"
                                                        class="btn btn-sm btn-primary " id="share_url"><i
                                                            class="fa fa-globe"></i></button>
                                                </div>
                                                <?php if ($this->rbac->hasPrivilege('upload_content', 'can_delete')) {?>
                                                <button href="#"
                                                    class="btn btn-sm btn-primary pull-right side_delete_btn"
                                                ...
                                                <form class="pt20"
                                                    ...
                                                    <div class="form-group row">
                                                        <label
                                                            class="control-label col-sm-12 col-xs-12 col-lg-12 col-md-12"><?php echo $this->lang->line('content_type'); ?>
                                                            <small class="req">*</small></label>
                                                        <div class="col-sm-12 col-xs-12 col-lg-12 col-md-12">
...
foreach ($content_types as $content_type_key => $content_type_value) {
    ?>
                                                                <option value="<?php echo $content_type_value->id; ?>">
                                                                    <?php echo $content_type_value->name; ?></option>
                                                                <?php
}
?>
                                                            </select>
                                                    ...
                                                    <button type="submit"
                                                        class="btn btn-sm btn-primary pull-right"><?php echo $this->lang->line('save'); ?></button>
                                                    <div class="clearfix"></div>
                                                </form>
                                            </div>
                                        </div>
...
<div id="addModal" class="modal fade" role="dialog">
    <div class="modal-dialog modal-lg">
        <form id="fileupload" action="<?php echo site_url('admin/content/ajaxupload'); ?>"
                    ...
                    <div class="row">
                        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                            <div class="form-group">
                                <label for="content_type"><?php echo $this->lang->line('content_type'); ?> <small
...
<div id="shareURLModal" class="modal fade" role="dialog">
    <div class="modal-dialog modal-lg">
        <form id="shareurl" action="<?php echo site_url('admin/content/generate_url'); ?>"
            enctype="multipart/form-data">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body minheight199">
                    ...
                    <div class="share_link_div displaynone">
                        ...
                        <span class="btn btn-xs btn-info" onclick="copylink()" id="basic-addon1" data-toggle="tooltip"
                            data-original-title="<?php echo $this->lang->line('copy'); ?>"><i
                    ...
                    <div class="from_content">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label
                                        for="exampleInputEmail1"><?php echo $this->lang->line('share_date'); ?></label><small
                                        class="req"> *</small>
                                    <input id="share_date" name="share_date" placeholder="" type="text"
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label
                                        for="exampleInputEmail1"><?php echo $this->lang->line('valid_upto'); ?></label>
                                    <input id="valid_upto" name="valid_upto" placeholder="" type="text"
                                        class="form-control date">
                                    <span class="text-danger"></span>
                                </div>
                            </div>
                        ...
                        <button type="submit" class="btn btn-primary" id="load"
                            data-loading-text="<i class='fa fa-spinner fa-spin'></i> <?php echo $this->lang->line('saving'); ?>"><?php echo $this->lang->line('generate_url'); ?></button>
                    </div>
                    ...
                    <div class="row">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label
                                                for="exampleInputEmail1"><?php echo $this->lang->line('valid_upto'); ?></label>
                                            <input id="upload_date" name="valid_upto" placeholder="" type="text"
                                                class="form-control date">
                                            <span class="text-danger"></span>
                                        </div>
                                    </div>
                        ...
                        <div class="col-md-4">
                            <div class="nav-tabs-radio" role="tablist">
                                <div class="form-group">
                                    <label for="input-type"><?php echo $this->lang->line('send_to'); ?> <small
                                            class="req"> *</small></label>
                                    <div id="input-type" class="row">
                                        <div class="col-md-4">
                                            <label class="radio-inline">
                                                <input value="group" name="send_to" type="radio"
                                                    data-target="#share_group"
                                                    checked="checked" /><?php echo $this->lang->line('group'); ?>
                                            </label>
                                        </div>
                                        <div class="col-md-4">
                                            <label class="radio-inline">
                                                <input value="class" name="send_to" type="radio"
                                                    data-target="#share_class" /><?php echo $this->lang->line('class'); ?>
                                            </label>
                                        </div>
                                        <div class="col-md-4">
                                            <label class="radio-inline">
                                                <input value="individual" name="send_to" type="radio"
                                                    data-target="#share_individual" /><?php echo $this->lang->line('individual'); ?>
                                            </label>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group">
                                        <div class="well minheight303">
                                            <div class="checkbox mt0">
                                                <label><input type="checkbox" name="user[]" value="student">
                                                    <b><?php echo $this->lang->line('students'); ?></b> </label>
                                            </div>
                                            <?php
if ($sch_setting->guardian_name) {?>
                                            <div class="checkbox">
                                                <label><input type="checkbox" name="user[]" value="parent">
                                                    <b><?php echo $this->lang->line('guardians'); ?></b></label>
                                            </div>
                                            <?php }
?>
                                            <?php
foreach ($roles as $role_key => $role_value) {
    if ($role_value["name"] != 'Super Admin' || $superadmin_restriction != 'disabled') {?>
                                            ...
                                            <div class="checkbox">
                                                <label><input type="checkbox" name="user[]"
                                                        value="<?php echo $role_value['id']; ?>">
                                                    <b><?php echo $role_value['name']; ?></b></label>
                                            </div>
                                            <?php
}
}
                                    ...
                                    <div class="form-group">
                                        <div class="input-group">
                                            <div class="input-group-btn bs-dropdown-to-select-group">
                                                <button type="button"
                                                    class="btn btn-primary btn-searchsm dropdown-toggle as-is bs-dropdown-to-select"
                                                    data-toggle="dropdown">
                                                    <span
                                                        data-bind="bs-drp-sel-label"><?php echo $this->lang->line('select'); ?></span>
                                                    <input type="hidden" name="selected_value"
                                                        data-bind="bs-drp-sel-value" value="">
                                                    <span class="caret"></span>
                                                </button>
                                                <ul class="dropdown-menu" role="menu" style="">
                                                    <li data-value="student"><a
                                                            href="#"><?php echo $this->lang->line('students'); ?></a>
                                                    </li>
                                                    <?php
if ($sch_setting->guardian_name) {
    ?>
                                                    <li data-value="parent"><a
                                                            href="#"><?php echo $this->lang->line('guardians'); ?></a>
                                                    </li>
                                                    <li data-value="student_guardian"><a
                                                            href="#"><?php echo $this->lang->line('students_guardians'); ?></a>
                                                    </li>
                                                    <?php
}
?>
...
foreach ($roles as $role_key => $role_value) {
    ...
    if ($role_value["name"] != 'Super Admin' || $superadmin_restriction != 'disabled') {?>
                                                    ...
                                                    <li data-value="staff"><a
                                                            href="#"><?php echo $role_value['name']; ?></a></li>
                                                    <?php
}
}
?>
                                            ...
                                            <input type="text" value="" data-record="" data-email="" data-mobileno=""
                                                class="form-control" autocomplete="off" name="text" id="search-query">

                                            <div id="suggesstion-box"></div>
                                            <span class="input-group-btn">
                                                <button class="btn btn-primary btn-searchsm add-btn"
                                                    type="button"><?php echo $this->lang->line('add') ?></button>
                                            </span>
                                        </div>
                                    </div>
                                                ...
                                                <div class="col-md-12">
                                                    <div class="input-group">
                                                        ...
                                                        <div class="input-group-btn"><span
                                                                class="btn btn-primary input-group-addon bright btn-searchsm"><i
...
?>
                                    ...
                                    <div class="dual-list list-right">
                                        <div class="well minheight260">
                                            <div class="wellscroll">
                                                <b><?php echo $this->lang->line('section'); ?></b> <small class="req">
                                                    *</small>
                ...
                <div class="modal-footer">
                    <button type="submit" class="btn btn-primary" id="load"
                        data-loading-text="<i class='fa fa-spinner fa-spin'></i> <?php echo $this->lang->line('saving'); ?>"><?php echo $this->lang->line('send'); ?></button>
                </div>
            </div>
        </form>
    </div>
...
<div class="modal fade" id="single-delete" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
    aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p><?php echo $this->lang->line('you_are_about_to_delete'); ?> <b><i class="title"></i></b>
                    ,<?php echo $this->lang->line('this_procedure_is_irreversible_do_you_want_to_proceed'); ?></p>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-danger btn-ok"
                    data-loading-text="<i class='fa fa-circle-o-notch fa-spin'></i> <?php echo $this->lang->line('please_wait'); ?>"><?php echo $this->lang->line('delete'); ?></button>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="modal-dialog full-width mt0">
        <div class="modal-content m-0 bg-transparent modal-body-scroll">
            <div class="modal-gradient">
                ...
                <div class=" p0 border0">
                    <div class="d-flex pdficon pdficon-rtl">
...
$(document).on('click', '.share_checkbox,.share_checkbox_list', function() {
    ...
    if ($(this).is(':checked')) {
        $('.pagination-container').find('input.share_checkbox[value=' + $(this).val() + ']').prop('checked',
            true);
        $('.pagination-container').find('input.share_checkbox_list[value=' + $(this).val() + ']').prop(
            'checked', true);
    ...
    if (total_selected_check <= 0) {
        ...
        if (total_selected_check > 0) {
            ...
            let div_count = $('<div />', {
                ...
                'class': 'fa fa-plus'
            })).append(" " + total_selected_check.toString().padStart(2, '0') + " " + files_selected + " ");
...
function form_content_list() {
    ...
    $.each(new_selected, function(key, input) {
        ...
        var sub_li = $('<li/>', {
            ...
            }).append($('<a>').attr('href', 'javascript:void(0)').text(input.filename))
        ...
        this.ajax_get_items_pagination = function(page) {
            if ($(".pagination-container").length) {
                ...
                $.ajax({
                    ...
                    error: function(xhr) { // if error occured
                        alert(
                            "<?php echo $this->lang->line('error_occured_please_try_again'); ?>");
                        $('.modal_loader_div').fadeOut(400);
        ...
        $.ajax({
            ...
            beforeSend: function() {
                $("#search-query").css("background",
                    " url(../../backend/images/loading.gif) no-repeat 165px");
            },
            success: function(data) {
                if (data.length > 0) {
                    setTimeout(function() {
        ...
        if (record_id != "" && category_selected != "") {
            ...
            if (chkexists) {
                ...
                $(".send_list").append('<li class="list-group-item" id="' + category_selected + '-' +
                    record_id + '"><i class="fa fa-user"></i> <span class="pe-5 ps-rtl-1">'  + value + '(' +
                    category_selected_lang +
                    ') </span> <i class="fa fa-trash pull-right text-danger"  data-toggle="tooltip" data-original-title="<?php echo $this->lang->line('delete') ?>"  onclick="delete_record(' +
...
$(document).on('change', '#class_id', function(e) {
    ...
    $.ajax({
        ...
        success: function(data) {
            $.each(data, function(i, obj) {
                div_data +=
                    '<li class="checkbox"><a href="#" class="small"><label><input type="checkbox" name="class_section_id[]" value ="' +
                    obj.id + '"/>' + obj.section + '</label></a></li>';
            });
            ...
            if (data.status) {
                ...
                if (share_by_side_panel) {
                    ...
                    if (selected_data.length > 0) {
                        ...
                        $('.d-preview-count').html(div_count).append(" " + selected_data.length
                            .toString().padStart(2, '0') + " " + files_selected + " ");
                    }
...
$(document).on('click', '.top_list_div', function(event) {
    ...
    if (!($target.is("input:checkbox[name='share_checkbox[]']")) && !($target.parent().hasClass(
        'delete_file'))) {
...
$(document).on('click', '.div_image', function() {
    ...
    if (fileType == "jpg" || fileType == "jpeg" || fileType == "png" || fileType == "svg" || fileType ==
        "webp" || fileType == "gif") {
        modal_view = true;;
        var img = $('<img />', {
            id: 'image',
