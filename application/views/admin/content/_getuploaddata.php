                                ...
                                <div class="radio-title">
									...
									<aside class="div_image">
										<a href="javascript:void(0);" class="image_content">
                                            <?php echo ($content_value->file_type == "video") ? $content_value->vid_title : $content_value->real_name; ?>    
										</a> 
									</aside>																						
                                    
                                </div>                                  <!-- price-dewrap // -->
                                <div class="price-wrap me-3">
                                    <?php echo $this->customlib->getStaffFullName($content_value->staff_name,$content_value->surname,$content_value->employee_id);   ?>
                                </div>
                                <!-- price-dewrap // -->                                
                            </div>                            
