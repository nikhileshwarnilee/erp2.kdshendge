    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <p class="bolds"><?php echo $this->lang->line('are_you_sure_to_return_this_item'); ?></p>

                <ul class="list2">
                    <li class="roboto"><?php echo $this->lang->line('item'); ?><span class="pull-right" id="modal_item"></span></li>
                    <li class="roboto"><?php echo $this->lang->line('item_category'); ?><span class="pull-right" id="modal_item_cat"></span></li>
                    <li class="roboto"><?php echo $this->lang->line('quantity'); ?><span class="pull-right" id="modal_item_quantity"></span></li>
                </ul>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-default" data-dismiss="modal"><?php echo $this->lang->line('cancel'); ?></button>
                <a class="btn btn-primary btn-ok" data-loading-text="<i class='fa fa-spinner fa-spin '></i> <?php echo $this->lang->line('please_wait'); ?>"><?php echo $this->lang->line('return'); ?></a>
            </div>
        </div>
    </div>
</div>
...
<script>
    (function($) {
        'use strict';
        $(document).ready(function() {
            initDatatable('item-list', 'admin/issueitem/getitemlist');
        });
    }(jQuery))
</script>