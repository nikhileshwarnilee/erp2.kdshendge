                                ...
                                ?>
                                    ...
                                    <form action="<?php echo site_url('admin/subjectattendence/index') ?>" method="post" class="form_attendence">
                                        ...
                                        <div class="table-responsive ptt10">
                                            ...
                                            <table class="table table-hover table-striped example" data-export-title="<?php echo $this->lang->line('student_list'); ?>">
                                                <thead>
                                                    <tr>
                                                        <th>#</th>
                                                ...
                                                <tbody>
                                                    ...
                                                    ?>
                                                        <tr>
                                                            ...
                                                            <?php if ($date == 'xxx') { ?>
                                                                <td><input type="text" class="form-control" name="remark<?php echo $value["student_session_id"] ?>"></td>
                                                            <?php } else { ?>
                                                                <td><input type="text"  class="form-control"  name="remark<?php echo $value["student_session_id"] ?>" value="<?php echo $value["remark"]; ?>"></td>
                                                            <?php } ?>
                                                        </tr>
                                                    <?php
                                                        $row_count++;
