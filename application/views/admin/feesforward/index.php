...
<div class="content-wrapper" style="min-height: 946px;">
	...
	<small class="pull-right">
                                  <a href="<?php echo base_url(); ?>admin/feesforward/deletefeesforward" class="btn btn-primary btn-sm"  > Delete Carry Forward
                                    ...
                                    if (!empty($student_due_fee)) {
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-xs-12 table-responsive">
                                                ...
                                                <table class="table table-striped dt_table"  data-export-title="<?php echo $this->lang->line('previous_session_balance_fees');?>">
                                                    <thead>
                                                        <tr>
                                                        ...
                                                        foreach ($student_due_fee as $due_fee_key => $due_fee_value) {
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="text text-right">
                                                                    ...
                                                                    <input type="number" name="amount[<?php echo $i; ?>]" class="form-control tddm200" value="<?php echo convertBaseAmountCurrencyFormat($due_fee_value->balance); ?>">
                                                                </td>
<td class="text text-right">
																	 <?php echo $due_fee_value->yesorno; ?>
                                                                </td>
                                                            </tr>
                                                            <?php
                                                            $i++;
