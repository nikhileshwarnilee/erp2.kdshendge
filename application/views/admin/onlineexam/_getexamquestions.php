...
<div class="question_row_<?php echo $question_value->onlineexam_question_id; ?> subject_div_<?php echo $question_value->subject_id; ?>" >
    ...
    <button type="button" class="btn btn-xs del_exam_question btn-primary" data-original-title="<?php echo $this->lang->line('delete') ?>" data-toggle="modal" data-target="#mydeleteModal" data-exam-id="<?php echo $exam->exam; ?>" data-onlineexam-question-id="<?php echo $question_value->onlineexam_question_id; ?>"><i class="fa fa-trash" aria-hidden="true"></i></button> 
                        </div>
                       <div class="rltpaddleft mr0-3">
