...
$can_edit_fee_type = $this->rbac->hasPrivilege('fees_type', 'can_edit');
$edit_search_due_fees_value = set_value('include_in_search_due_fees', isset($feetype['include_in_search_due_fees']) ? $feetype['include_in_search_due_fees'] : 1);
?>
                            ...
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div style="display:flex; align-items:center; gap:10px;">
                                        <input type="hidden" name="include_in_search_due_fees" id="include_in_search_due_fees" value="<?php echo $edit_search_due_fees_value; ?>">
                                        <div class="material-switch">
                                            <input id="include_in_search_due_fees_toggle" type="checkbox" class="form-search-due-fees-toggle" <?php if ((string) $edit_search_due_fees_value === '1') { echo "checked='checked'"; } ?> />
                                            <label for="include_in_search_due_fees_toggle" class="label-info-success"></label>
                                        </div>
                                        <span id="include_in_search_due_fees_text"><?php echo ((string) $edit_search_due_fees_value === '1') ? 'Selected' : 'Unselected'; ?></span>
                                    </div>
                                </div>
                            </div><!-- /.box-body -->
