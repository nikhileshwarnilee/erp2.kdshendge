                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <div class="pull-right ptt10">
                                                    <button type="submit" class="btn btn-primary" name="save" value="save" id="submitbtn"><?php echo $this->lang->line('save'); ?></button>
                                                    <button type="submit" class="btn btn-primary" name="save" value="enroll" id="enrollbtn"> <?php echo $this->lang->line('save_and_enroll'); ?></button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
