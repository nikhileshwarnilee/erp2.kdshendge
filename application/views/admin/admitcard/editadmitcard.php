...
if (isset($error_message)) {
    ...
    ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="documents" name="left_logo" placeholder="" type="file" class="filestyle form-control" data-height="38">
                                    ...
                                    <?php if(!empty($admitcard->left_logo)){
                                        ...
                                        <div class="left_logo">
                                            <div class="fadeheight-sms">
                                             <p class=""> <a class="uploadclosebtn" title="<?php echo $this->lang->line('delete_left_logo'); ?>"><i class="fa fa-trash-o" onclick="removeleft_logo()"></i></a><?php echo $admitcard->left_logo; ?>
                                             </p>
                                            </div>
                                        </div>
                                    <?php }?>
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="documents" name="right_logo" placeholder="" type="file" class="filestyle form-control" data-height="38">
                                    ...
                                    <?php if(!empty($admitcard->right_logo)){
                                        ...
                                        <div class="right_logo">
                                            <div class="fadeheight-sms">
                                             <p class=""> <a class="uploadclosebtn" title="<?php echo $this->lang->line('delete_right_logo'); ?>"><i class="fa fa-trash-o" onclick="removeright_logo()"></i></a><?php echo $admitcard->right_logo; ?>
                                             </p>
                                            </div>
                                        </div>
                                    <?php }?>
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="documents" name="sign" placeholder="" type="file" class="filestyle form-control" data-height="38"  name="sign">
                                    <input type="hidden" name="old_sign" value="<?php echo $admitcard->sign; ?>">
                                    <span class="text-danger"><?php echo form_error('sign'); ?></span>
                                    <?php if(!empty($admitcard->sign)){
                                        ?>
                                        <div class="sign">
                                            <div class="fadeheight-sms">
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="documents" name="background_img" placeholder="" type="file" class="filestyle form-control" data-height="38"  name="background_image">
...
if ($this->rbac->hasPrivilege('design_admit_card', 'can_edit')) {
            ?>
                                                        <a href="<?php echo site_url('admin/admitcard/edit/' . $certificate->id); ?>" class="btn btn-primary btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('edit'); ?>">
        ...
        if ($this->rbac->hasPrivilege('design_admit_card', 'can_delete')) {
            ?>
                                                        <a href="<?php echo base_url(); ?>admin/admitcard/delete/<?php echo $certificate->id ?>" class="btn btn-primary btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('delete'); ?>" onclick="return confirm('<?php echo $this->lang->line('delete_confirm') ?>');">
...
<div class="modal fade" id="myModal" role="dialog" style="width: 100%;" >
    <div class="modal-dialog modal-lg" style="width: 90%;">
        <div class="modal-content">
            ...
            <div class="modal-body table-responsive" id="certificate_detail">
            </div>
        </div>
    </div>
</div>
