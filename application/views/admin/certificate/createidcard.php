                            ...
                            <div class="box-body">
                                ...
                                <div class="form-group switch-inline">
                                    ...
                                    <div class="material-switch switchcheck">
                                        ...
                                        <label for="enable_admission_no" class="label-info-success"></label>
                                    </div>
                                </div>
                                <div class="form-group switch-inline">
                                    ...
                                    <div class="material-switch switchcheck">
                                        ...
                                        <label for="enable_student_name" class="label-info-success"></label>
                                    </div>
                                </div>
                                <div class="form-group switch-inline">
                                    ...
                                    <div class="material-switch switchcheck">
                                        ...
                                        <label for="enable_class" class="label-info-success"></label>
                                    </div>
                                </div>
                                <div class="form-group switch-inline">
                                    ...
                                    <div class="material-switch switchcheck">
                                        ...
                                        <label for="enable_father_name" class="label-info-success"></label>
                                    </div>
                                </div>
                                <div class="form-group switch-inline">
                                ...
                                <div class="form-group switch-inline">
                                    ...
                                    <div class="material-switch switchcheck">
                                        ...
                                        <label for="enable_address" class="label-info-success"></label>
                                    </div>
                                </div>
                                <div class="form-group switch-inline">
                                    ...
                                    <div class="material-switch switchcheck">
                                        ...
                                        <label for="enable_phone" class="label-info-success"></label>
                                    </div>
                                </div>
                                <div class="form-group switch-inline">
                                    ...
                                    <div class="material-switch switchcheck">
                                        ...
                                        <label for="enable_dob" class="label-info-success"></label>
                                    </div>
                                </div>
                                <div class="form-group switch-inline">
                                    ...
                                    <div class="material-switch switchcheck">
                                        ...
                                        <label for="enable_blood_group" class="label-info-success"></label>
                                    </div>
                                </div>
                                <div class="form-group switch-inline">
                                ...
                                <div class="form-group switch-inline">
                                    ...
                                    <div class="material-switch switchcheck">
                                        ...
                                        <label for="enable_student_barcode" class="label-info-success"></label>
                                    </div>
                                </div>
                                ...
                                <div class="form-group switch-inline">
                                    ...
                                    <div class="material-switch switchcheck">
                                        <input id="enable_student_rollno" name="enable_student_rollno" type="checkbox" class="chk" value="1" <?php echo set_checkbox('enable_student_rollno', '1', (set_value('enable_student_rollno') == 1) ? TRUE : FALSE); ?>>
                                        <label for="enable_student_rollno" class="label-info-success"></label>
                                    </div>
                                </div>
                                ...
                                <div class="form-group switch-inline">
                                    ...
                                    <div class="material-switch switchcheck">
                                        <input id="enable_student_house_name" name="enable_student_house_name" type="checkbox" class="chk" value="1" <?php echo set_checkbox('enable_student_house_name', '1', (set_value('enable_student_house_name') == 1) ? TRUE : FALSE); ?>>
                                        <label for="enable_student_house_name" class="label-info-success"></label>
                                    </div>
                                </div>
                ...
                <div class="box box-primary" id="hroom">
                    ...
                    <div class="box-body">
                        <div class="mailbox-messages table-responsive">
                            ...
                            <table class="table table-striped table-bordered table-hover example" data-export-title="<?php echo $this->lang->line('student_id_card_list');?>">
                                <thead>
                                    <tr>
                                        ...
                                        foreach ($idcardlist as $idcard) {
                                            ...
                                            <tr>
                                                ...
                                                <td class="mailbox-date pull-right no-print white-space-nowrap">
                                                    <a data-id="<?php echo $idcard->id ?>" class="btn btn-primary btn-xs view_data"  data-toggle="tooltip" title="<?php echo $this->lang->line('view'); ?>">
                                                        <i class="fa fa-reorder"></i>
                                                    </a>
                                                    <?php
                                                    if ($this->rbac->hasPrivilege('student_id_card', 'can_edit')) {
                                                        ?>
                                                        <a href="<?php echo base_url(); ?>admin/studentidcard/edit/<?php echo $idcard->id ?>" class="btn btn-primary btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('edit'); ?>">
                                                    ...
                                                    if ($this->rbac->hasPrivilege('student_id_card', 'can_delete')) {
                                                        ?>
                                                        <a href="<?php echo base_url(); ?>admin/studentidcard/delete/<?php echo $idcard->id ?>" class="btn btn-primary btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('delete'); ?>" onclick="return confirm('<?php echo $this->lang->line('delete_confirm') ?>');">
