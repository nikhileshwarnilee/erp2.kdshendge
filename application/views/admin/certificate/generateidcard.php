                        ...
                        <form method="post" action="<?php echo base_url('admin/generateidcard/generatemultiple') ?>">
                            <div  class="" id="duefee">
                                ...
                                <div class="box-header ptbnull">
                                    <h3 class="box-title titlefix pt5"><i class="fa fa-users"></i> <?php echo $this->lang->line('student_list'); ?></h3>
                                ...
                                <div class="box-body table-responsive">
                                    ...
                                    <div class="tab-pane active table-responsive no-padding" id="tab_1">
                                        <table class="table table-striped table-bordered table-hover dt_table" cellspacing="0" width="100%" data-export-title="<?php echo $this->lang->line('student_list');?>">
                                            <thead>
                                                <tr> 
                                                    <th class="noExport"><input type="checkbox" id="select_all" /></th>
...
<script type="text/javascript">
        ...
        ],50, [],true, true, true, true,'landscape',  []
    );
    });
