...
if (isset($error_message)) {
    ...
    ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <span class="text-primary">[name] [dob] [present_address] [guardian] [created_at] [admission_no] [roll_no] [class] [section] [gender] [admission_date] [category] [cast] [father_name] [mother_name] [religion] [email] [phone] [present_date]
                                        <?php
                                        ...
                                        <div class="col-md-6 col-sm-6 img_div_modal minh45">
                                            <div class="form-group switch-inline">
                                                ...
                                                <div class="material-switch switchcheck">
                                                    ...
                                                    <label for="enable_student_img" class="label-info-success"></label>
                                                </div>
                                            </div>
                                        </div><!--./col-md-6-->
                                        <div class="col-md-6 col-sm-6 img_div_modal">
                ...
                <div class="box box-primary" id="hroom">
                    ...
                    <div class="box-body">
                        <div class="table-responsive mailbox-messages">
                            ...
                            <table class="table table-striped table-bordered table-hover example"  data-export-title="<?php echo $this->lang->line('student_certificate_list');?>">
                                <thead>
                                    <tr>
...
if ($this->rbac->hasPrivilege('student_certificate', 'can_edit')) {
            ?>
                                                        <a href="<?php echo base_url(); ?>admin/certificate/edit/<?php echo $certificate->id ?>" class="btn btn-primary btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('edit'); ?>">
        ...
        if ($this->rbac->hasPrivilege('student_certificate', 'can_delete')) {
            ?>
                                                        <a href="<?php echo base_url(); ?>admin/certificate/delete/<?php echo $certificate->id ?>" class="btn btn-primary btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('delete'); ?>" onclick="return confirm('<?php echo $this->lang->line('delete_confirm') ?>');">
