...
<div class="content-wrapper">
    <section class="content-header">
        <h1><i class="fa fa-newspaper-o"></i> <?php //echo $this->lang->line('certificate'); 
                                                ?></h1>
    </section>
    <!-- Main content -->
                            ...
                            <div class="" id="duefee">
                                ...
                                <div class="box-body table-responsive">
                                    ...
                                    <div class="tab-pane active table-responsive no-padding" id="tab_1">
                                        <table class="table table-striped table-bordered table-hover myexample" cellspacing="0" width="100%" data-export-title="<?php echo $this->lang->line('student_list'); ?>">
                                            <thead>
                                                <tr>
