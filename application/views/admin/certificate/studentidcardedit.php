                                ...
                                <div class="form-group">
                                    ...
                                    <span class="text-danger"><?php echo form_error('logo_img'); ?></span>
                                     <?php if(!empty($editidcard[0]->logo)){
                                        ...
                                        <div class="fadeheight-sms">
                                         <p class=""> <a class="uploadclosebtn" title="<?php echo $this->lang->line('delete_logo_image'); ?>"><i class="fa fa-trash-o" onclick="removelogo_image()"></i></a><?php echo $editidcard[0]->logo;?>
                                         </p>
                                        </div>
                                    </div>                                    
                                        <?php }?>
