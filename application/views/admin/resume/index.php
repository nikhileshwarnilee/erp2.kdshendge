  ...
  <div class="row">
   <div class="col-md-12">
    <div class="box box-primary">
      ...
      <h3 class="box-title"><i class="fa fa-search"></i> <?php echo $this->lang->line('select_criteria'); ?></h3>
		<div class="box-tools pull-right">
                            <small class="pull-right">
								<?php if ($this->rbac->hasPrivilege('download_cv_setting', 'can_view')) { ?>
                                <a href="<?php echo base_url(); ?>admin/resume/resume_setting" class="btn btn-primary btn-sm"   >
     ...
     <div class="box-body">
      <div class="row">
       <form role="form" action="<?php echo site_url('admin/resume/index') ?>" method="post" class="">
     ...
     <form method="post" action="<?php echo base_url('admin/resume/printresume') ?>" id="printallresume">
      <div class="" id="duefee">
       ...
       <div class="box-body table-responsive mailbox-messages">
        ...
        <table class="table table-striped table-bordered table-hover example" id="members"  data-export-title="<?php echo $this->lang->line('student_list');?>">
          <thead>
           <tr>
          ...
          <tbody>
           ...
           <tr>
            ...
            <td>
			<?php if ($this->rbac->hasPrivilege('build_cv', 'can_view')) { ?>
            <a href="<?php echo base_url(); ?>admin/resume/student_resume_details/<?php echo $student['id'] ?>" class="btn btn-primary btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('add'); ?> / <?php echo $this->lang->line('edit'); ?>"><i class="fa fa-reorder"></i></a>
			<?php } ?>
            </td>
           </tr>
           <?php
