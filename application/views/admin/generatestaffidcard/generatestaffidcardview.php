                        ...
                        <div  class="" id="duefee">
                          <div class="box-header ptbnull"></div>
                            <div class="box-header ptbnull">
                                <h3 class="box-title titlefix pt5"><i class="fa fa-users"></i> <?php echo $this->lang->line('staff_list'); ?></h3>
                            ...
                            <div class="box-body table-responsive">
                                <div class="tab-pane active table-responsive no-padding" id="tab_1">
                                    ...
                                    <table class="table table-striped table-bordered table-hover dt_table" cellspacing="0" width="100%"  data-export-title="<?php echo $this->lang->line('staff_list');?>">
                                        <thead>
                                            <tr>
