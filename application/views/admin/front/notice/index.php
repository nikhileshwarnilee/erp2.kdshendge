                    ...
                    <div class="box-body">
                        ...
                        <div class="mailbox-messages">
                            <div class="table-responsive overflow-visible-lg">
                                <table class="table table-striped table-bordered table-hover example"  data-export-title="<?php echo $this->lang->line('news_list');?>">
                                    <thead>
                                        <tr>
                                                ...
                                                <tr id="<?php echo $page["id"]; ?>">
                                                    ...
                                                    <td class="mailbox-date pull-right no-print">
                                                        ...
                                                        if ($this->rbac->hasPrivilege('notice', 'can_edit')) {
                                                            ?>
                                                            <a href="<?php echo site_url('admin/front/notice/edit/' . $page['slug']); ?>" class="btn btn-primary btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('edit'); ?>">
                                                        ...
                                                        if ($this->rbac->hasPrivilege('notice', 'can_delete')) {
                                                            ?>
                                                            <a href="<?php echo site_url('admin/front/notice/delete/' . $page['slug']); ?>" class="btn btn-primary btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('delete'); ?>" onclick="return confirm('<?php echo $this->lang->line('delete_confirm') ?>');">
