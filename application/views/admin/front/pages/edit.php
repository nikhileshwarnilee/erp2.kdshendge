                            ...
                            <div class="form-group">
                                ...
                                foreach ($category as $cat_key => $cat_value) {
                                    ...
                                    <label class="radio-inline">
                                        <input type="radio" value="<?php echo $cat_key ?>" name="content_category" <?php echo set_checkbox('content_category', $cat_key, set_value('content_category', in_array($cat_key, $result['category_content'])) ? TRUE : FALSE); ?> > <?php echo $cat_value; ?></label>
                                    <?php
                                }
                                ?>
                            ...
                            <div class="form-group mb0">
                                <div class="input-group input-group-sm">
                                    ...
                                    <span class="input-group-btn">
                                        <a href="#" class="btn btn-primary feture_image_btn" id="feture_image" data-toggle="tooltip" data-title="<?php echo $this->lang->line('select_image'); ?>" type="button" ><i class="fa fa-folder-open"></i></a>
                                        <?php if ($this->rbac->hasPrivilege('pages', 'can_delete')) { ?>
