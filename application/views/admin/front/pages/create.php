                            ...
                            <div class="form-group">
                                ...
                                foreach ($category as $cat_key => $cat_value) {
                                    ...
                                    <label class="radio-inline">
                                        <input type="radio" value="<?php echo $cat_key ?>" name="content_category" <?php echo set_radio('content_category', $cat_key, (set_value('content_category', 'standard') == $cat_key) ? TRUE : FALSE ) ?> > <?php echo $cat_value; ?> </label>
                                    <?php
                                }
                                ?>
        ...
        $(document).on('click', '.add_media', function (event) {
            ...
            if (popup_target === "media_images") {
                ...
                if (typeof content_html !== "undefined") { 
                    ...
                    alert('<?php echo $this->lang->line('select_media_file'); ?>');
                }
            } else {
