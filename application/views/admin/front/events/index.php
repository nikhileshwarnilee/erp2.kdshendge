                                                ...
                                                <tr>
                                                    ...
                                                    <td class="mailbox-date pull-right no-print">
                                                        ...
                                                        if ($this->rbac->hasPrivilege('event', 'can_edit')) {
                                                            ?>
                                                            <a href="<?php echo site_url('admin/front/events/edit/' . $event['slug']); ?>" class="btn btn-primary btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('edit'); ?>">
                                                        ...
                                                        if ($this->rbac->hasPrivilege('event', 'can_delete')) {
                                                            ?>
                                                            <a href="<?php echo site_url('admin/front/events/delete/' . $event['slug']); ?>" class="btn btn-primary btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('delete'); ?>" onclick="return confirm('<?php echo $this->lang->line('delete_confirm') ?>');">
