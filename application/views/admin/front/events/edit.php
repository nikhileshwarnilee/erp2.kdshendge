                ...
                <div class="col-md-3 col-sm-12 uploadbarfixes">
                    ...
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            ...
                            <div class="box-tools pull-right">
                                <button class="btn btn-box-tool delete_media" data-placement="bottom" data-widget="collapse" data-toggle="tooltip" title="<?php echo $this->lang->line('collapse'); ?>"><i class="fa fa-minus"></i></button>
                            </div><!-- /.box-tools -->
                        </div><!-- /.box-header -->
