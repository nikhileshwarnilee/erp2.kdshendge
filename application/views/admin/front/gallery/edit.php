        ...
        <div class="row">
            <form id="form1" action="<?php echo site_url('admin/front/gallery/edit/' . $result['slug']) ?>"  id="employeeform" name="employeeform" method="post" accept-charset="utf-8">
                                    ...
                                    <div class="gallery_content">
                                        ...
                                        if (!empty($result['page_contents'])) {
                                            foreach ($result['page_contents'] as $page_content_key => $page_content_value) {
                                                ...
                                                ?>
                                                <div class='col-sm-3 col-md-3 col-lg-3 col-xs-6 img_div_modal gallery_img div_record_<?php echo $page_content_value->id; ?>'>
                                                    <div class='fadeoverlay'>
                                                    <div class='fadeheight'>
                                                        <img class='img-responsive' data-fid='<?php echo $page_content_value->id; ?>' data-content_name='<?php echo $page_content_value->img_name; ?>' data-is_image='' data-img='<?php echo $page_content_value->dir_path . $page_content_value->img_name; ?>' src='<?php echo $this->media_storage->getImageURL($page_content_value->thumb_path . $page_content_value->thumb_name); ?>'>
                                                    ...
                                                    <p class='fadeoverlay-para'><?php echo  $this->media_storage->fileview($page_content_value->img_name); ?></p>
                                                </div>
                ...
                <div class="col-md-3 col-sm-12">
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group mb0">
                                ...
                                <div class="material-switch pull-right">
                                    ...
                                    <label for="sidebar" class="label-info-success"></label>
                                </div>
                            </div>                      
                        </div><!-- /.box-body -->
                    </div><!-- /.box -->              
                            ...
                            <div class="form-group mb0">
                                <div class="input-group input-group-sm">
                                    ...
                                    <span class="input-group-btn">
                                        <a href="#" class="btn btn-primary feature_image_btn" id="feature_image" data-toggle="tooltip" data-title="<?php echo $this->lang->line('select_image'); ?>" type="button"><i class="fa fa-folder-open"></i></a>
                                ...
                                ?>
                                <div id="image_preview" class="thumbnail mb0" style="margin-top: 10px; <?php echo $image_display; ?>">
                    ...
                    <div class="box box-primary">
                        <div class="box-body">
                            <button type="submit" class="btn btn-primary btn-block"><i class="fa fa-save"></i> <?php echo $this->lang->line('save'); ?></button>
                        </div><!-- /.box-body -->
                    </div><!-- /.box -->
