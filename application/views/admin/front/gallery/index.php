                        ...
                        <div class="table-responsive overflow-visible">  
                            <table class>
                                ...
                                <div class="mailbox-messages">
                                    ...
                                    <table class="table table-striped table-bordered table-hover example"  data-export-title="<?php echo $this->lang->line('gallery_list');?>">
                                        <thead>
                                            <tr>
                                                    ...
                                                    <tr id="<?php echo $page["id"]; ?>">
                                                        ...
                                                        <td class="mailbox-date pull-right no-print">
                                                            ...
                                                            if ($this->rbac->hasPrivilege('gallery', 'can_edit')) {
                                                                ?>
                                                                <a href="<?php echo site_url('admin/front/gallery/edit/' . $page['slug']); ?>" class="btn btn-primary btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('edit'); ?>">
                                                            ...
                                                            if ($this->rbac->hasPrivilege('gallery', 'can_delete')) {
                                                                ?>
                                                                <a href="<?php echo site_url('admin/front/gallery/delete/' . $page['slug']); ?>" class="btn btn-primary btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('delete'); ?>" onclick="return confirm('<?php echo $this->lang->line('delete_confirm') ?>');">
