            ...
            <div class="col-md-6">
                ...
                <div class="box box-primary" id="holist">
                    <div class="box-header ptbnull">
                        <h3 class="box-title titlefix pt5"><?php echo $this->lang->line('menu_item_list'); ?></h3>

                        <div class="pull-right">
							<div class="btn-group btn-toggle qrtabs">
                                <?php foreach ($listMenus as $menu) {   ?>

								<a href="<?php echo site_url('admin/front/menus/additem/' . $menu['slug']); ?>" class="btn <?php echo ($this->uri->segment(5) == $menu['slug'] ? 'btn-primary' : 'btn-outline-primary'); ?>"><?php echo $menu['menu'] ?></a>
                                                        ...
                                                        <ol class="submenu-list">
                                                            ...
                                                            foreach ($menu['submenus'] as $submenu_key => $submenu_value) {
                                                                ...
                                                                <li id="list_<?php echo $submenu_value['id']; ?>">
                                                                    <div class="divsortable ui-sortable-handle">
