            ...
            <div class="col-md-12">
                <div class="nav-tabs-custom theme-shadow">
                    ...
                    if ($this->module_lib->hasModule('online_course')) { ?>
                        ...
                        <li><a href="#tab_guest" data-toggle="tab" data-list="guest-list"><?php echo $this->lang->line('guest'); ?></a></li>
                    ...
                    <div class="tab-content">					
                        ...
                        <!-- /.tab-pane -->
                        <div class="tab-pane table-responsive" id="tab_guest">
                            <table class="table table-striped table-bordered table-hover guest-list" data-export-title="<?php echo $this->lang->line('user_log'); ?>" data-target="parent-list">
                                <thead>
                                    <tr>
                                        <th><?php echo $this->lang->line('users'); ?></th>
                                        <th width="150"><?php echo $this->lang->line('role'); ?></th>
...
<script type="text/javascript">
    ...
    $('a[data-toggle="tab"]').on('show.bs.tab', function (e) {
        ...
        if (target == "staff-list") {
            initDatatable(target, 'admin/userlog/getStaffDatatable');
        } else if (target == "student-list") {
            initDatatable(target, 'admin/userlog/getStudentDatatable');
        } else if (target == "parent-list") {
            initDatatable(target, 'admin/userlog/getParentDatatable');
        } else if (target == "all-list") {
            initDatatable(target, 'admin/userlog/getDatatable');
        }else if (target == "guest-list") {
            initDatatable(target, 'admin/userlog/getguestDatatable');
        }
    ...
    (function ($) {
        ...
        $(document).ready(function () {
            initDatatable('all-list', 'admin/userlog/getDatatable');
        });
    }(jQuery))
</script>