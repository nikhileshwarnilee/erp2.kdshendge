                ...
                <div class="box box-primary" id="hroom">
                    ...
                    <div class="box-body">
                        ...
                        <div class="mailbox-messages table-responsive">
                            ...
                            <table class="table table-striped table-bordered table-hover example"  data-export-title="<?php echo $this->lang->line('hostel_room_list');?>">
                                <thead>
                                    <tr>
        ...
        ?>
                                                ...
                                                <td class="mailbox-date pull-right no-print">
                                                    ...
                                                    <?php }if ($this->rbac->hasPrivilege('hostel_rooms', 'can_delete')) {?>
                                                        <a href="<?php echo base_url(); ?>admin/hostelroom/delete/<?php echo $hostelroom['id'] ?>"class="btn btn-primary btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('delete'); ?>" onclick="return confirm('<?php echo $this->lang->line('delete_confirm') ?>');">
