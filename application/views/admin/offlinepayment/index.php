...
<script>
    ...
    $(document).ready(function () {
      ...
      initDatatable('payment-list','admin/offlinepayment/getlist',[],[],100, [
          {
    targets: [0,1],                  // 5th column from the end
    orderable: true,                // enable sorting
    className: 'dt-head-left dt-body-left'      // apply right-align to body cells
  },
  {
    targets: [-5],                  // 5th column from the end
    orderable: true,                // enable sorting
    className: 'dt-body-right'      // apply right-align to body cells
  },{
    targets: [-1],                  // 5th column from the end
    orderable: true,                // enable sorting
    className: 'dt-head-right dt-body-right'      // apply right-align to body cells
  }
]);
