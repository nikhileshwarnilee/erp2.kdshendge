                    ...
                    ?>
                        ...
                        <div class="box-body">
                            <div class="table-responsive no-padding">
                                ...
                                <?php
                                    ...
                                    foreach ($studentList as $student_key => $student_value) {
                                        ...
                                        if (!empty($subjectList)) {
                                            ...
                                            $student_array['quality_points']    = $exam_qulity_point;
                                ...
                                <table class="table table-striped table-bordered table-hover dt_table" cellspacing="0" width="100%" data-export-title="<?php echo $this->lang->line('examinations_report'); ?>">
                                    <thead>
                                        <tr>
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                                <tr>
                                                    <td class="dt-body-left dt-head-left"><?php echo $student_list_value['rank']; ?></td>
