    ...
    <tbody>
       <tr>
                                                ...
                                                if ($exam->exam_group_type != "gpa") {
                                                    ...
                                                    ?>
                                                    <th valign="middle"><?php echo $this->lang->line('grade_point'); ?></th>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        ...
                                                        if ($total_hours <= 0) {
                                                            ...
                                                            echo $exam_qulity_point . " [" . findGrade($exam_grades, $total_grade_percentage) . "]";
                                                        }
                                                        ?>
                                                    </td>
                                                    <td valign="top" style="text-align: left;border-right:1px solid #999"></td>
        ...
        <thead>
                                            <tr>
                                                ...
                                                if ($exam->exam_group_type != "gpa") {
                                                    ...
                                                    <th class="text-center"><?php echo $this->lang->line('quality_points') ?></th>
                                                    <?php
                                                }
