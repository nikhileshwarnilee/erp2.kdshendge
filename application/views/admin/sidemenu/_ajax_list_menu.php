...
<div id="sortable-div-menu" class="col-sm-12 col-xs-12 col-md-12 addSub">
   ...
   <div id="dragdrop" class="col-sm-6 col-md-6">
      <div class="well-list clearfix">
         <div class=""><h3 class="panel-title relative"><?php echo $this->lang->line('menu_list'); ?></h3></div>
...
?>
   ...
   <div id="dragdrop" class="col-sm-6 col-md-6">
      <div id="my-timesheet" class="well-list clearfix">
         <div class=""><h3 class="panel-title relative"><?php echo $this->lang->line('selected_sidebar_menus'); ?></h3></div>
<div>
  <div class="row">
    <div class="col-md-12">
