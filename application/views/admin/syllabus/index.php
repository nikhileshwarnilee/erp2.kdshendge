...
<div class="modal fade" id="add_assignsyllabus"  role="dialog" aria-labelledby="evaluation" style="padding-left: 0 !important">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content modal-media-content">
            <div class="modal-header modal-media-header">
                <button type="button" class="close" data-dismiss="modal">&times;</button>
                <h4 class="box-title" id="modaltitle"></h4>
            </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-12 col-md-12 col-sm-12">
                                        <div class="form-group" id="get_ckeditor">
                                            <div class="d-flex align-items-center justify-content-between pb10">
                                                <label class="mb0" for="exampleInputEmail1"><?php echo $this->lang->line('presentation'); ?></label>
                                                <button class="btn btn-primary pull-right" type="button" id="question" data-toggle="modal" data-location="question" data-target="#myimgModal"><i class="fa fa-plus"></i> <?php echo $this->lang->line('add_image'); ?></button>
                                            </div>
...
<div class="modal fade syllbus" id="lacture_youtube_modal" role="dialog" aria-labelledby="evaluation">
    <div class="modal-dialog video-lg" role="document">
        <button type="button" class="ukclose" data-dismiss="modal" style="" onclick="videoUrlBlank()">&times;</button>
...
<?php }?>
        $('#title').html('<?php echo $this->lang->line('lesson_plan'); ?>');
    ...
    function subject_syllabusedit(id) {
        ...
        $.ajax({
            ...
            {
                $('#modaltitle').html('<?php echo $this->lang->line('edit_lesson_plan'); ?>');
...
<script>
    function add_syllabus(subject_group_subject_id, time_from, time_to, new_date, subject_group_class_section_id, staff_id) {
        $('#add_assignsyllabus').modal('show');
        $('#modaltitle').html('<?php echo $this->lang->line('add_lesson_plan'); ?>');
