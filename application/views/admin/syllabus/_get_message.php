...
if ($this->rbac->hasPrivilege('lesson_plan_comments', 'can_delete')) {
                if ($login_staff_id == $messagelist_value['staff_id']) {?>
                        <a onclick='deletemessage("<?php echo $messagelist_value['fourm_id']; ?>")' class='btn btn-primary btn-xs pull-right text-tooltip-sm' data-placement="bottom" title="<?php echo $this->lang->line('delete'); ?>" data-toggle='tooltip'> <i class='fa fa-trash'></i></a>
                        <?php }}?>
