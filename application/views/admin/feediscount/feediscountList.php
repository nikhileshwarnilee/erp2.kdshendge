                            ...
                            <div class="box-body">
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-6 col-xs-6">
                                        ...
                                        <input id="percentage" name="percentage" type="text" class="form-control" value="<?php echo set_value('percentage'); ?>" />
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-6 col-md-12 col-lg-6">
                                        ...
                                        <input id="discount_limit" name="discount_limit" type="number" min="0" step="1" class="form-control" value="<?php echo set_value('discount_limit'); ?>" />
                                        <span class="text-danger"><?php echo form_error('discount_limit'); ?></span>
                                    </div>
                                    <div class="col-sm-6 col-md-12 col-lg-6 pt-sm-1 pt-md-1">
                                        <label for="exampleInputEmail1"><?php echo $this->lang->line('expiry_date'); ?></label>
                                        <input id="expire_date" name="expire_date" type="text" class="form-control date" value="<?php echo set_value('expire_date'); ?>" />
                ...
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        <div class="mailbox-messages table-responsive">
                            ...
                            <table class="table table-striped table-bordered table-hover example"  data-export-title="<?php echo $this->lang->line('fees_discount_list');?>">
                                <thead>
                                    <tr>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td class="mailbox-date pull-right white-space-nowrap">
                                                ...
                                                ?>
                                                    <a href="<?php echo base_url(); ?>admin/feediscount/edit/<?php echo $feediscount['id'] ?>" class="btn btn-primary btn-xs" data-toggle="tooltip" title="<?php echo $this->lang->line('edit'); ?>">
                                                ...
                                                ?>
                                                    <a href="<?php echo base_url(); ?>admin/feediscount/delete/<?php echo $feediscount['id'] ?>" class="btn btn-primary btn-xs" data-toggle="tooltip" title="<?php echo $this->lang->line('delete'); ?>" onclick="return confirm('<?php echo $this->lang->line('delete_confirm') ?>');">
