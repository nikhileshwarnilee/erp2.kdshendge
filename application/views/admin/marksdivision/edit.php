    ...
    ?>
                                        <tr>
                                            ...
                                            <?php if ($this->rbac->hasPrivilege('marks_division', 'can_edit')) {?>
                                                <a href="<?php echo site_url('admin/marksdivision/edit/' . $division->id); ?>" class="btn btn-primary btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('edit'); ?>">
                                                    <i class="fa fa-pencil"></i>
                                                </a>
                                            <?php }if ($this->rbac->hasPrivilege('marks_division', 'can_delete')) {?>
                                                <a href="<?php echo site_url('admin/marksdivision/delete/' . $division->id); ?>"class="btn btn-primary btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('delete'); ?>" onclick="return confirm('<?php echo $this->lang->line('delete_confirm') ?>');">
