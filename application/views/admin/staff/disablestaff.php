                    ...
                    <div class="nav-tabs-custom theme-shadow">
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane  table-responsive no-padding" id="tab_2">
                                <table class="table table-striped table-bordered table-hover example"  data-export-title="<?php echo $this->lang->line('staff_list'); ?>" cellspacing="0" width="100%">
                                    <thead>
                                        <tr>
                                    ...
                                    foreach ($resultlist as $staff) {  ?>
                                                ...
                                                <tr>
                                                    ...
                                                    if (($this->rbac->hasPrivilege('can_see_other_users_profile', 'can_view')) || ($userdata["id"] == $staff["id"])) { ?>
                                                        <a href="<?php echo base_url(); ?>admin/staff/profile/<?php echo $staff['id'] ?>" class="btn btn-primary btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('view'); ?>" >
