                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="tab-pane active table-responsive no-padding">
                                    ...
                                    <table class="table table-striped table-bordered table-hover example" data-export-title="<?php echo $this->lang->line('approve_leave_request');?>">
                                        <thead>
...
if ($value["status"] == "approved") {
    ...
    ?>
                                                    <td><span data-toggle="popover" class="detail_popover" data-original-title="" title=""><small <?php echo $label ?>><?php echo $status[$status1]; ?></small></span>
                                                        ...
                                                        <div class="fee_detail_popover" style="display: none"><p class="text text-info"><?php echo $this->lang->line('submitted_by'); ?>: <?php echo $value['applied_by']; ?></p></div></td>
                                                    <td class="pull-right no-print white-space-nowrap">
                                                        <a href="#leavedetails" onclick="getRecord('<?php echo $value["id"] ?>')" role="button" class="btn btn-primary btn-xs" data-toggle="tooltip" title="<?php echo $this->lang->line('view'); ?>" ><i class="fa fa-reorder"></i></a>
...
if ($this->rbac->hasPrivilege('approve_leave_request', 'can_edit')) {
            ?>
                                                                <a href="#addleave" onclick="editRecord('<?php echo $value["id"] ?>')" role="button" class="btn btn-primary btn-xs" data-toggle="tooltip" title="<?php echo $this->lang->line('edit'); ?>" ><i class="fa fa-pencil"></i></a>
                                                            <?php }?>
    ...
    ?>
                                                        <?php if ($value["applied_by"] == $this->customlib->getAdminSessionUserName()) {?>
                                                            ...
                                                            <a onclick="getDelete('<?php echo $value["id"] ?>')"  class="btn btn-primary btn-xs" data-toggle="tooltip" title="<?php echo $this->lang->line('delete'); ?>" ><i class="fa fa-remove"></i></a>
