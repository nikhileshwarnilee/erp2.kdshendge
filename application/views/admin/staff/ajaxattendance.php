<table class="table table-striped table-bordered table-hover attendancetable" id="attendancetable" data-export-title="<?php echo $this->lang->line('details_for'); ?> <?php echo $staff["name"] . " " . $staff["surname"]; ?>">
    <thead>
        <tr>
            <th>
