        ...
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <div class="box box-primary">
                    ...
                    <?php if (form_error('validate_storage')) : ?>
                    <div class="alert alert-danger">
                        <?php echo form_error('validate_storage'); ?>
                    </div>
                    <?php endif; ?>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-7">
                                                    <div class="material-switch">
                                                        ...
                                                        <label for="enable_frontcms" class="label-info-success"></label>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-7">
                                                    <div class="material-switch">
                                                        ...
                                                        <label for="enable_sidebar" class="label-info-success"></label>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-7">
                                                    <div class="material-switch">
                                                        ...
                                                        <label for="enable_rtl" class="label-info-success"></label>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group">
