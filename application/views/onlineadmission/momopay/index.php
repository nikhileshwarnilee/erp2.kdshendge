                ...
                <div class="col-md-6 col-md-offset-3 mt20">
                    <div class="paymentbg">
                        ...
                        <div class="padd2 paddtzero">
                            <form action="<?php echo base_url(); ?>onlineadmission/momopay/pay" method="post">
                                <table class="table2" width="100%">
                                    ...
                                    <tr class="bordertoplightgray">
                                        <td colspan="2" class="text-center text-danger">
                                            <?php
                                            if (is_array($error)) {
                                                echo isset($error['message']) ? $error['message'] : '';
                                            } else {
                                                echo $error;
                                            }
                                            ?>
                                    ...
                                    <tr class="bordertoplightgray">
                                        <td><button type="submit" onclick="window.history.go(-1); return false;" name="search" value="" class="btn paybackbtn"><i class="fa fa fa-chevron-left"></i> <?php echo $this->lang->line('back'); ?> </button></td>
                                        <td class="text-right"> <button type="submit" name="search" value="" class="btn btn-info pull-right submit_button"><?php echo $this->lang->line('pay_with_momopay'); ?> <i class="fa fa fa-chevron-right"></i></button> </td>
                                    </tr>
                                </table>
                            </form>
                        </div>
