        ...
        <div class="row">
            ...
            <div class="col-lg-9 col-md-8 col-sm-8">            
                ...
                <div class="box box-primary">                    
                    ...
                    <div class="">
                         <form role="form" id="schsetting_form" action="<?php //echo site_url('schsettings/ajax_schedit_new'); ?>" method="post" enctype="multipart/form-data">
                            <div class="box-body">
                                <div class="row">
                                    <div class="col-md-6">
