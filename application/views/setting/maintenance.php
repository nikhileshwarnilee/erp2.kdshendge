                                    ...
                                    <div class="form-group">
                                            ...
                                            <div class="col-sm-9 col-lg-10 col-md-9">
                                                 <div class="material-switch">
                                                    <input id="maintenance_mode" name="maintenance_mode" type="checkbox" class=""
                                                        value="1" <?php echo set_checkbox('maintenance_mode', '1', ($result->maintenance_mode==1)); ?> />
                                                    <label for="maintenance_mode" class="label-info-success"></label>
                                                </div>
                                            </div>
                                    </div>                       
                                </div>
