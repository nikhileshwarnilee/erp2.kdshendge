                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-8">                                                        
                                                        <div class="material-switch">
                                                            <input id="student_timeline" name="student_timeline" type="checkbox" class=""
                                                            value="" <?php echo set_checkbox('student_timeline', 'enabled', ($result->student_timeline=="enabled")); ?> />
                                                            <label for="student_timeline" class="label-info-success"></label>
                                                        </div>
...
<script type="text/javascript">
    ...
    $(".edit_student_guardian").on('click', function (e) {
        ...
        var student_timeline = $("#student_timeline").prop("checked");
        if(student_timeline){
            var isTimelineEnabled="enabled";
        }else{
            var isTimelineEnabled="disabled";
        }
        var formData = $("#student_guardian_form").serialize();
        $.ajax({
