            ...
            <div class="col-md-12">
                <div class="nav-tabs-custom theme-shadow">
                    <ul class="nav nav-tabs pull-right">
                        ...
                        <li class="pull-left header"><span class="pt5 displayblock"><?php echo $this->lang->line('modules'); ?></span></li>
                    </ul>
                    <div class="tab-content">
                        <div class="tab-pane table-responsive active" id="tab_system">
                            <div class="download_label"><?php echo $this->lang->line('modules'); ?></div>
                            <table class="table table-striped table-bordered table-hover example"  data-export-title="<?php echo $this->lang->line('modules'); ?>" cellspacing="0" width="100%">
                                 <thead>
                                        <tr>
...
if (!empty($permissionList)) {
    ...
    foreach ($permissionList as $system) {
        ...
        ?> />
                                                        <label for="system<?php echo $system['id'] ?>" class="label-info-success"></label>
                                                    </div>
...
if (!empty($studentpermissionList)) {
    ...
    foreach ($studentpermissionList as $student) {
        ...
        ?> />
                                                        <label for="student<?php echo $student['id'] ?>" class="label-info-success"></label>
                                                    </div>
