                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <div class="material-switch">
                                                    <input id="adm_auto_insert" name="adm_auto_insert" type="checkbox" class=""
                                                        value="1" <?php echo set_checkbox('adm_auto_insert', '1', ($result->adm_auto_insert==1)); ?> />
                                                    <label for="adm_auto_insert" class="label-info-success"></label>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <div class="material-switch">
                                                    <input id="staffid_auto_insert" name="staffid_auto_insert" type="checkbox" class=""
                                                        value="1" <?php echo set_checkbox('staffid_auto_insert', '1', ($result->staffid_auto_insert==1)); ?> />
                                                    <label for="staffid_auto_insert" class="label-info-success"></label>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
