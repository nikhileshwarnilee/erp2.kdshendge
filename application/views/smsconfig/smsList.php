            ...
            <div class="col-md-12">
                <div class="nav-tabs-custom theme-shadow">
                    ...
                    <ul class="nav nav-tabs">
                        ...
                        <li><a href="#tab_12" data-toggle="tab"><?php echo $this->lang->line('sms_gateway_hub'); ?></a></li>
                    ...
                    <div class="tab-content">
                                    ...
                                    <div class="row">
                                        <div class="minheight170">
                                            <div class="col-md-7">
                                                ...
                                                <div class="form-group">
                                                    <label class="col-sm-5 control-label"><?php echo $this->lang->line('hashkey'); ?> <small class="req"> *</small></label>
                                                    <div class="col-sm-7">
                                            ...
                                            <div class="col-md-7">
                                               ...
                                               <div class="form-group">
                                                 ...
                                                 <div class="form-group">
                                                    ...
                                                    <div class="col-sm-7">
                                                        <input type="text" class="form-control" name="registered_from_number" value="<?php echo $nexmo_result->senderid; ?>">
                                                        <span class="text text-danger registered_from_number_error"></span>
                                                    </div>
                                                </div>
                                                 <div class="form-group">
                                                   <label class="col-sm-5 control-label"><?php echo $this->lang->line('status'); ?><small class="req"> *</small></label>
                        ...
                        <div class="tab-pane" id="tab_11">
                          ...
                          <div class="tab-pane" id="tab_12">
                            ...
                            <form role="form"  id="smsgatewayhub" action="<?php echo site_url('smsconfig/smsgatewayhub') ?>" class="form-horizontal" method="post">
                                <div class="box-body">
                                    <div class="row">
                                        <div class="minheight170">
                                            <div class="col-md-7">
                                                <?php
                                                $smsgatewayhub = check_in_array('smsgatewayhub', $smslist);
                                                ?>
                                                <div class="form-group">
                                                    <label class="col-sm-5 control-label"><?php echo $this->lang->line('auth_Key'); ?><small class="req"> *</small></label>
                                                    <div class="col-sm-7">
                                                        <input type="text" class="form-control" name="smsgatewayhub_authkey" value="<?php echo $smsgatewayhub->authkey; ?>">
                                                        <span class="text text-danger smsgatewayhub_authkey_error"></span>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label class="col-sm-5 control-label"><?php echo $this->lang->line('sender_id'); ?><small class="req"> *</small></label>
                                                    <div class="col-sm-7">
                                                        <input type="text" class="form-control" name="smsgatewayhub_senderid" value="<?php echo $smsgatewayhub->senderid; ?>">
                                                        <span class="text text-danger smsgatewayhub_senderid_error"></span>
                                                    </div>
                                                </div>

                                                <div class="form-group">
                                                    <label class="col-sm-5 control-label"><?php echo $this->lang->line('entity_id'); ?><small class="req"> *</small></label>
                                                    <div class="col-sm-7">
                                                        <input type="text" class="form-control" name="smsgatewayhub_entityid" value="<?php echo $smsgatewayhub->api_id; ?>">
                                                        <span class="text text-danger smsgatewayhub_entityid_error"></span>
                                                    </div>
                                                </div>
                                                 ...
                                                 <div class="form-group">
                                                   <label class="col-sm-5 control-label"><?php echo $this->lang->line('status'); ?><small class="req"> *</small></label>
                                                    <div class="col-sm-7">
                                                        <select class="form-control" name="smsgatewayhub_status">
                                                            <?php
                                                            foreach ($statuslist as $s_key => $s_value) {
                                                                ?>
                                                                <option 
                                                                    value="<?php echo $s_key; ?>"
                                                                    <?php
                                                                   if ($smsgatewayhub->is_active == $s_key) {
                                                                       echo "selected=selected";
                                                                   }
                                                                    ?>
                                                                    ><?php echo $s_value; ?></option>
                                                        ...
                                                        <span class=" text text-danger smsgatewayhub_status_error"></span>
                                                    </div>
                                                </div>
                                            
                                            </div>
                                            <div class="col-md-5 text text-center disblock">
                                                <a href="https://www.smsgatewayhub.com/" target="_blank"><img src="<?php echo base_url() ?>backend/images/smsgatewayhub.png<?php echo img_time(); ?>" class="img-responsive center-block"><p>https://www.smsgatewayhub.com/</p></a>
                                ...
                                <div class="box-footer">
                                    <div class="col-md-offset-3">
                                            ...
                                            <button type="submit" class="btn btn-primary btnleftinfo"><?php echo $this->lang->line('save'); ?></button>&nbsp;&nbsp;<span class="smsgatewayhub_loader"></span>
...
<script type="text/javascript">
   ...
   $("#bulk_sms").submit(function (e) {
       ...
       $("#smsgatewayhub").submit(function (e) {
        $("[class$='_error']").html("");
        $(".smsgatewayhub_loader").html('<img src="' + img_path + '">');
        var url = $(this).attr('action'); // the script where you handle the form input.
        $.ajax({
            type: "POST",
            dataType: 'JSON',
            url: url,
            data: $("#smsgatewayhub").serialize(), // serializes the form's elements.
            success: function (data, textStatus, jqXHR)
            {
                if (data.st === 1) {
                    $.each(data.msg, function (key, value) {
