...
<html lang="en">
    <head>
        ...
        <script type="text/javascript"
                src="<?php echo (ENVIRONMENT === 'production') ? 'https://app.midtrans.com/snap/snap.js' : 'https://app.sandbox.midtrans.com/snap/snap.js'; ?>"
                        ...
                        <div class="paymentbg">
                            ...
                            <?php if (!empty($api_error)) {
                                ...
                                <div class="alert alert-danger">
                                    <strong><?php echo $this->lang->line('error'); ?>:</strong> <?php echo htmlspecialchars($api_error); ?>
                                    <br><small><?php echo $this->lang->line('please_check_your_payment_gateway_settings'); ?></small>
                                </div>
                            <?php }
                            ?>
                            <?php if (empty($api_error)) { ?>
                ...
                echo $fees_value['fee_type_code'];
                                    ...
                                    ?>
                                     <tr class="border_bottom">
                                        ...
                                        <hr>
                                        <tr class="bordertoplightgray">
                                            <td><button type="button" onclick="window.history.go(-1); return false;" name="search"  value="" class="btn btn-info"><i class="fa fa fa-chevron-left"></i> <?php echo $this->lang->line('back'); ?> </button>  </td>
                                            <td class="text-right"> <button type="button"  name="search" id="pay-button"  value="" class="btn btn-info"><?php echo $this->lang->line('pay_with_midtrans'); ?>  <i class="fa fa fa-chevron-right"></i></button>  </td>
                                        </tr>
                                    </table>
                                </form>
                            </div>
                            <?php } else { ?>
                            <div class="padd2 paddtzero text-center">
