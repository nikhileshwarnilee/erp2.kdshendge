                                ...
                                <form action="<?php echo base_url(); ?>user/gateway/paystack/paystack_pay" method="post">
                                    ...
                                    <tr class="border_bottom">
                                        ...
                                        <tr class="bordertoplightgray">
                                            ...
                                            <td class="text-right"> <button type="submit"  name="search"  value="" class="btn btn-info pull-right submit_button"><?php echo $this->lang->line('pay_with_paystack'); ?> <i class="fa fa fa-chevron-right"></i></button>  </td>
                                        </tr>
                                    </table>
                                </form>
                            </div>
