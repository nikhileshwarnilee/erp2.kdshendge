            ...
            <div class="row"> 
                ...
                echo $fees_value['fee_type_code'];
                                ...
                                <form class="paddtlrb" method="POST" action="<?php echo site_url('user/gateway/ccavenue/pay') ?>">
                                    ...
                                    <button type="submit" name="search" value="" class="btn btn-info pull-right submit_button"><i class="fa fa fa-money"></i> <?php echo $this->lang->line('pay_with_ccavenue')?> </button> 
                                </form>
                            </div>
                        </div>
                    </div>
