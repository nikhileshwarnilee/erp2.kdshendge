                    ...
                    <div class="col-md-6 col-md-offset-3 mt20">
                        <div class="paymentbg">
                            ...
                            <div class="padd2 paddtzero">
                                <form action="<?php echo base_url(); ?>user/gateway/ipayafrica/pay" method="post">
                                    ...
                                    ?>
                                     <tr class="border_bottom">
                                        ...
                                        <tr class="bordertoplightgray">
                                            ...
                                            <td class="text-right"> <input type="text" class="form-control"  name="phone" value="<?php echo set_value('phone', $params['guardian_phone']); ?>" /><small style="color:red;"> <?php echo form_error('phone'); ?></small></td>
                                        </tr>
                                        <tr class="bordertoplightgray">
                                            <td><?php echo $this->lang->line('email'); ?>:</td>
                                            <td class="text-right"> <input type="text" class="form-control" name="email" value="<?php echo set_value('email', $student_data['guardian_email']); ?>"><small style="color:red;"> <?php echo form_error('email'); ?></small></td>
                                        </tr>
                                        <tr class="bordertoplightgray">
                                            ...
                                            <td class="text-right"> <button type="submit"  name="search"  value="" class="btn btn-info pull-right submit_button"><?php echo $this->lang->line('pay_with_ipayafrica'); ?> <i class="fa fa fa-chevron-right"></i></button>  </td>
                                        </tr>
                                    </table>
                                </form>
                            </div>
