                ...
                <div class="col-md-6 col-md-offset-3 mt20">
                    <div class="paymentbg">
                        ...
                        <div class="padd2 paddtzero">
                            <form action="<?php echo base_url(); ?>user/gateway/skrill/pay" method="post">
                                <table class="table2" width="100%">
                                    ...
                                    <tr class="bordertoplightgray">
                                        ...
                                        <td class="text-right"> <button type="submit" name="search" value="" class="btn btn-info pull-right submit_button"><?php echo $this->lang->line('pay_with_skrill'); ?> <i class="fa fa fa-chevron-right"></i></button> </td>
                                    </tr>
                                </table>
                            </form>
                        </div>
