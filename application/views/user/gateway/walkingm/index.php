            ...
            <div class="row">
                    ...
                    <div class="col-md-6 col-md-offset-3 mt20">
                        <div class="paymentbg">
                            ...
                            <div class="padd2 paddtzero">
                                <form action="<?php echo base_url(); ?>user/gateway/walkingm/pay" method="post">
                ...
                echo $fees_value['fee_type_code'];
                                    ...
                                    <tr class="border_bottom">
                                        ...
                                        <tr class="bordertoplightgray">
                                            <td><?php echo $this->lang->line('walkingm_email'); ?>:</td>
                                            <td class="text-right"> <input type="text" class="form-control" name="email" value="<?php echo set_value('email'); ?>"></td>
                                        </tr>
                                        <tr class="bordertoplightgray">
                                            <td><?php echo $this->lang->line('walkingm_password'); ?>:</td>
                                            <td class="text-right"> <input type="password" class="form-control"  name="password" value="<?php echo set_value('password'); ?>" /></td>
                                        </tr>
                                        <?php 
                                        if((!empty(validation_errors())) || ($api_error!='')){
                                           ?>
                                           <tr class="bordertoplightgray">
                                            <td colspan="2"><div class="alert alert-danger"><?php echo validation_errors(); if(!empty($api_error)){ print_r($api_error); }?></div></td>                                            
                                        </tr>
                                           <?php 
                                        }
                                        ?>                                        
                                        <tr class="bordertoplightgray">
                                            ...
                                            <td class="text-right"> <button type="submit"  name="search"  value="" class="btn btn-info pull-right submit_button"><?php echo $this->lang->line('pay_with_walkingm'); ?>  <i class="fa fa fa-chevron-right"></i></button>  </td>
                                        </tr>
                                    </table>
                                </form>
                            </div>
