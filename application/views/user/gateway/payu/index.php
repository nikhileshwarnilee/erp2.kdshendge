                ...
                echo $fees_value['fee_type_code'];
                                ...
                                <form class="paddtlrb" action="<?php echo $action; ?>/_payment" method="post" id="payuForm" name="payuForm">
                                    ...
                                    <button type="button" onclick="window.history.go(-1);
                                            return false;" name="search"  value="" class="btn paybackbtn"><i class="fa fa fa-chevron-left"></i> <?php echo $this->lang->line('back') ?></button>    
                                    <button type="button" class="btn btn-info pull-right submit_button" ><i class="fa fa fa-money"></i> <?php echo $this->lang->line('pay_with_payu') ?></button></td>
                                </form>        
                            </div>
                        </div>
                    </div>                      
