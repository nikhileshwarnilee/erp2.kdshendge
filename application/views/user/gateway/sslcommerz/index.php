                ...
                <div class="paddtop20">
                    ...
                    <div class="col-md-6 col-md-offset-3 mt20">
                        <div class="paymentbg">
                            ...
                            <?php if ($api_error) { ?><center><div class="alert alert-danger">  <?php echo $api_error ?> </div></center> <?php } ?>
                            <div class="padd2 paddtzero">
                                <form action="<?php echo base_url(); ?>user/gateway/sslcommerz/pay" method="post">
                ...
                echo $fees_value['fee_type_code'];
                                    ...
                                    <tr class="border_bottom">
                                        ...
                                        <tr class="bordertoplightgray">
                                            ...
                                            <td class="text-right"> <button type="submit"  name="search"  value="" class="btn btn-info pull-right submit_button"><?php echo $this->lang->line('pay_sslcommerz_payment'); ?>  <i class="fa fa fa-chevron-right"></i></button>  </td>
                                        </tr>
                                    </table>
                                </form>
                            </div>
