                        ...
                        <div class="paymentbg">
                            ...
                            <?php if ($api_error) {
                                ...
                                <div class="alert alert-danger">
                                    ...
                                    if (isset($api_error['TransRef'])) {
                                        echo '<p><strong>Transaction Reference:</strong> ' . htmlspecialchars($api_error['TransRef']) . '</p>';
                                    }
                                    ?>
                                    ...
                                    ?>
                                     <tr class="border_bottom">
                                        ...
                                        <tr class="bordertoplightgray">
                                            ...
                                            <td class="text-right"> <input type="text" class="form-control"  name="creditcardnumber" value="<?php echo set_value('creditcardnumber'); ?>" /><span class="alert-danger"><?php echo form_error('creditcardnumber');?></span></td>
                                        </tr>
                                        <tr class="bordertoplightgray">
                                            <td><?php echo ('Credit Card Expiry'); ?>:</td>
                                            <td class="text-right"> <input type="text" class="form-control" name="creditcardexpiry" value="<?php echo set_value('creditcardexpiry'); ?>" placeholder="MMYY"><span class="alert-danger"><?php echo form_error('creditcardexpiry');?></span></td>
                                        </tr>
                                        <tr class="bordertoplightgray">
                                            <td><?php echo ('Credit Card CVV'); ?>:</td>
                                            <td class="text-right"> <input type="text" class="form-control" name="creditcardcvv" value="<?php echo set_value('creditcardcvv'); ?>" ><span class="alert-danger"><?php echo form_error('creditcardcvv');?></span></td>
                                        </tr>
                                        <tr class="bordertoplightgray">
                                            <td><?php echo ('Card Holder Name'); ?>:</td>
                                            <td class="text-right"> <input type="text" class="form-control" name="cardholdername" value="<?php echo set_value('cardholdername'); ?>" ><span class="alert-danger"><?php echo form_error('cardholdername');?></span></td>
                                        </tr>
                                        ...
                                        <tr class="bordertoplightgray">
                                            ...
                                            <td><button type="submit"  name="search"  value="" class="btn btn-info pull-right submit_button"><?php echo ('Pay'); ?>  <i class="fa fa fa-chevron-right"></i></button>  </td>
                                        </tr>
                                    </table>
                                </form>
                            </div>
