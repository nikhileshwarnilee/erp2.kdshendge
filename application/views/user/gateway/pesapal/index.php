                    ...
                    <div class="col-md-6 col-md-offset-3 mt20">
                        <div class="paymentbg">
                                        ...
                                        foreach($api_error as $value){
                                            foreach ($value as $key => $value1) {
                                                if($key == 'consumer_key_unknown'){
                                                    echo "<strong>Problem:</strong> consumer_key_unknown<br>";
                                                    echo "<strong>Advice:</strong> Please check your Pesapal Consumer Key and Consumer Secret in Payment Settings. Make sure they are correctly configured and valid.";
                                                } else {
                                                    echo $value1;
                                                }
                                            }
                            ...
                            <div class="padd2 paddtzero">
                                <form action="<?php echo base_url(); ?>user/gateway/pesapal/pesapal_pay" method="post">
                                	<?php 
                ...
                echo $fees_value['fee_type_code'];
                                   ...
                                   <tr class="border_bottom">
                                    ...
                                    <tr class="bordertoplightgray">
                                        ...
                                        <td class="text-right"> <input type="text" class="form-control"  name="phone" value="<?php echo set_value('phone',$params['guardian_phone']);?>" /></td>
                                    </tr>
                                    <tr class="bordertoplightgray">
                                        <td><?php echo $this->lang->line('email');?>:</td>
                                        <td class="text-right"> <input type="text" class="form-control" name="email" value="<?php echo set_value('email',$student_data['guardian_email']);  ?>"></td>
                                    </tr>
                                    <tr class="bordertoplightgray">
                                        ...
                                        <td class="text-right"> <button type="submit"  name="search"  value="" class="btn btn-info pull-right submit_button"><?php echo $this->lang->line('pay_with_pesapal'); ?> <i class="fa fa fa-chevron-right"></i></button>  </td>
                                    </tr>
                                </table>                                
                                </form> 
                            </div>
