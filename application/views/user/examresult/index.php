               ...
               <div class="box-header ptbnull">
                  ...
                  <div class="box-tools pull-right">
                    ...
                    <?php if (!empty($exam_result)) {?>
                        <a class=" btn btn-primary btn-xs no_print" data-toggle="tooltip" data-placement="bottom" title="<?php echo $this->lang->line('print'); ?>" id="print" onclick="printDiv()" ><i class="fa fa-print"></i></a>
                    <?php }?>
                     </div>
                  </div>
               </div>
