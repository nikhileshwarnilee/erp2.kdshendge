            ...
            <div class="forum-set-flex">
                ...
                <div class="d-flex justify-content-between">
                    ...
                    <?php if ($messagelist_value['student_id'] == $login_student_id) {?>
                        &nbsp;
                        <a onclick='deletemessage("<?php echo $messagelist_value['fourm_id']; ?>")'  class='btn btn-primary btn-xs pull-right' data-placement="bottom" title="<?php echo $this->lang->line('delete'); ?>" data-toggle='tooltip'> <i class='fa fa-trash'></i></a>
                    <?php }?>
                    </div>
