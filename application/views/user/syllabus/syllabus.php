        ...
        <div class="modal-content modal-media-content">
               <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal">&times;</button>
                               ...
                               <h4 class="modal-title" id="modal-title"><?php echo $this->lang->line('lesson_plan'); ?></h4>
...
<div class="modal fade syllbus" id="lacture_youtube_modal" role="dialog" aria-labelledby="evaluation">
    <div class="modal-dialog video-lg" role="document">
        <button type="button" class="ukclose" data-dismiss="modal" onclick="videoUrlBlank()">&times;</button>
