...
<div class="content-wrapper">
    ...
    ?>
        ...
        ?>
                                        <div class="col-lg-2 col-md-3 col-xs-6 systatus print">
    ...
    ?>
                ...
                <div class="box-body"  id="transfee" >
                    <div class="table-responsive">
                        ...
                        <a class="btn btn-default btn-xs pull-right mb5 mt5 mleft-right-rtl" title="<?php echo $this->lang->line('export') ?>"  id="btnExport" onclick="fnExcelReport();"> <i class="fa fa-file-excel-o"></i></a>
                                    </div>
