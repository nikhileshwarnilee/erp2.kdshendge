...
$question_counter = 1;
        foreach ($questions as $question_key => $question_value) {
            ?>
                    <button type="button" class="btn btn-primary question_switcher <?php echo ($question_counter == 1) ? "activeqbtn" : "" ?>" data-qustion_no="<?php echo $question_counter; ?>"><?php echo $question_counter; ?></button>
                    <?php
$question_counter++;
        }
        ?>
