    ...
    ?>
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input id="admission_date" name="admission_date" placeholder="" type="text" class="form-control date"  
                                                value="<?php echo set_value('admission_date', isset($student['admission_date']) ? date($this->customlib->getSchoolDateFormat(), $this->customlib->dateyyyymmddTodateformat($student['admission_date'])) : ""); ?>" 
