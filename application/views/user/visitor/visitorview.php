            ...
            <div class="col-md-12">
                ...
                <div class="box box-primary">
                    ...
                    <div class="box-body">                       
                        ...
                        <div class=" ">
                            <table class="table table-hover table-striped table-bordered example" data-export-title="<?php echo $this->lang->line('visitor_list'); ?>">
                                <thead>
                                    <tr>
    ...
    foreach ($visitor_list as $key => $value) {?>
                                            <tr>
                                                ...
                                                <td class="mailbox-name">
                                                    <?php if ($value['image'] != "") {?>
                                                        <a href="<?php echo base_url(); ?>user/visitors/download/<?php echo $value['id']; ?>" class="btn btn-primary btn-xs" data-toggle="tooltip" title="" data-original-title="<?php echo $this->lang->line('download'); ?>">
