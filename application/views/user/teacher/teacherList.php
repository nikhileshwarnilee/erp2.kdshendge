<div class="content-wrapper">
    <section class="content-header">
        <h1>
            <i class="fa fa-user-secret"></i> <?php //echo $this->lang->line('teachers'); 
                                                ?>
        </h1>
    </section>
    <!-- Main content -->
                ...
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        <div class="table-responsive mailbox-messages">
                            <table class="table table-striped table-bordered table-hover example" data-export-title="<?php echo $this->lang->line('teachers_reviews'); ?>">
                                <thead>
                                    <tr>
                                        ...
                                        if ($role == 'student') {
                                        ?>
                                            <th width="10%"><?php echo $this->lang->line('my_rating'); ?></th>
                                            ...
                                            <tr>
                                                ...
                                                ?>
                                                    <td>
                                                        ...
                                                        <?php if (!empty($reviews[$teacher[0]->staff_id])) { ?>
                                                            <span class="print-only"> <?php echo $reviews[$teacher[0]->staff_id]; ?></span>
                                                        <?php } ?>
                                                    ...
                                                    <td width="15%"> <?php if (isset($comment[$teacher[0]->staff_id])) {
                                                                            echo $comment[$teacher[0]->staff_id];
                                                                        } ?> </td>
                                                    <td class="text-right">
                                                        <?php
                                                        $reted = 0;
                                                        ...
                                                        if ($reted == '0') {
                                                        ?>
                                                            <a class="btn btn-primary btn-xs" onclick="rating('<?php echo $teacher[0]->staff_id ?>')" data-toggle="tooltip" title="" data-original-title="<?php echo $this->lang->line('add'); ?>"><i class="fa fa-plus"></i></a><?php } ?>
                                                    </td>
                                                ...
                                                ?>
                                                    <td>
                                                        ...
                                                        <center>
                                                            <h5><?php echo substr($avg_rate[$teacher[0]->staff_id], 0, 3); ?> <?php echo $this->lang->line('average_based_on'); ?> <?php echo $reviews[$teacher[0]->staff_id]; ?> <?php echo $this->lang->line('reviews'); ?></h5>
                                                        </center>
                                                    <?php } ?>
                                                    </td>
                                                <?php
