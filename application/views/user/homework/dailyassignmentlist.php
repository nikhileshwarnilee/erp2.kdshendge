        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box box-info"><div class="box-header ptbnull">
                        ...
                        <div class="box-tools">
                            <button type="button" class="btn btn-primary" data-backdrop="static" data-toggle="modal" data-target="#myModal"><i class="fa fa-plus"></i> <?php echo $this->lang->line('daily_assignment'); ?></button>
                        </div>
                    </div>
                    <div class="box-body table-responsive">
                        <div class="download_label"><?php echo $this->lang->line('daily_assignment_list'); ?></div>
                            <table class="table table-hover table-striped table-bordered dt_table" data-export-title="<?php echo $this->lang->line('daily_assignment_list');?>">
                                <thead>
                                    <tr>
    ...
    ?>
                                        <tr>
                                            ...
                                            <?php if ($dailyassignmentlist_value["attachment"] != '') {?>
                                                <a class="btn btn-primary btn-xs" href="<?php echo base_url(); ?>user/homework/dailyassigmnetdownload/<?php echo $dailyassignmentlist_value['id']; ?>" data-toggle='tooltip' title="<?php echo $this->lang->line("download"); ?>"><i class="fa fa-download"></i></a>
                                            <?php }?>
                                            <?php if ($dailyassignmentlist_value["evaluated_by"] == NULL) {?>
                                                <a class="btn btn-primary btn-xs edit_modal_btn" data-toggle="tooltip" data-id ="<?php echo $dailyassignmentlist_value["id"]; ?>" data-original-title="<?php echo $this->lang->line('edit'); ?>"><i class="fa fa-pencil"></i></a>
                                                
                                                <a href="<?php echo base_url(); ?>user/homework/deletedailyassignment/<?php echo $dailyassignmentlist_value['id']; ?>" class='btn btn-primary btn-xs pull-right' data-toggle='tooltip' title="<?php echo $this->lang->line('delete'); ?>" onclick='return confirm("<?php echo $this->lang->line('delete_confirm'); ?>")'><i class='fa fa-remove'></i></a>
                                            <?php }?>
