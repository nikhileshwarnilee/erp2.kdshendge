...
?>
        ...
        <form id="upload" method="post" class="ptt10" style="min-height: 500px;">
            ...
            <div class="col-md-12 ptt10">
                ...
                <li class="list-group-item overflow-hidden mb5">
                    ...
                    <a href="<?php echo base_url(); ?>user/homework/assigmnetDownload/<?php echo $homework_id; ?>"  data-toggle="tooltip" data-placement="right" data-original-title="<?php echo $this->lang->line('download'); ?>"> <i class="fa fa-download"></i></a>
    ...
    <div class="col-lg-4 col-md-4 col-sm-4 col-eq">
        <div class="scroll-area">
            ...
            <a href="<?php echo base_url() . "user/homework/download/" . $result["id"] ?>" data-toggle="tooltip" data-original-title="<?php echo $this->lang->line('download'); ?>"><i class="fa fa-download"></i></a>               
