                ...
                <div class="box box-info">
                    <div class="box-header ptbnull">
                        ...
                        <div class="box-tools pull-right">
                            <a href="<?php echo base_url(); ?>user/homework/dailyassignment" class="btn btn-primary" data-method_call="add" autocomplete="off"> <?php echo $this->lang->line('daily_assignment'); ?></a>
                        </div>
                    </div>
                        ...
                        <div class="tab-pane active" id="tab_1">
                            <div class="box-body table-responsive">
                                <div>
                                    ...
                                    <table class="table table-hover table-striped table-bordered example" data-export-title="<?php echo $this->lang->line('homework_list'); ?>">
                                        <thead>
                                            <tr>
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td><?php echo $homework['subject_name']; ?> <?php if ($homework['subject_code']) {
                                                                                                        echo '(' . $homework['subject_code'] . ')';
                                                                                                    } ?> </td>
                                                    ...
                                                    <td class="mailbox-date pull-right">
                                                        <span data-toggle="tooltip" title="<?php echo $this->lang->line('view_edit'); ?>"><a class="btn btn-primary btn-xs" onclick="evaluation(<?php echo $homework['id']; ?>,<?php echo $h_status; ?>);" title="" data-target="#evaluation" data-toggle="modal" data-original-title="Evaluation">
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td><?php echo $closedhomework['subject_name']; ?> <?php if ($closedhomework['subject_code']) {
                                                                                                            echo '(' . $closedhomework['subject_code'] . ')';
                                                                                                        } ?></td>
                                                    ...
                                                    <td class="mailbox-date pull-right ss">
                                                        ...
                                                        <span data-toggle="tooltip" title="<?php echo $this->lang->line('view_edit'); ?>"><a class="btn btn-primary btn-xs" onclick="evaluation(<?php echo $closedhomework['id']; ?>,<?php echo $h_status; ?>);" title="" data-target="#evaluation" data-toggle="modal" data-original-title="Evaluation">
                                                                <i class="fa fa-reorder"></i></a></span>
                                                    </td>
                                                </tr>
                                            <?php } ?>
