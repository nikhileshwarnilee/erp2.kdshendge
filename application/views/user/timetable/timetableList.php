                                ...
                                <table class="table table-stripped">
                                    <thead>
                                        <tr>
                                            ...
                                            ?>
                                                <th class="text v-align-top"><?php echo $this->lang->line(strtolower($tm_key)); ?></th>
                                            <?php
                                            }
                                            ?>
                                        </tr>
