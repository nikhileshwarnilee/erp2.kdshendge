            ...
            <div class="col-md-12">
                <div class="box box-info">
                    ...
                    <div class="box-body table-responsive overflow-visible-lg">
                        ...
                        <div >
                            <table class="table table-hover table-striped table-bordered example" data-export-title="<?php echo $this->lang->line('leave_list'); ?>">
                                <thead>
                                    <tr>
...
if ($value['docs'] != '') {
        ?>
                                                    <a href="<?php echo base_url(); ?>user/apply_leave/download/<?php echo $value['id'] ?>" class="btn btn-primary btn-xs" data-toggle="tooltip" title="" data-original-title="<?php echo $this->lang->line('download'); ?>">
...
if ($value['status'] == 0) {
        ?>
                                                    <a onclick="get('<?php echo $value['id']; ?>')" class="btn btn-primary btn-xs" data-toggle="tooltip" title="" data-original-title="<?php echo $this->lang->line('edit'); ?>"><i class="fa fa-pencil"></i> </a>
                                                    <a onclick="return confirm('<?php echo $this->lang->line('are_you_sure_want_to_delete') ?>');" href="<?php echo base_url(); ?>user/apply_leave/remove_leave/<?php echo $value['id']; ?>" data-toggle="tooltip" title="" data-original-title="<?php echo $this->lang->line('delete'); ?>" class="btn btn-primary btn-xs"><i class="fa fa-remove"></i> </a>
    <?php }?>
