...
?></div>
                            <table class="table table-striped table-bordered table-hover example"  data-export-title="<?php echo $this->lang->line('guardian_report');?>">
                                <thead>
                                    <tr>
                                        ...
                                        <?php if ($sch_setting->mobile_no) {?>
                                            <th class="dt-body-left dt-head-left"><?php echo $this->lang->line('mobile_number'); ?></th>
                                        ...
                                        <th class="dt-body-left dt-head-left"><?php echo $this->lang->line('guardian_phone'); ?></th>
    ...
    foreach ($resultlist as $student) {
        ?>
                                            <tr>
                                                ...
                                                <?php if ($sch_setting->mobile_no) {?>
                                                    <td class="dt-body-left dt-head-left"><?php echo $student['mobileno']; ?></td>
                                                <?php }if ($sch_setting->guardian_name) {?>
                                                <td><?php echo $student['guardian_name']; ?></td>
                                                <?php }if ($sch_setting->guardian_relation) {?>
                                                    <td><?php echo $student['guardian_relation']; ?></td>
                                                 <?php }if ($sch_setting->guardian_phone) {?>
                                                <td class="dt-body-left dt-head-left"><?php echo $student['guardian_phone']; ?></td>
                                                <?php }if ($sch_setting->father_name) {?>
