        ...
        <div class="box box-primary border0 mb0 margesection">
            ...
            <div class="">
                <ul class="reportlists">
                    ...
                    if (($this->rbac->hasPrivilege('staff_leave_request_report', 'can_view'))) {
                        ?>

                        <li class="col-lg-4 col-md-4 col-sm-6 <?php echo set_SubSubmenu('Reports/attendance/leaverequestreport'); ?>">
                            <a href="<?php echo base_url(); ?>report/leaverequestreport"><i class="fa fa-file-text-o"></i> <?php echo $this->lang->line('leave_request_report'); ?> </a>
                        </li>
                    
                    <?php
                    }
                    if (($this->rbac->hasPrivilege('my_leave_request_report', 'can_view'))) {
                        ?>

                      <li class="col-lg-4 col-md-4 col-sm-6 <?php echo set_SubSubmenu('Reports/human_resource/myleaverequestreport'); ?>">
                            <a href="<?php echo base_url(); ?>report/myleaverequestreport"><i class="fa fa-file-text-o"></i> <?php echo $this->lang->line('my_leave_request_report'); ?> </a>
                        </li>
                     <?php } ?>
                </ul>
            </div>
