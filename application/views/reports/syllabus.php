...
<div class="content-wrapper">
            ...
            <?php if (!empty($subjects_data)) {
                ...
                <div class="box-body">
                    <div id="transfee">
                        ...
                        <div class="pull-right d-flex pb10">
                        <a title="<?php echo $this->lang->line('download_excel'); ?>" class="btn btn-primary btn-xs" id="btnExport" onclick="fnExcelReport();"> <i class="fa fa-file-excel-o"></i></a>
                        <a title="<?php echo $this->lang->line('print'); ?>" class="btn btn-primary btn-xs mr0-3" id="print" onclick="printDiv()" ><i class="fa fa-print"></i></a> 
                        </div>
    ...
    ?>
                <div class="active table-responsive box-body" >
                    <div class="download_label"> <?php echo $this->lang->line('syllabus_status_report'); ?></div>
                    <table class="table table-striped table-bordered table-hover"  data-export-title="<?php echo $this->lang->line('syllabus_status_report'); ?>" cellspacing="0" >
                        <thead>
                        </thead>
                        <tbody></tbody>
                    </table>
...
function printDiv() {
    ...
    const original = document.getElementById("transfee");
    const clone = original.cloneNode(true);

    // Convert all canvas charts to images
    ...
    originalCanvases.forEach((canvas, index) => {
        ...
        img.style.width = canvas.style.width || "400px"; // fallback size
        ...
        clonedCanvas.parentNode.replaceChild(wrapper, clonedCanvas);
    });

    // Open a new window and write the printable content with styles
