                ...
                <tr>
                    ...
                    <td class="text-right">
                        <?php if($assignmentlist_value["attachment"] !=''){ ?>
                            <a class="btn btn-primary btn-xs" href="<?php echo base_url(); ?>homework/dailyassigmnetdownload/<?php echo $assignmentlist_value['id']; ?>" data-toggle='tooltip' title="<?php echo $this->lang->line("download"); ?>"><i class="fa fa-download"></i></a>
                        <?php } ?>
                    </td>
                </tr>
                <?php
