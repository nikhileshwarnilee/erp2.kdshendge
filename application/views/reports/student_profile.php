                    ...
                    <div class="">
                        ...
                        <div class="box-body table-responsive">
                            <div class="download_label"> <?php echo $this->lang->line('student_profile').' '.
                                            ...
                                            ?></div>
                            <table class="table table-striped table-bordered table-hover example" data-export-title="<?php echo $this->lang->line('student_profile').' '. $this->customlib->get_postmessage();   ?>">
                                <thead>
                                    <tr>
                                    ...
                                    if (!empty($resultlist)) {
                                        foreach ($resultlist as $value) {
                                            ...
                                            <tr>
                                                ...
                                                <?php } ?>
                                                <td><?php if($value['gender']){ echo $this->lang->line(strtolower($value['gender'])); } ?></td>
