        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box removeboxmius">
                    ...
                    <form role="form" action="<?php echo site_url('report/leaverequestreport') ?>" method="post" class="">
                          ...
                          ?>                        
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="joining_date" value="<?php echo set_value('joining_date', $joining_date); ?>" class="form-control date">
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    <label for="exampleInputEmail1"><?php echo $this->lang->line('staff_name'); ?></label>
                                    <select class="form-control"  id="staff_name" name="staff_name">
                                        <option value=""><?php echo $this->lang->line('select');?></option>
                                        <?php 
                                        foreach($staff_list as $value){ ?>
                                            <option value="<?php echo $value["id"];?>"  <?php echo ($selected_staff_name == $value["id"]) ? 'selected' : ''; ?>><?php echo $value["name"]." ".$value["surname"]."(".$value["employee_id"].")";?></option>
                                        <?php } ?>
                                    </select>
                    ...
                    <div class="">
                        ...
                        <div class="box-header ptbnull">
                            <h3 class="box-title titlefix"><i class="fa fa-money"></i> <?php echo $this->lang->line('leave_request_report'); ?></h3>
                        </div>
                        <div class="box-body table-responsive">
                            
                            <table class="table table-striped table-bordered table-hover example" data-export-title="<?php echo $this->lang->line('leave_request_report'); ?>">
                                <thead>
									<tr>
                                        ...
                                        foreach ($resultlist as $key => $value) { ?>
                                                <tr>
                                                    ...
                                                    <td><?php echo ($value["date_of_joining"]!="") ? date($this->customlib->getSchoolDateFormat(), strtotime($value["date_of_joining"])) : ""; ?> </td>
