                    ...
                    <div class="row" id="printDiv">
                        ...
                        if (isset($student_due_fee)) {
                            ...
                            <div class="" id="transfee">
                                ...
                                <div class="box-header  with-border">
                                    <h3 class="box-title titlefix"> <?php echo $this->lang->line('balance_fees_statement'); ?></h3>
                                </div>                              
                                </div>                              
                                <div class="box-body">
                                    <?php
                                    if (!empty($student_due_fee)) {
                                        ?>
<button type="button" class="btn btn-sm btn-primary mb5 mr0-3 print" id="load" data-class-id="<?php echo $class_id;?>"  data-section-id="<?php echo $section_id;?>" data-loading-text="<i class='fa fa-spinner fa-spin '></i> Please wait"><i class="fa fa-print"></i> <?php echo $this->lang->line('print') ?> </button>
...
if($feetype_balance > 0){
    ...
    ?>
                                            ...
                                            <td align="left" class="text-rtl-right"><?php echo $this->lang->line(strtolower($transport_fee_value->month)); ?></td>
                                            <td align="left" class="text text-left">
...
<div class="fee_detail_popover" style="display: none">
<?php
if ($tr_fine_amount != "" || $tr_fine_amount>=0) {
            ?>
    <p class="text text-danger"><?php echo $this->lang->line('fine'); ?></p>
    <?php
}
...
function Popup(data)
    {
       ...
       // 🔥 Add this inline CSS block for print styles:
        frameDoc.document.write('<style>');
        frameDoc.document.write('@media print { .print { display: none !important; } }');
        frameDoc.document.write('</style>');
