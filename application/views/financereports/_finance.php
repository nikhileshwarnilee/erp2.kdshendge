        ...
        <div class="box box-primary border0 mb0 margesection">
            ...
            <div class="">
                <ul class="reportlists">
					...
					<?php } if ($this->rbac->hasPrivilege('online_admission_fees_collection_report', 'can_view')) {  ?> 
					...
					<?php } if ($this->rbac->hasPrivilege('due_fees_report', 'can_view')) {  ?> 
					
						<li class="col-lg-4 col-md-4 col-sm-6 <?php echo set_SubSubmenu('balancefees/index'); ?>"><a href="<?php echo base_url(); ?>balancefees/index"><i class="fa fa-file-text-o"></i> <?php echo $this->lang->line('due_fees_report'); ?> </a></li> 
