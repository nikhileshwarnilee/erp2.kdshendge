                        ...
                        ?>
                            <div class="" id="transfee">
                                <div class="box-header">
                                    <div class="box-header with-border">
                                        <h3 class="box-title titlefix"><i class="fa fa-users"></i> <?php echo $this->lang->line('daily_collection_report'); ?>
                                        </h3>
                                    </div>
                                </div>
                                <div class="box-body">
                                    ...
                                    ?>
                                        <div class="table-responsive">
                                            ...
                                            <table class="table table-striped table-bordered table-hover example"  data-export-title="<?php echo $this->lang->line('daily_collection_report');?>">
                                                <thead>
                                                    <tr>
