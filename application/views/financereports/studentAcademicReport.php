                    ...
                    <div class="row">
                        ...
                        if (isset($student_due_fee) && !empty($student_due_fee)) {
                            ...
                            ?></div> 
                                    ...
                                    <button class="btn btn-default btn-xs pull-right" id="btnExport" data-toggle="tooltip"
                                     data-original-title="<?php echo $this->lang->line('download_excel'); ?>"  onclick="fnExcelReport();"> <i class="fa fa-file-excel-o"></i></button>  
                                                      ...
                                                      <tr>
                                                            ...
                                                            ?>
                                                               <tr class="box box-solid total-bg">
                                                                ...
                                                                <td class="text-right"><?php echo $currency_symbol.amountFormat($totalfeelabel);  ?></td>
                                                                <td class="text-right"><?php echo $currency_symbol.amountFormat($depositfeelabel); ?></td>
                                                                <td class="text-right"><?php echo $currency_symbol.amountFormat($discountlabel); ?></td>
                                                                <td class="text-right"><?php echo $currency_symbol.amountFormat($finelabel); ?></td>
                                                                <td class="text-right"><?php echo $currency_symbol.amountFormat($balancelabel); ?></td>
                                                            </tr>
                                                        <?php                                
                                                          } ?>
                                            </tbody> 
