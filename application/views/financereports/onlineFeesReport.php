                    ...
                    <div class="">
                        ...
                        <div class="box-body table-responsive">
                            <div class="download_label"><?php echo $this->lang->line('online_fees_report');
                                                ...
                                                ?></div>
                            <table class="table table-striped table-bordered table-hover example"  data-export-title="<?php echo $this->lang->line('online_fees_report');?>">
                                <thead class="header">
                                    <tr>
                                    ...
                                    <?php
                                        ...
                                        foreach ($collectlist as $key => $collect) {
                                            ...
                                            <tr>
                                                ...
                                                <td> <a href="<?php echo base_url("student/view/".$collect['student_id']); ?>"><?php echo $this->customlib->getFullName($collect['firstname'],$collect['middlename'],$collect['lastname'],$sch_setting->middlename,$sch_setting->lastname); ?></a> </td>
                                                ...
                                                <td>  
                                                    <?php
                                                        if ($collect['is_system']) {
                                                            ...
                                                            echo $collect['type'].' ('.$collect['code'].')';
                                                        }
                                                    ?>
                                                </td>                                                
                                ...
                                <tr>
                                    ...
                                    <td class="text text-right" style="font-weight:bold"><?php echo $currency_symbol.amountFormat($allamount); ?></td>
                                    <td class="text text-right" style="font-weight:bold"><?php echo $currency_symbol.amountFormat($alldiscount); ?></td>
                                    <td class="text text-right" style="font-weight:bold"><?php echo $currency_symbol.amountFormat($finetotal); ?></td>
                                    <td class="text text-right" style="font-weight:bold"><?php echo $currency_symbol.amountFormat($alltotal); ?></td>                                                
                                </tr>      
                            </table>
                        </div>
                    </div>
