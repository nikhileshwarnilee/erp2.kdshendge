...
if ($student->dob != null && $student->dob != '0000-00-00') {
        ...
        ?>
         <b><?php echo $this->lang->line('current_address'); ?>:&nbsp;</b><?php echo $student->current_address ?> <?php echo $student->city ?><br>
            ...
            <a href="<?php echo base_url(); ?>student/view/<?php echo $student->id ?>" class="btn btn-primary btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('view'); ?>" >
                   <i class="fa fa-reorder"></i>
                             </a>
                                             <?php
if ($this->rbac->hasPrivilege('student', 'can_edit')) {
            ?>
                  <a href="<?php echo base_url(); ?>student/edit/<?php echo $student->id ?>" class="btn btn-primary btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('edit'); ?>">
        ...
        if ($this->module_lib->hasActive('fees_collection') &&  $this->rbac->hasPrivilege('collect_fees', 'can_add')) {
            ?>
                   <a href="<?php echo base_url(); ?>studentfee/addfee/<?php echo $student->student_session_id ?>" class="btn btn-primary btn-xs" data-toggle="tooltip" title="" data-original-title="<?php echo $this->lang->line('add_fees'); ?>">
                                 <?php echo $currency_symbol; ?>
                                                                                </a>
            <?php
}
        ?>
         <a type="button" class="btn btn-primary btn-xs print_student_details shadow-none" data-student_id="<?php echo $student->id ?>" data-student_name="<?php echo $this->customlib->getFullName($student->firstname, $student->middlename, $student->lastname, $sch_setting->middlename, $sch_setting->lastname); ?>" data-admission_no="<?php echo $student->admission_no; ?>" data-action="download" data-placement="bottom" data-toggle="tooltip" data-original-title="<?php echo $this->lang->line('print'); ?>" data-loading-text="<i class='fa fa-circle-o-notch fa-spin'></i>" autocomplete="off"><i class="fa fa-print"></i></a>
                </span>
                 </div>
                </div>
                 </div>
