                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label
                                                    for="exampleInputEmail1"><?php echo $this->lang->line('admission_no'); ?></label>
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label
                                                    for="exampleInputEmail1"><?php echo $this->lang->line('roll_number'); ?></label>
                                                <input id="roll_no" name="roll_no" placeholder="" type="text"
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input id="lastname" name="lastname" placeholder="" type="text"
                                                    class="form-control" value="<?php echo set_value('lastname'); ?>" />
...
?>
    ...
    ?>
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                <label
                                                    for="exampleInputEmail1"><?php echo $this->lang->line('category'); ?></label>
...
if (set_value('category_id') == $category['id']) {
    ...
    ?>
                                                ...
                                                <span
                                                    class="text-danger"><?php echo form_error('category_id'); ?></span>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                <label
                                                    for="exampleInputEmail1"><?php echo $this->lang->line('religion'); ?></label>
                                                <input id="religion" name="religion" placeholder="" type="text"
                                                    class="form-control" value="<?php echo set_value('religion'); ?>" />
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                <label
                                                    for="exampleInputEmail1"><?php echo $this->lang->line('caste'); ?></label>
                                                <input id="cast" name="cast" placeholder="" type="text"
                                                    class="form-control" value="<?php echo set_value('cast'); ?>" />
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label
                                                    for="exampleInputEmail1"><?php echo $this->lang->line('admission_date'); ?></label>
                                                <input id="admission_date" name="admission_date" placeholder=""
                                                    type="text" class="form-control date"
                                                    value="<?php echo set_value('admission_date', date($this->customlib->getSchoolDateFormat())); ?>"
                                                    readonly="readonly" />
                                                <span
                                                    class="text-danger"><?php echo form_error('admission_date'); ?></span>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label
                                                    for="exampleInputFile"><?php echo $this->lang->line('student_photo'); ?>
                                                    (100px X 100px)</label>
                                                <div><input class="filestyle form-control" type='file' name='image'
                                                        id="image" size='20' />
                                                </div>
...
if ($sch_setting->is_blood_group) {
    ?>
                                        <div class="col-md-3 col-xs-12">
                                            <div class="form-group">
                                                <label
                                                    for="exampleInputEmail1"><?php echo $this->lang->line('blood_group'); ?></label>
                                                <?php
?>
        ...
        ?>
                                                    <option value="<?php echo $bgvalue ?>"><?php echo $bgvalue ?>
                                                    </option>
...
if ($sch_setting->is_student_house) {
    ?>
                                        <div class="col-md-3 col-xs-12">
                                            <div class="form-group">
                                                <label
                                                    for="exampleInputEmail1"><?php echo $this->lang->line('house') ?></label>
...
?>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3 col-xs-12">
                                            <div class="form-group">
                                                <label
                                                    for="exampleInputEmail1"><?php echo $this->lang->line('height'); ?></label>
                                                <?php ?>
                                        ...
                                        <div class="col-md-3 col-xs-12">
                                            <div class="form-group">
                                                <label
                                                    for="exampleInputEmail1"><?php echo $this->lang->line('weight'); ?></label>
                                                <?php ?>
                                        ...
                                        <div class="col-md-3 col-xs-12">
                                            <div class="form-group">
                                                <label
                                                    for="exampleInputEmail1"><?php echo $this->lang->line('measurement_date'); ?></label>
                                                <?php ?>
                                                <input type="text" id="measure_date"
                                                    value="<?php echo set_value('measure_date', date($this->customlib->getSchoolDateFormat())); ?>"
                                                    name="measure_date" class="form-control date">
                                                <span
                                                    class="text-danger"><?php echo form_error('measure_date'); ?></span>
                                            </div>
                                        </div>
                                        <?php }?>
                                        <div class="col-md-3" style="display:none;">
                                            <div class="form-group">
                                                <label
                                                    for="exampleInputEmail1"><?php echo $this->lang->line('fees_discount'); ?></label>
                                                <input id="fees_discount" name="fees_discount" placeholder=""
                                                    type="text" class="form-control"
                                                    value="<?php echo set_value('fees_discount', 0); ?>" />
                                                <span
                                                    class="text-danger"><?php echo form_error('fees_discount'); ?></span>
                                            </div>
                                        </div>
...
?>
                      ...
                      <?php   if ($sch_setting->student_form_multi_class=='enabled') { ?>
                        <div class="bozero">
                            <div class="relative">
                                <h4 class="pagetitleh2">
                                    <?php echo $this->lang->line('multi_class_student'); ?>
                                </h4>
                                <div class="pull-right box-tools impbtntitle">
                                    <button class="btn btn-primary pull-right add_class" type="button"> <i
                            ...
                            <div class="row around10">
                                ...
                                <div class="col-md-12">
                                    <div class="row_list">
                                        ...
                                        <?php
                                            $mul_classes = (set_value('multi_class_row', 0));
                                            if (!is_array($mul_classes) && $mul_classes == 0) {
                                            ?>
                                        <div class="row">
                                            <input type="hidden" name="multi_class_row[]" value="1" />
                                            <div class="col-md-3 col-lg-3 col-sm-5">
                                                <div class="form-group">
                                                    <label for="exampleInputEmail1">
                                                        <?php echo $this->lang->line('class'); ?></label>
                                                    <select class="form-control class_multi" id="multiclass[1][class]"
                                                        name="multiclass[1][class]">
                                                    ...
                                                    <span
                                                        class="text-danger"><?php echo form_error('multiclass_class_1'); ?></span>
                                                </div>
                                            </div>
                                            <div class="col-md-3 col-lg-3 col-sm-5 section_div">
                                                <div class="form-group">
                                                    <label for="exampleInputEmail1">
                                                        <?php echo $this->lang->line('section'); ?></label>
                                                    <select id="multiclass_section_1" name="multiclass[1][section]"
                                                        class="form-control section_multi">
                                                        <option value=""><?php echo $this->lang->line('select'); ?>
                                                        </option>
                                                    </select>

                                                    <span
                                                        class="text-danger"><?php echo form_error('multiclass_section_1'); ?></span>
                                                </div>
                                            </div>

                                            <div class="col-md-1 col-lg-1 col-sm-2">
                                                <label class="displayblock opacity d-sm-none">&nbsp;</label>
                                                <button class="btn btn-danger btn-sm remove rmv_row delete-w-40"
                                        ...
                                        <?php
                                                ...
                                                foreach ($mul_classes as $mul_class_key => $mul_class_value) {

                                                ?>
                                        <div class="row">
                                            <input type="hidden" name="multi_class_row[]"
                                                value="<?php echo $mul_class_value; ?>" />
                                            <div class="col-md-3 col-lg-3 col-sm-5">
                                                <div class="form-group">
                                                    <label for="exampleInputEmail1">
                                                        <?php echo $this->lang->line('class'); ?></label>
                                                    <select class="form-control class_multi"
                                                        id="multiclass_class_<?php echo $mul_class_value; ?>"
                                                        name="multiclass[<?php echo $mul_class_value; ?>][class]">
                                                        ...
                                                        <option value="<?php echo $class['id'] ?>" <?php
                                                                                                                    if (set_value("multiclass[" . $mul_class_value . "][class]") == $class['id']) {
                                                                                                                        echo "selected=selected";
                                                                                                                    }
                                                                                                                    ?>>
                                                            <?php echo $class['class'] ?></option>
                                                    ...
                                                    <span
                                                        class="text-danger"><?php echo form_error("multiclass[" . $mul_class_value . "][class]"); ?></span>
                                                </div>
                                            </div>
                                            <div class="col-md-3 col-lg-3 col-sm-5 section_div">
                                                <div class="form-group">
                                                    <label for="exampleInputEmail1">
                                                        <?php echo $this->lang->line('section'); ?></label>
                                                    <select id="multiclass_section_<?php echo $mul_class_value; ?>"
                                                        name="multiclass[<?php echo $mul_class_value; ?>][section]"
                                                        class="form-control section_multi">
                                                        <option value=""><?php echo $this->lang->line('select'); ?>
                                                        </option>
                                                    </select>
                                                    ...
                                                    <span
                                                        class="text-danger"><?php echo form_error("multiclass[".$mul_class_value."][section]"); ?></span>
                                                </div>
                                            </div>
                        ...
                        <div class="bozero">
                            ...
                            <div class="row around10">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label
                                            for="exampleInputEmail1"><?php echo $this->lang->line('route_list'); ?></label>
...
$vehicles = $vehroute['vehicles'];
                ...
                foreach ($vehicles as $key => $value) {
                    ?>
                                                ...
                                                <option value="<?php echo $value->vec_route_id ?>"
                                                    <?php echo set_select('vehroute_id', $value->vec_route_id); ?>
                                                    data-fee="">
        ...
        ?>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label
                                            for="exampleInputEmail1"><?php echo $this->lang->line('pickup_point'); ?></label>
                                        <select class="form-control" id="pickup_point" name="route_pickup_point_id">

                                        </select>

                                        <span
                                            class="text-danger"><?php echo form_error('route_pickup_point_id'); ?></span>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label
                                            for="exampleInputEmail1"><?php echo $this->lang->line('fees_month'); ?></label>

                                        <select class="form-control" id="transport_feemaster_id"
                                            name="transport_feemaster_id[]" multiple="multiple">

                                            <?php
foreach ($transport_fees as $key => $value) {
            ?>
                                            <option <?php echo set_select('transport_feemaster_id[]', $value['id']); ?>
                                                value="<?php echo $value['id']; ?>">
                                                <?php echo $this->lang->line(strtolower($value['month'])); ?></option>
                                            <?php
}
        ?>
                                        ...
                                        <span
                                            class="text-danger"><?php echo form_error('transport_feemaster_id[]'); ?></span>
                        ...
                        <div class="bozero">
                            ...
                            <div class="row around10">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label
                                            for="exampleInputEmail1"><?php echo $this->lang->line('hostel'); ?></label>
...
foreach ($hostelList as $hostel_key => $hostel_value) {
                ?>
                                            ...
                                            <option value="<?php echo $hostel_value['id'] ?>"
                                                <?php echo set_select('hostel_id', $hostel_value['id']); ?>>
            ...
            ?>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label
                                            for="exampleInputEmail1"><?php echo $this->lang->line('room_no'); ?></label>
                                                        ...
                                                        <div class="panel-group1 mb0">
                                                            <div class="panel panel-default1">
                                                                <div class="panel-heading pt5 pb5">
                                                                    <h6
                                                                        class="panel-title panel-title1 overflow-hidden">
                                                                        <input class="fee_group_chk vertical-middle"
                                                                            type="checkbox"
                                                                            name="fee_session_group_id[]"
                                                                            value="<?php echo $feesessiongroup_value->id; ?>"
                                                                            <?php echo set_checkbox('fee_session_group_id[]', $feesessiongroup_value->id); ?>>
                                                                        <a class="display-inline collapsed box-plus-panel"
                                                                            data-toggle="collapse"
                                                                            href="#collapse_fees_<?php echo $feesessiongroup_value->id ?>">
                                                                            <span
                                                                                class="font14"><?php echo $feesessiongroup_value->group_name; ?></span></a>
                                                                        <span
                                                                            class="float-right bmedium fee_group_total"
                                                                ...
                                                                <div id="collapse_fees_<?php echo $feesessiongroup_value->id ?>"
                                                                    ...
                                                                    <ul class="list-group student_fee_list ui-sortable student-list-sm">
                                                                        <li class="list-group-item">
                                                                            <div
                                                                                class="displayinline stfirstdiv bmedium  pl-65">
                                                                                <?php echo $this->lang->line('fees_type'); ?>
                                                                            </div>
                                                                            <div class="due_date bmedium">
                                                                                <?php echo $this->lang->line('due_date'); ?>
                                                                            </div>
                                                                            <div class="tools bmedium">
                                                                                <?php echo $this->lang->line('amount'); ?>
                                                                                (<?php echo $currency_symbol; ?>)</div>
                                                                        </li>
                                                                        <?php
foreach ($feesessiongroup_value->feetypes as $fee_type_key => $fee_type_value) {
            ?>
                                                            ...
                                                            <div class="panel panel-default1">
                                                                <div class="panel-heading pt5 pb5">
                                                                    <h6
                                                                        class="panel-title panel-title1 overflow-hidden">
                                                                        <input
                                                                            class="discount_group_chk vertical-middle"
                                                                            type="checkbox" name="discount_id[]"
                                                                            value="<?php echo $feediscount['id']; ?>"
                                                                            <?php echo set_checkbox('discount_id[]', $feediscount['id']); ?>>
                                                                        <a class="display-inline collapsed box-plus-panel"
                                                                            data-toggle="collapse"
                                                                            href="#collapse_fees_<?php echo $feediscount['id'] ?>">
                                                                            <span
                                                                                class="font14"><?php  echo $feediscount['name']." - ".$feediscount['code']; ?></span></a>
                                                                        <span
                                                                            class="float-right bmedium pt3 discount_group_total"
                                                                            data-discount="<?php echo $feediscount['amount']; ?>"><?php  ?></span>
                                                                    </h6>
                                                                </div>
                                                                <div id="collapse_fees_<?php echo $feediscount['id']; ?>"
                                                                    class="panel-collapse collapse">
                                                                    <ul class="list-group student_fee_list ui-sortable student-list-sm">
                                                                        <li class="list-group-item">
                                                                            <div class="due_date bmedium pl-65">
                                                                                <?php echo $this->lang->line('name'); ?>
                                                                            </div>
                                                                            <div class="due_date bmedium pl-65">
                                                                                <?php echo $this->lang->line('discount_code'); ?>
                                                                            </div>
                                                                            <div class="due_date bmedium pl-65">
                                                                        ...
                                                                        <li class="list-group-item">
                                                                            ...
                                                                            <div class="due_date pl-65">
                                                                                <?php echo $this->lang->line($feediscount['type']); ?>
                                                                            </div>
                                                                            <div class="tools">
                                                                                <?php
                            ...
                            <div class="around10">
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label
                                                for="exampleInputEmail1"><?php echo $this->lang->line('father_phone'); ?></label>
                                            <input id="father_phone" name="father_phone" placeholder="" type="text"
                                                class="form-control" value="<?php echo set_value('father_phone'); ?>" />
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label
                                                for="exampleInputFile"><?php echo $this->lang->line('father_photo'); ?>
                                                (100px X 100px)</label>
                                            <div><input class="filestyle form-control" type='file' name='father_pic'
                                                    id="file" size='20' />
                                            </div>
                                            <span class="text-danger"><?php echo form_error('file'); ?></span>
                                        </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input id="mother_phone" name="mother_phone" placeholder="" type="text"
                                                class="form-control" value="<?php echo set_value('mother_phone'); ?>" />
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label
                                                for="exampleInputFile"><?php echo $this->lang->line('mother_photo'); ?>
                                                (100px X 100px)</label>
                                            <div><input class="filestyle form-control" type='file' name='mother_pic'
                                                    id="file" size='20' />
                                            </div>
                                            <span class="text-danger"><?php echo form_error('file'); ?></span>
                                        </div>
        ...
        ?>
                                <div class="row">
                                    <div class="form-group col-md-12">
                                        <label><?php echo $this->lang->line('if_guardian_is'); ?><small class="req">
                                                *</small>&nbsp;&nbsp;&nbsp;</label>
        ...
        ?>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input id="guardian_email" name="guardian_email" placeholder="" type="text"
                                                class="form-control"
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label
                                                for="exampleInputFile"><?php echo $this->lang->line('guardian_photo'); ?>
                                                (100px X 100px)</label>
                                            <div><input class="filestyle form-control" type='file' name='guardian_pic'
                                                    id="file" size='20' />
                                            </div>
                                            <span class="text-danger"><?php echo form_error('file'); ?></span>
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        <label
                                            for="exampleInputEmail1"><?php echo $this->lang->line('guardian_address'); ?></label>
                                        <textarea id="guardian_address" name="guardian_address" placeholder=""
                                            class="form-control"
                                            rows="2"><?php echo set_value('guardian_address'); ?></textarea>
                            ...
                            <div class="panel box collapsed-box border0 mb0">
                                ...
                                <div class="box-body">
                                    <div class="mb25 bozero">
                                        <h4 class="pagetitleh2">
                                            <?php echo $this->lang->line('student_address_details'); ?></h4>
                                        ...
                                        <div class="row around10">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group">
                                                    <label
                                                        for="exampleInputEmail1"><?php echo $this->lang->line('current_address'); ?></label>
                                                    <textarea id="current_address" name="current_address" placeholder=""
                                                        class="form-control"><?php echo set_value('current_address'); ?></textarea>
                                                    <span
                                                        class="text-danger"><?php echo form_error('current_address'); ?></span>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <span
                                                        class="text-danger"><?php echo form_error('permanent_address'); ?></span>
                                                </div>
                                            </div>
                                            <?php }?>
                                        </div>
                                    ...
                                    <div class="tshadow mb25 bozero">
                                        <h4 class="pagetitleh2">
                                            <?php echo $this->lang->line('miscellaneous_details'); ?>
                                        </h4>
                                        <div class="row around10">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label
                                                        for="exampleInputEmail1"><?php echo $this->lang->line('bank_account_number'); ?></label>
                                                    <input id="bank_account_no" name="bank_account_no" placeholder=""
                                                        type="text" class="form-control"
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input id="bank_name" name="bank_name" placeholder="" type="text"
                                                        class="form-control"
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input id="ifsc_code" name="ifsc_code" placeholder="" type="text"
                                                        class="form-control"
                                        ...
                                        <div class="row around10">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input id="adhar_no" name="adhar_no" placeholder="" type="text"
                                                        class="form-control"
                                                        value="<?php echo set_value('adhar_no'); ?>" />
                                                    <span
                                                        class="text-danger"><?php echo form_error('adhar_no'); ?></span>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input id="samagra_id" name="samagra_id" placeholder="" type="text"
                                                        class="form-control"
...
echo set_value('rte') == "no" ? "checked" : "";
    ?>><?php echo $this->lang->line('no'); ?></label>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label
                                                        for="exampleInputEmail1"><?php echo $this->lang->line('previous_school_details'); ?></label>
                                                    <textarea class="form-control" rows="3" placeholder=""
                                                        name="previous_school"></textarea>
                                                    <span
                                                        class="text-danger"><?php echo form_error('previous_school'); ?></span>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label
                                                        for="exampleInputEmail1"><?php echo $this->lang->line('note'); ?></label>
                                                    <textarea class="form-control" rows="3" placeholder=""
                                                        name="note"></textarea>
                                                        ...
                                                        <div class="col-md-6">
                                                            <table class="table">
                                                                <tbody>
                                                                    ...
                                                                    <tr>
                                                                        <td>1.</td>
                                                                        <td><input type="text" name='first_title'
                                                                                class="form-control" placeholder="">
                                                                        </td>
                                                                        <td>
                                                                            <input class="filestyle form-control"
                                                                                type='file' name='first_doc' id="doc1">
                                                                            <span
                                                                    ...
                                                                    <tr>
                                                                        <td>2.</td>
                                                                        <td><input type="text" name='second_title'
                                                                                class="form-control" placeholder="">
                                                                        </td>
                                                                        <td>
                                                                            <input class="filestyle form-control"
                                                                                type='file' name='second_doc' id="doc1">
                                                                            <span
                                                        ...
                                                        <div class="col-md-6">
                                                            <table class="table">
                                                                <tbody>
                                                                    ...
                                                                    <tr>
                                                                        <td>3.</td>
                                                                        <td><input type="text" name='fourth_title'
                                                                                class="form-control" placeholder="">
                                                                        </td>
                                                                        <td>
                                                                            <input class="filestyle form-control"
                                                                                type='file' name='fourth_doc' id="doc1">
                                                                            <span
                                                                    ...
                                                                    <tr>
                                                                        <td>4.</td>
                                                                        <td><input type="text" name='fifth_title'
                                                                                class="form-control" placeholder="">
                                                                        </td>
                                                                        <td>
                                                                            <input class="filestyle form-control"
                                                                                type='file' name='fifth_doc' id="doc1">
                                                                            <span
                                                                                class="text-danger"><?php echo form_error('fifth_doc'); ?></span>
                                                                        </td>
                                                                    </tr>
                                                                </tbody>
                                                            </table>
                        ...
                        <div class="box-footer">
                            <button type="submit" class="btn btn-info pull-right"
                                id="addloader"><?php echo $this->lang->line('save'); ?></button>
                        </div>
                    </form>
                </div>
            </div>
...
"></span>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-primary add_sibling" id="load"
...
$('#addloader').on('click', function() {
    $('#addloader').html(
        '<i class="fa fa-spinner fa-spin fa-1x fa-fw"></i><?php echo $this->lang->line('loading'); ?>');
});
            ...
            $.ajax({
                ...
                success: function(data) {
                    $.each(data, function(i, obj) {
                        ...
                        div_data += "<option value=" + obj.section_id + " " + sel + ">" +
                            obj.section + "</option>";
                    });
        ...
        success: function(data) {
            $.each(data, function(i, obj) {
                ...
                if (obj.admission_no == null) {
                    ...
                    div_data += "<option value=" + obj.id + ">" + obj.full_name + " (" + obj
                        .admission_no + ") " + "</option>";
                }
...
$(document).ready(function() {
    $(document).on('change', '.fee_group_chk', function() {
        ...
        if ($(this).prop("checked")) {
            total_fees_alloted += parseFloat($(this).closest('div').find('span.fee_group_total').data(
                'amount'));
        } else {
            total_fees_alloted -= parseFloat($(this).closest('div').find('span.fee_group_total').data(
                'amount'));
...
$(document).on('change', '.class_multi', function(e) {
    let _this = $(this);
    let class_id = $(this).val();
    getMultiSectionByClass(class_id, 0, _this);
});


function getMultiSectionByClass(class_id, section_id, current_obj) {

    if (class_id != "") {


        var div_data = '<option value=""><?php echo $this->lang->line('select'); ?></option>';
        let section_multi_dropdown = current_obj.closest('div').parent('div').parent('div').find(
            'div.section_div .section_multi');
        ...
        $.ajax({
            ...
            dataType: "json",
            beforeSend: function() {
                section_multi_dropdown.addClass('dropdownloading');
            },
            success: function(data) {
                $.each(data, function(i, obj) {
                    var sel = "";
                ...
                section_multi_dropdown.empty().append(div_data);
            },
            complete: function() {
                section_multi_dropdown.removeClass('dropdownloading');
            }
        });
    }
}

var total_multi_class = "<?php echo count(set_value('multi_class_row', [1])); ?>";



$(document).on('click', '.add_class', function() {
    total_multi_class++; // increment count
    var classOptions = $('#class_drp').html();
    var teacherOptions = $('#teacher_drp').html();
    var newRow = `
    <div class="row">
    <input type="hidden" name="multi_class_row[]" value="${total_multi_class}"/>
        <div class="col-md-3 col-lg-3 col-sm-5">
            <div class="form-group">
                <label><?php echo $this->lang->line('class'); ?> </label>
                <select class="form-control class_multi" id="multiclass_class_${total_multi_class}" name="multiclass[${total_multi_class}][class]" autocomplete="off">
                    ${classOptions}
                </select>
        ...
        <div class="col-md-3 col-lg-3 col-sm-5 section_div">
            <div class="form-group">
                ...
                <select id="multiclass_section_${total_multi_class}" name="multiclass[${total_multi_class}][section]" class="form-control section_multi">
                    <option value=""><?php echo $this->lang->line('select'); ?></option>
                </select>
                <span class="text-danger"></span>
            </div>
        ...
        <div class="col-md-1 col-lg-1 col-sm-2">
        <label class="displayblock opacity d-sm-none">&nbsp;</label>
            <button class="btn btn-danger btn-sm remove rmv_row delete-w-40" type="button"><i class="fa fa-trash"></i></button>
        </div>
    </div>`;

    $('.row_list').append(newRow);
    $(`#multiclass_teacher_${total_multi_class}`).multiselect({
        columns: 1,
...
<script type="text/template" id="class_drp">
    <option value=""><?php echo $this->lang->line('select'); ?></option>
    <?php
    foreach ($classlist as $class) {
    ?>
...
<script type="text/template" id="teacher_drp">
    <?php
    foreach ($teacher_staffs as $teacher_staff) {
    ?>
        <option value="<?php echo $teacher_staff['id'] ?>"
              <?php
                if (set_value('class_id') == $teacher_staff['id']) {
                    echo "selected=selected";
                }
                ?>><?php echo $teacher_staff['name'] . " " . $teacher_staff['surname']; ?></option>
    <?php
    }
    ?> 
</script>
