...
<?php }if ($sch_setting->measurement_date) {
    $measurement_date = "";
    if ($student['measurement_date'] != '0000-00-00' && $student['measurement_date'] != '') {
...
?>
                      ...
                      <?php   if ($sch_setting->student_form_multi_class=='enabled') { ?>
                            ...
                            <div class="tshadow mb25 bozero">
                                <div class="relative">
                                    <h4 class="pagetitleh2"><?php echo $this->lang->line('multi_class_student'); ?></h4>                                
                                    <div class="pull-right box-tools impbtntitle">
                                        <button class="btn btn-primary pull-right add_class" type="button"> <i class="fa fa-plus"></i> <?php echo $this->lang->line('add'); ?></button>
                                    </div>
                                </div>
                                ...
                                <div class="row around10">
                                    <div class="col-md-12">
                                        <div class="row_list">
                                            ...
                                            $mul_classes = (count($teacher_data));
                                           

                                            if (!is_array($mul_classes) && $mul_classes <= 1 && set_value('multi_class_row', 0) ==0) {
                                            ...
                                            ?>
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-4 col-lg-3 col-sm-5">
                                                        <div class="form-group">
                                                            ...
                                                            <select class="form-control class_multi" id="multiclass[1][class]" name="multiclass[1][class]">
                                                                ...
                                                                ?>
                                                                    <option value="<?php echo $class['id'] ?>" <?php
                                                                                                                if (set_value("multiclass[1][class]")  == $class['id']) {
                                                                                                                    echo "selected=selected";
                                                                                                                }
                                                                                                                ?>><?php echo $class['class'] ?></option>
                                                                <?php
                                                            ...
                                                            <span class="text-danger"><?php echo form_error("multiclass[1][class]"); ?></span></span>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-4 col-lg-3 col-sm-5 section_div">
                                                        <div class="form-group">
                                                            <label for="exampleInputEmail1"> <?php echo $this->lang->line('section'); ?></label>
                                                            <select id="multiclass_section_1" name="multiclass[1][section]" class="form-control section_multi">
                                                                <option value=""><?php echo $this->lang->line('select'); ?></option>
                                                            </select>

                                                            <span class="text-danger"><?php echo form_error("multiclass[1][section]"); ?></span>
                                                        </div>
                                                    </div>
                                                ...
                                                <?php
                                                    ...
                                                    $mul_class_post = (set_value('multi_class_row', 0));
                                                   if (is_array($mul_class_post)) {
                                                       foreach ($mul_class_post as $mul_class_key => $mul_class_post_data) {
                                                     

                                                ?>
                                                    <div class="row">
                                                        <input type="hidden" name="multi_class_row[]" value="<?php echo $mul_class_post_data; ?>" />
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                <label for="exampleInputEmail1"> <?php echo $this->lang->line('class'); ?></label>
                                                                <select class="form-control class_multi" id="multiclass_class_<?php echo $mul_class_post_data; ?>" name="multiclass[<?php echo $mul_class_post_data; ?>][class]">
                                                                    ...
                                                                    ?>
                                                                        ...
                                                                        <option value="<?php echo $class['id'] ?>" <?php
                                                                                                                    if (set_value("multiclass[" . $mul_class_post_data . "][class]") == $class['id']) {
                                                                                                                        echo "selected=selected";
                                                                                                                    }
                                                                                                                    ?>><?php echo $class['class'] ?></option>
                                                                    <?php
                                                                ...
                                                                <span class="text-danger"><?php echo form_error("multiclass[" . $mul_class_post_data . "][class]"); ?></span>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-4 col-lg-3 col-sm-5 section_div">
                                                            <div class="form-group">
                                                                <label for="exampleInputEmail1"> <?php echo $this->lang->line('section'); ?></label>
                                                                <select id="multiclass_section_<?php echo $mul_class_post_data; ?>" name="multiclass[<?php echo $mul_class_post_data; ?>][section]" class="form-control section_multi">
                                                                    <option value=""><?php echo $this->lang->line('select'); ?></option>
                                                                </select>

                                                                <span class="text-danger"><?php echo form_error("multiclass[".$mul_class_post_data."][section]"); ?></span>
                                                            </div>
                                                        </div>
                                                   
                                                        <div class="col-md-1 col-lg-1 col-sm-2">
                                                            <label class="displayblock opacity d-sm-none">&nbsp;</label>
                                                            <button class="btn btn-danger rmv_row remove delete-w-40" type="button"><i class="fa fa-trash"></i></button>
                                                        </div>
                                                    </div>
                                                <?php
                                                }
...
unset($aarray[0]);
                                                       foreach ($aarray as $mul_class_key => $mul_class_value) {
                                                         $new_key=$mul_class_key+1;
                                                       ?>
                                                           <div class="row">
                                                               <input type="hidden" name="multi_class_row[]" value="<?php echo $new_key; ?>" />
                                                               <div class="col-md-4 col-lg-3 col-sm-5">
                                                                   <div class="form-group">
                                                                       <label for="exampleInputEmail1"> <?php echo $this->lang->line('class'); ?> </label>
                                                                       <select class="form-control class_multi" id="multiclass_class_<?php echo $new_key; ?>" name="multiclass[<?php echo $new_key; ?>][class]">
                                                                           ...
                                                                           ?>
                                                                               <option value="<?php echo $class['id'] ?>" <?php
                                                                                                                           if (set_value("multiclass[" . $new_key . "][class]",$mul_class_value->class_id) == $class['id']) {
                                                                                                                               echo "selected=selected";
                                                                                                                           }
                                                                                                                           ?>><?php echo $class['class'] ?></option>
                                                                           <?php
                                                                       ...
                                                                       <span class="text-danger"><?php echo form_error("multiclass[" . $new_key . "][class]"); ?></span>
                                                                   </div>
                                                               </div>
                                                               <div class="col-md-4 col-lg-3 col-sm-5 section_div">
                                                                   <div class="form-group">
                                                                       <label for="exampleInputEmail1"> <?php echo $this->lang->line('section'); ?> </label>
                                                                       <select id="multiclass_section_<?php echo $new_key; ?>" name="multiclass[<?php echo $new_key; ?>][section]" class="form-control section_multi">
                                                                           <option value=""><?php echo $this->lang->line('select'); ?></option>
                                                                       </select>
       
                                                                       <span class="text-danger"><?php echo form_error("multiclass[".$new_key."][section]"); ?></span>
                                                                   </div>
                                                               </div>
                                                           
                                                               <div class="col-md-1 col-lg-1 col-sm-2">
                                                                    <label class="displayblock opacity d-sm-none">&nbsp;</label>
                                                                   <button class="btn btn-danger remove rmv_row  delete-w-40" type="button"><i class="fa fa-trash"></i></button>
                                                               </div>
                                                           </div>
                                                       <?php
                                                       }
    ...
    <div class="panel panel-default1">
      <div class="panel-heading pt5 pb5">
         <h6 class="panel-title panel-title1 overflow-hidden">
          ...
          <span class="float-right bmedium fee_group_total" data-amount="<?php echo ($total_fees); ?>"><?php echo amountFormat($total_fees); ?></span>
        </h6>
      </div>
...
?>
    ...
    if (!empty($feediscountList)) {  ?>
        <div class="table-responsive border0">
            ...
            <?php
            foreach($feediscountList as $key=>$feediscount){ 
                if(is_value_exist($student_fees_discount,$feediscount['id'])){ ?>
                    <!-- previous fees discount id -->
                    <input type="hidden" name="prev_discount[]" value="<?php echo $feediscount['id']; ?>">
                    <!-- previous fees discount id -->
           <?php }  ?>
...
<script type="text/javascript">
    ...
    function getMultiSectionByClass(class_id, section_id, current_obj) {
        ...
        if (class_id != "") {
            ...
            var div_data = '<option value=""><?php echo $this->lang->line('select'); ?></option>';
            let section_multi_dropdown = current_obj.closest('div').parent('div').parent('div').find('div.section_div .section_multi');
    ...
    var total_multi_class = "<?php echo count(set_value('multi_class_row', json_decode(json_encode($teacher_data), true))); ?>";
