                                ...
                                <form class="mt10" action="<?php echo site_url('student/ajax_delete') ?>" method="POST" id="deletebulk">
                                    ...
                                    if (isset($resultlist)) {
                                        ...
                                        <div class="checkbox bordertop pt15">
                                            ...
                                            if (!empty($resultlist)) {
                                                ?>                              
                                                <button type="submit" class="btn btn-primary pull-right btn-sm mb5" id="load" data-loading-text="<i class='fa fa-spinner fa-spin '></i>  <?php echo $this->lang->line('please_wait'); ?>"> <?php echo $this->lang->line('delete') ?></button>
                                                <?php
                                            }
                                            ?>
                                        </div> 
                                        <div class="table-responsive pt15 clearboth">
                                            ...
                                            <table class="table table-striped table-bordered table-hover example" cellspacing="0" width="100%"  data-export-title="<?php echo $this->lang->line('bulk_delete');?>">
                                                <thead>
                                                    <tr>
