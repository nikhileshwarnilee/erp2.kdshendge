                        ...
                        <div class="nav-tabs-custom border0">
                            ...
                            <div class="tab-content">
                                ...
                                <div class="tab-pane active table-responsive no-padding overflow-visible-lg" id="tab_1">
                                    <table class="table table-striped table-bordered table-hover example" cellspacing="0" width="100%" data-export-title="<?php echo $this->lang->line('disable_student_list'); ?>">
                                        <thead>
                                            <tr>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-xs-6 col-md-6">
                                                                ...
                                                                if ($sch_setting->guardian_name) { ?>
                                                                    <b><?php echo $this->lang->line('guardian_name'); ?>:&nbsp;</b><?php echo $student['guardian_name'] ?><br><?php }
