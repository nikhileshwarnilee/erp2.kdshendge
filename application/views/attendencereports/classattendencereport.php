                    ...
                    if ($this->module_lib->hasActive('student_attendance')) {
                        ...
                        if (isset($resultlist)) {
                            ...
                            $this->customlib->get_postmessage();
                                        ?></div>
                                        <table class="table table-striped table-bordered table-hover example" data-export-title="<?php echo $this->lang->line('student_attendance_report');?>">
                                            <thead>
                                                <tr>
                                                    <th>
                                            ...
                                            <tbody>
                                                <?php if (empty($student_array)) {
                                                    ...
                                                    foreach ($student_array as $student_key => $student_value) {                                                      
                                                        ...
                                                        <tr>
                                                            <th class="tdclsname">
                                                                <span data-toggle="popover" class="detail_popover" data-original-title="" title=""><a href="#"><?php echo $this->customlib->getFullName($student_value['firstname'],$student_value['middlename'],$student_value['lastname'],$sch_setting->middlename,$sch_setting->lastname); ?></a></span>
                                                                <div class="fee_detail_popover" style="display: none"><p class="text text-info"><?php echo $this->lang->line("admission_no").": " . $student_value['admission_no']; ?></p></div> 
                                                            </th>
                                                            <th><?php
