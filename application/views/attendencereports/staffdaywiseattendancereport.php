                            ...
                            <div class="" id="attendencelist">
                                ...
                                <div class="box-body table-responsive">
                                    ...
                                    ?>
                                        ...
                                        <table class="table table-hover table-striped example" data-export-title="<?php echo $this->lang->line('staff_day_wise_attendance_report');?>">
                                            <thead>
                                                <tr>
                                                    <th width="5%" class="dt-body-left dt-head-left">#</th>
