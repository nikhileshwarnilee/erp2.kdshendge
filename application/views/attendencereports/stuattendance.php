        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box removeboxmius">
                    ...
                    <form role="form" action="<?php echo site_url('attendencereports/attendancereport') ?>" method="post">
...
?></div>
                            <table class="table table-striped table-bordered table-hover example" data-export-title="<?php echo $this->lang->line('student_attendance_type_report');?>">
                                <thead>
                                    <tr>
