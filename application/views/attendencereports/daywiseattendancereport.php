...
<div class="content-wrapper" style="min-height: 946px;">
    ...
    <section class="content-header">
        <h1>
            <i class="fa fa-calendar-check-o"></i><small></small>
        </h1>
    </section>
                            ...
                            <div class="" id="attendencelist">
                                ...
                                <div class="box-body table-responsive">
                                    ...
                                    ?>
                                        ...
                                        <table class="table table-hover table-striped example" data-export-title="<?php echo $this->lang->line('student_day_wise_attendance_report');?>">
                                            <thead>
                                                <tr>
                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <?php } ?>
                                                        <td><a href="<?php echo base_url("student/view/".$value['id']); ?>">
                                                            <?php
                                                            echo $this->customlib->getFullName($value['firstname'], $value['middlename'], $value['lastname'], $sch_setting->middlename, $sch_setting->lastname); ?></a>
                                                        </td>
