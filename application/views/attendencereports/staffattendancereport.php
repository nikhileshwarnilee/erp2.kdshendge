                            ...
                            <div class="box-body table-responsive">
                                ...
                                ?>
                                    ...
                                    <div> <?php echo
                                            ...
                                            ?></div>
                                    <table class="table table-striped table-bordered table-hover example xyz" data-export-title="<?php echo $this->lang->line('staff_attendance_report');?>">
                                        <thead>
                                            <tr>
                                                <th>
                                            ...
                                            ?>
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td class="tdclsname">
                                                            <a href="#">
                                                            <?php echo $student_value['name'] . " " . $student_value['surname']." (".$student_value['employee_id'].")"; ?>
                                                </a>
