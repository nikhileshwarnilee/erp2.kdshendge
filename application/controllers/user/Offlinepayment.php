...
class Offlinepayment extends Student_Controller
{
    ...
    {      
        ...
        $storage_array = 'attachment'; // use comma for multiple files       
    ...
    public function getlistbyuser()
    {
        ...
        if (!empty($m->data)) {
            foreach ($m->data as $key => $value) {
                ...
                $viewbtn = " <button type='button' data-toggle='tooltip' class='btn btn-primary btn-xs getbankdetail' data-recordid=" . $value->id . "  title=" . $this->lang->line('view') . " data-loading-text='<i class=" . '" fa fa-spinner fa-spin"' . "  ></i>'><i class='fa fa-reorder'></i></button>";
