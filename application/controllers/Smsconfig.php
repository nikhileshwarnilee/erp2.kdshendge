...
class Smsconfig extends Admin_Controller
{
    ...
    public function clickatell()
    {
        ...
        $this->form_validation->set_rules('clickatell_api_id', $this->lang->line('api_key'), 'required');
    ...
    public function custom()
    {
        ...
        $this->form_validation->set_rules('name', $this->lang->line('gateway_name'), 'required');
    ...
    public function smsgatewayhub()
    {
        $this->form_validation->set_error_delimiters('', '');

        $this->form_validation->set_rules('smsgatewayhub_authkey', $this->lang->line('auth_Key'), 'required');
        $this->form_validation->set_rules('smsgatewayhub_senderid', $this->lang->line('sender_id'), 'required');
        $this->form_validation->set_rules('smsgatewayhub_entityid', $this->lang->line('entity_id'), 'required');

        if ($this->form_validation->run()) {

            $data = array(
                'type'      => 'smsgatewayhub',
                'authkey'   => $this->input->post('smsgatewayhub_authkey'),
                'senderid'  => $this->input->post('smsgatewayhub_senderid'),
                'api_id'    => $this->input->post('smsgatewayhub_entityid'),
                'is_active' => $this->input->post('smsgatewayhub_status'),
            ...
            $data = array(
                'smsgatewayhub_authkey'         => form_error('smsgatewayhub_authkey'),
                'smsgatewayhub_senderid'        => form_error('smsgatewayhub_senderid'),
                'smsgatewayhub_entityid'        => form_error('smsgatewayhub_entityid'),
                'smsgatewayhub_status'          => form_error('smsgatewayhub_status'),
            );
    ...
    public function mobireach()
    {
     ...
     {      
        ...
        $this->form_validation->set_rules('registered_from_number', $this->lang->line('registered_from_number'), 'required');
        ...
        if ($this->form_validation->run()) {
            ...
            $data = array(
                ...
                'senderid'  => $this->input->post('registered_from_number'),
            ...
            $data = array(
                ...
                'registered_from_number' => form_error('registered_from_number'),
