                ...
                if ($this->form_validation->run() == true) {
                 ...
                 try {
                    ...
                    $data = array(
                        ...
                        'online_admission_amount'      => convertCurrencyFormatToBaseAmount(trim($this->input->post('online_admission_amount'))),
                    ...
                    if (isset($_FILES["file"]) && $_FILES['file']['name'] != '' && (!empty($_FILES['file']['name']))) {
                        $prev_file_size = $this->media_storage->getUploadedFileSize($this->sch_setting_detail->online_admission_application_form, 'uploads/admission_form');
