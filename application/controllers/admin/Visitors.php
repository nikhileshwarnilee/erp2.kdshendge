...
class Visitors extends Admin_Controller
{
    ...
    public function delete()
    {
        ...
        if ($row['image'] != '') {
            //=============
            $delete_file_size = $this->media_storage->getUploadedFileSize($row['image'], 'uploads/front_office/visitors');
   ...
   public function edit()
    {
        ...
        $this->form_validation->set_rules($storage_array, $this->lang->line('file'), "callback_validateCanUploadFile[$storage_array]");
        ...
        try {
            ...
            if (isset($_FILES["file"]) && $_FILES['file']['name'] != '' && (!empty($_FILES['file']['name']))) {
                $prev_file_size = $this->media_storage->getUploadedFileSize($visitors_list['image'], 'uploads/front_office/visitors');
