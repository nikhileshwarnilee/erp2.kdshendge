...
class Complaint extends Admin_Controller
{
    ...
    public function edit($id)
    {
        ...
        try {
            ...
            if (isset($_FILES["file"]) && $_FILES['file']['name'] != '' && (!empty($_FILES['file']['name']))) {
                $prev_file_size = $this->media_storage->getUploadedFileSize($data['complaint_data']['image'], 'uploads/front_office/complaints');
                $img_name = $this->media_storage->fileupload("file", "./uploads/front_office/complaints/");
    ...
    public function delete($id)
    {
        ...
        if ($row['image'] != '') {
            $delete_file_size = $this->media_storage->getUploadedFileSize($row['image'], 'uploads/front_office/complaints');
