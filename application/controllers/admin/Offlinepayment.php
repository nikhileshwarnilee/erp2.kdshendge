    ...
    public function getlist()
    {
        ...
        if (!empty($m->data)) {
            foreach ($m->data as $key => $value) {
                ...
                $viewbtn = " <button type='button' data-toggle='tooltip' class='btn btn-primary btn-xs download_exam' data-recordid=" . $value->id . "  title=" . $this->lang->line('view') . " data-loading-text='<i class=" . '" fa fa-spinner fa-spin"' . "  ></i>'><i class='fa fa-reorder'></i></button>";
