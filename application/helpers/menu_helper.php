    ...
    {  
        $array = array(
            ...
            'certificate' => array(               
                ...
                'transfercertificate'   => array('download','verify_tc','prepare_tc','index','edit_custom_field','edit_header'), 
            ...
            'reports' => array(  
                ...
                'homework'          => array('homeworkordailyassignmentreport','homeworkreport','evaluation_report','dailyassignmentreport','homework_marksreport'),             
            ),            
            ...
            'behaviour_records' => array(               
                ...
                'report'    => array('behaviourreport','studentincidentreport','studentbehaviorsrankreport','classwiserankreport','classsectionwiserank','housewiserank','incidentwisereport'),               
                'behavioursetting'   => array('index'),               
            ),
            ...
            'online_course' => array(               
                ...
                'coursereport'   => array('report','coursepurchase','coursesellreport','trendingreport','completereport','courseratingreport','guestlist','quizperformance','course_assignment_report','course_exam_result_report','course_exam_report','course_exam_attempt_report','result_report'),         
