...
class Question_model extends MY_model
{
    ...
    public function getAllRecord($class_id=null,$section_id=null,$subject=null,$question_type=null,$question_level=null,$created_by=null)
    {
        $userdata = $this->customlib->getUserData();
        $role_id  = $userdata["role_id"];
        ...
        $this->datatables->searchable('questions.id,classes.class,subjects.name,questions.question_type,questions.level,questions.question,classes.class,questions.staff_id');
        $this->datatables->orderable('questions.id,classes.class,subjects.name,questions.question_type,questions.level,questions.question,classes.class,questions.staff_id');
